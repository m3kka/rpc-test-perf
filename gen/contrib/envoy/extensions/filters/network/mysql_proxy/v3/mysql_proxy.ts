...
// @generated from protobuf file "contrib/envoy/extensions/filters/network/mysql_proxy/v3/mysql_proxy.proto" (package "envoy.extensions.filters.network.mysql_proxy.v3", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message envoy.extensions.filters.network.mysql_proxy.v3.MySQLProxy
 */
...
class MySQLProxy$Type extends MessageType<MySQLProxy> {
    constructor() {
        super("envoy.extensions.filters.network.mysql_proxy.v3.MySQLProxy", [
        ...
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.filter.network.mysql_proxy.v1alpha1.MySQLProxy" } });
    }
...
/**
 * @generated MessageType for protobuf message envoy.extensions.filters.network.mysql_proxy.v3.MySQLProxy
 */
