 ...
 *
 * @generated from protobuf service envoy.service.discovery.v2.AggregatedDiscoveryService
 */
export interface IAggregatedDiscoveryServiceClient {
    /**
     * This is a gRPC-only API.
     *
     * @generated from protobuf rpc: StreamAggregatedResources(stream envoy.api.v2.DiscoveryRequest) returns (stream envoy.api.v2.DiscoveryResponse);
     */
    streamAggregatedResources(options?: RpcOptions): DuplexStreamingCall<DiscoveryRequest, DiscoveryResponse>;
    /**
     * @generated from protobuf rpc: DeltaAggregatedResources(stream envoy.api.v2.DeltaDiscoveryRequest) returns (stream envoy.api.v2.DeltaDiscoveryResponse);
     */
