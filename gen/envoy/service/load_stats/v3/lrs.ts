 ...
 *
 * @generated from protobuf message envoy.service.load_stats.v3.LoadStatsRequest
 */
export interface LoadStatsRequest {
     ...
     *
     * @generated from protobuf field: repeated envoy.config.endpoint.v3.ClusterStats cluster_stats = 2;
     */
 ...
 *
 * @generated from protobuf message envoy.service.load_stats.v3.LoadStatsResponse
 */
...
class LoadStatsRequest$Type extends MessageType<LoadStatsRequest> {
    constructor() {
        super("envoy.service.load_stats.v3.LoadStatsRequest", [
            { no: 1, name: "node", kind: "message", T: () => Node },
            { no: 2, name: "cluster_stats", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ClusterStats }
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.service.load_stats.v2.LoadStatsRequest" } });
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* envoy.config.core.v3.Node node */ 1:
                    ...
                    break;
                case /* repeated envoy.config.endpoint.v3.ClusterStats cluster_stats */ 2:
...
/**
 * @generated MessageType for protobuf message envoy.service.load_stats.v3.LoadStatsRequest
 */
...
class LoadStatsResponse$Type extends MessageType<LoadStatsResponse> {
    constructor() {
        super("envoy.service.load_stats.v3.LoadStatsResponse", [
        ...
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.service.load_stats.v2.LoadStatsResponse" } });
    }
...
/**
 * @generated MessageType for protobuf message envoy.service.load_stats.v3.LoadStatsResponse
 */
export const LoadStatsResponse = new LoadStatsResponse$Type();
/**
 * @generated ServiceType for protobuf service envoy.service.load_stats.v3.LoadReportingService
 */
export const LoadReportingService = new ServiceType("envoy.service.load_stats.v3.LoadReportingService", [
