...
// @generated from protobuf file "envoy/service/accesslog/v2/als.proto" (package "envoy.service.accesslog.v2", syntax proto3)
// tslint:disable
...
import { TCPAccessLogEntry } from "../../../data/accesslog/v2/accesslog";
import { HTTPAccessLogEntry } from "../../../data/accesslog/v2/accesslog";
import { Node } from "../../../api/v2/core/base";
/**
 * Empty response for the StreamAccessLogs API. Will never be sent. See below.
 *
 * @generated from protobuf message envoy.service.accesslog.v2.StreamAccessLogsResponse
 */
 ...
 *
 * @generated from protobuf message envoy.service.accesslog.v2.StreamAccessLogsMessage
 */
export interface StreamAccessLogsMessage {
     ...
     *
     * @generated from protobuf field: envoy.service.accesslog.v2.StreamAccessLogsMessage.Identifier identifier = 1;
     */
    ...
    logEntries: {
        oneofKind: "httpLogs";
        /**
         * @generated from protobuf field: envoy.service.accesslog.v2.StreamAccessLogsMessage.HTTPAccessLogEntries http_logs = 2;
         */
        httpLogs: StreamAccessLogsMessage_HTTPAccessLogEntries;
    } | {
        oneofKind: "tcpLogs";
        /**
         * @generated from protobuf field: envoy.service.accesslog.v2.StreamAccessLogsMessage.TCPAccessLogEntries tcp_logs = 3;
         */
...
/**
 * @generated from protobuf message envoy.service.accesslog.v2.StreamAccessLogsMessage.Identifier
 */
 ...
 *
 * @generated from protobuf message envoy.service.accesslog.v2.StreamAccessLogsMessage.HTTPAccessLogEntries
 */
export interface StreamAccessLogsMessage_HTTPAccessLogEntries {
    /**
     * @generated from protobuf field: repeated envoy.data.accesslog.v2.HTTPAccessLogEntry log_entry = 1;
     */
 ...
 *
 * @generated from protobuf message envoy.service.accesslog.v2.StreamAccessLogsMessage.TCPAccessLogEntries
 */
export interface StreamAccessLogsMessage_TCPAccessLogEntries {
    /**
     * @generated from protobuf field: repeated envoy.data.accesslog.v2.TCPAccessLogEntry log_entry = 1;
     */
...
class StreamAccessLogsResponse$Type extends MessageType<StreamAccessLogsResponse> {
    constructor() {
        super("envoy.service.accesslog.v2.StreamAccessLogsResponse", []);
    }
...
/**
 * @generated MessageType for protobuf message envoy.service.accesslog.v2.StreamAccessLogsResponse
 */
...
class StreamAccessLogsMessage$Type extends MessageType<StreamAccessLogsMessage> {
    constructor() {
        super("envoy.service.accesslog.v2.StreamAccessLogsMessage", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: StreamAccessLogsMessage): StreamAccessLogsMessage {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* envoy.service.accesslog.v2.StreamAccessLogsMessage.Identifier identifier */ 1:
                    message.identifier = StreamAccessLogsMessage_Identifier.internalBinaryRead(reader, reader.uint32(), options, message.identifier);
                    break;
                case /* envoy.service.accesslog.v2.StreamAccessLogsMessage.HTTPAccessLogEntries http_logs */ 2:
                    message.logEntries = {
                        oneofKind: "httpLogs",
                    ...
                    break;
                case /* envoy.service.accesslog.v2.StreamAccessLogsMessage.TCPAccessLogEntries tcp_logs */ 3:
                    message.logEntries = {
                        oneofKind: "tcpLogs",
...
/**
 * @generated MessageType for protobuf message envoy.service.accesslog.v2.StreamAccessLogsMessage
 */
...
class StreamAccessLogsMessage_Identifier$Type extends MessageType<StreamAccessLogsMessage_Identifier> {
    constructor() {
        super("envoy.service.accesslog.v2.StreamAccessLogsMessage.Identifier", [
            { no: 1, name: "node", kind: "message", T: () => Node, options: { "validate.rules": { message: { required: true } } } },
            { no: 2, name: "log_name", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "validate.rules": { string: { minBytes: "1" } } } }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message envoy.service.accesslog.v2.StreamAccessLogsMessage.Identifier
 */
...
class StreamAccessLogsMessage_HTTPAccessLogEntries$Type extends MessageType<StreamAccessLogsMessage_HTTPAccessLogEntries> {
    constructor() {
        super("envoy.service.accesslog.v2.StreamAccessLogsMessage.HTTPAccessLogEntries", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: StreamAccessLogsMessage_HTTPAccessLogEntries): StreamAccessLogsMessage_HTTPAccessLogEntries {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated envoy.data.accesslog.v2.HTTPAccessLogEntry log_entry */ 1:
...
/**
 * @generated MessageType for protobuf message envoy.service.accesslog.v2.StreamAccessLogsMessage.HTTPAccessLogEntries
 */
...
class StreamAccessLogsMessage_TCPAccessLogEntries$Type extends MessageType<StreamAccessLogsMessage_TCPAccessLogEntries> {
    constructor() {
        super("envoy.service.accesslog.v2.StreamAccessLogsMessage.TCPAccessLogEntries", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: StreamAccessLogsMessage_TCPAccessLogEntries): StreamAccessLogsMessage_TCPAccessLogEntries {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated envoy.data.accesslog.v2.TCPAccessLogEntry log_entry */ 1:
...
/**
 * @generated MessageType for protobuf message envoy.service.accesslog.v2.StreamAccessLogsMessage.TCPAccessLogEntries
 */
export const StreamAccessLogsMessage_TCPAccessLogEntries = new StreamAccessLogsMessage_TCPAccessLogEntries$Type();
/**
 * @generated ServiceType for protobuf service envoy.service.accesslog.v2.AccessLogService
 */
export const AccessLogService = new ServiceType("envoy.service.accesslog.v2.AccessLogService", [
