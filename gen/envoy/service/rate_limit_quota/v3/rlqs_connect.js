 ...
 */
export const RateLimitQuotaService = {
  typeName: "envoy.service.rate_limit_quota.v3.RateLimitQuotaService",
  methods: {
    /**
    ...
    streamRateLimitQuotas: {
      name: "StreamRateLimitQuotas",
      I: RateLimitQuotaUsageReports,
      O: RateLimitQuotaResponse,
