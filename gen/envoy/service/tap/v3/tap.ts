 ...
 *
 * @generated from protobuf message envoy.service.tap.v3.StreamTapsRequest
 */
export interface StreamTapsRequest {
     ...
     *
     * @generated from protobuf field: envoy.service.tap.v3.StreamTapsRequest.Identifier identifier = 1;
     */
     ...
     * The trace data.
     *
     * @generated from protobuf field: envoy.data.tap.v3.TraceWrapper trace = 3;
     */
    trace?: TraceWrapper;
}
/**
 * @generated from protobuf message envoy.service.tap.v3.StreamTapsRequest.Identifier
 */
 ...
 *
 * @generated from protobuf message envoy.service.tap.v3.StreamTapsResponse
 */
...
class StreamTapsRequest$Type extends MessageType<StreamTapsRequest> {
    constructor() {
        super("envoy.service.tap.v3.StreamTapsRequest", [
        ...
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.service.tap.v2alpha.StreamTapsRequest" } });
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: StreamTapsRequest): StreamTapsRequest {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* envoy.service.tap.v3.StreamTapsRequest.Identifier identifier */ 1:
                ...
                case /* uint64 trace_id */ 2:
                    ...
                    break;
                case /* envoy.data.tap.v3.TraceWrapper trace */ 3:
...
/**
 * @generated MessageType for protobuf message envoy.service.tap.v3.StreamTapsRequest
 */
...
class StreamTapsRequest_Identifier$Type extends MessageType<StreamTapsRequest_Identifier> {
    constructor() {
        super("envoy.service.tap.v3.StreamTapsRequest.Identifier", [
        ...
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.service.tap.v2alpha.StreamTapsRequest.Identifier" } });
    }
...
/**
 * @generated MessageType for protobuf message envoy.service.tap.v3.StreamTapsRequest.Identifier
 */
...
class StreamTapsResponse$Type extends MessageType<StreamTapsResponse> {
    constructor() {
        super("envoy.service.tap.v3.StreamTapsResponse", [], { "udpa.annotations.versioning": { previousMessageType: "envoy.service.tap.v2alpha.StreamTapsResponse" } });
    }
...
/**
 * @generated MessageType for protobuf message envoy.service.tap.v3.StreamTapsResponse
 */
export const StreamTapsResponse = new StreamTapsResponse$Type();
/**
 * @generated ServiceType for protobuf service envoy.service.tap.v3.TapSinkService
 */
export const TapSinkService = new ServiceType("envoy.service.tap.v3.TapSinkService", [
