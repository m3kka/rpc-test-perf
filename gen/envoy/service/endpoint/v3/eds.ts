...
// @generated from protobuf file "envoy/service/endpoint/v3/eds.proto" (package "envoy.service.endpoint.v3", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message envoy.service.endpoint.v3.EdsDummy
 */
...
class EdsDummy$Type extends MessageType<EdsDummy> {
    constructor() {
        super("envoy.service.endpoint.v3.EdsDummy", [], { "udpa.annotations.versioning": { previousMessageType: "envoy.api.v2.EdsDummy" } });
    }
...
/**
 * @generated MessageType for protobuf message envoy.service.endpoint.v3.EdsDummy
 */
export const EdsDummy = new EdsDummy$Type();
/**
 * @generated ServiceType for protobuf service envoy.service.endpoint.v3.EndpointDiscoveryService
 */
export const EndpointDiscoveryService = new ServiceType("envoy.service.endpoint.v3.EndpointDiscoveryService", [
    ...
    { name: "FetchEndpoints", options: { "google.api.http": { post: "/v3/discovery:endpoints", body: "*" } }, I: DiscoveryRequest, O: DiscoveryResponse }
], { "envoy.annotations.resource": { type: "envoy.config.endpoint.v3.ClusterLoadAssignment" } });
