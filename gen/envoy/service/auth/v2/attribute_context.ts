...
// @generated from protobuf file "envoy/service/auth/v2/attribute_context.proto" (package "envoy.service.auth.v2", syntax proto3)
// tslint:disable
 ...
 * [#next-free-field: 12]
 *
 * @generated from protobuf message envoy.service.auth.v2.AttributeContext
 */
export interface AttributeContext {
     ...
     * last hop.
     *
     * @generated from protobuf field: envoy.service.auth.v2.AttributeContext.Peer source = 1;
     */
     ...
     * the last hop.
     *
     * @generated from protobuf field: envoy.service.auth.v2.AttributeContext.Peer destination = 2;
     */
    destination?: AttributeContext_Peer;
    /**
     * Represents a network request, such as an HTTP request.
     *
     * @generated from protobuf field: envoy.service.auth.v2.AttributeContext.Request request = 4;
     */
     ...
     *
     * @generated from protobuf field: envoy.api.v2.core.Metadata metadata_context = 11;
     */
 ...
 * [#next-free-field: 6]
 *
 * @generated from protobuf message envoy.service.auth.v2.AttributeContext.Peer
 */
 ...
 * Represents a network request, such as an HTTP request.
 *
 * @generated from protobuf message envoy.service.auth.v2.AttributeContext.Request
 */
export interface AttributeContext_Request {
     ...
     *
     * @generated from protobuf field: envoy.service.auth.v2.AttributeContext.HttpRequest http = 2;
     */
 ...
 * [#next-free-field: 12]
 *
 * @generated from protobuf message envoy.service.auth.v2.AttributeContext.HttpRequest
 */
...
class AttributeContext$Type extends MessageType<AttributeContext> {
    constructor() {
        super("envoy.service.auth.v2.AttributeContext", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* map<string, string> context_extensions */ 10:
                    ...
                    break;
                case /* envoy.api.v2.core.Metadata metadata_context */ 11:
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field envoy.service.auth.v2.AttributeContext.context_extensions");
            }
        }
        map[key ?? ""] = val ?? "";
    }
...
/**
 * @generated MessageType for protobuf message envoy.service.auth.v2.AttributeContext
 */
...
class AttributeContext_Peer$Type extends MessageType<AttributeContext_Peer> {
    constructor() {
        super("envoy.service.auth.v2.AttributeContext.Peer", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field envoy.service.auth.v2.AttributeContext.Peer.labels");
            }
        }
        map[key ?? ""] = val ?? "";
    }
...
/**
 * @generated MessageType for protobuf message envoy.service.auth.v2.AttributeContext.Peer
 */
...
class AttributeContext_Request$Type extends MessageType<AttributeContext_Request> {
    constructor() {
        super("envoy.service.auth.v2.AttributeContext.Request", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* google.protobuf.Timestamp time */ 1:
                    ...
                    break;
                case /* envoy.service.auth.v2.AttributeContext.HttpRequest http */ 2:
...
/**
 * @generated MessageType for protobuf message envoy.service.auth.v2.AttributeContext.Request
 */
...
class AttributeContext_HttpRequest$Type extends MessageType<AttributeContext_HttpRequest> {
    constructor() {
        super("envoy.service.auth.v2.AttributeContext.HttpRequest", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field envoy.service.auth.v2.AttributeContext.HttpRequest.headers");
            }
        }
        map[key ?? ""] = val ?? "";
    }
...
/**
 * @generated MessageType for protobuf message envoy.service.auth.v2.AttributeContext.HttpRequest
 */
