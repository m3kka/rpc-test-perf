...
import type { CheckResponse } from "../v2/external_auth";
import type { CheckRequest } from "../v2/external_auth";
 ...
 *
 * @generated from protobuf service envoy.service.auth.v2alpha.Authorization
 */
export interface IAuthorizationClient {
     ...
     *
     * @generated from protobuf rpc: Check(envoy.service.auth.v2.CheckRequest) returns (envoy.service.auth.v2.CheckResponse);
     */
