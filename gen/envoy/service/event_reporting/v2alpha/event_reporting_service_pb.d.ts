...
export declare class StreamEventsRequest extends Message<StreamEventsRequest> {
  ...
  static readonly typeName = "envoy.service.event_reporting.v2alpha.StreamEventsRequest";
...
export declare class StreamEventsRequest_Identifier extends Message<StreamEventsRequest_Identifier> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "envoy.service.event_reporting.v2alpha.StreamEventsRequest.Identifier";
  static readonly fields: FieldList;
...
export declare class StreamEventsResponse extends Message<StreamEventsResponse> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "envoy.service.event_reporting.v2alpha.StreamEventsResponse";
  static readonly fields: FieldList;
