...
export declare class StreamTracesResponse extends Message<StreamTracesResponse> {
  ...
  static readonly typeName = "envoy.service.trace.v2.StreamTracesResponse";
...
export declare class StreamTracesMessage extends Message<StreamTracesMessage> {
   ...
   * on the stream.
   *
   * @generated from field: envoy.service.trace.v2.StreamTracesMessage.Identifier identifier = 1;
   */
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "envoy.service.trace.v2.StreamTracesMessage";
  static readonly fields: FieldList;
...
export declare class StreamTracesMessage_Identifier extends Message<StreamTracesMessage_Identifier> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "envoy.service.trace.v2.StreamTracesMessage.Identifier";
  static readonly fields: FieldList;
