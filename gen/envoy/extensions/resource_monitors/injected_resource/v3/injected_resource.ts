...
// @generated from protobuf file "envoy/extensions/resource_monitors/injected_resource/v3/injected_resource.proto" (package "envoy.extensions.resource_monitors.injected_resource.v3", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message envoy.extensions.resource_monitors.injected_resource.v3.InjectedResourceConfig
 */
...
class InjectedResourceConfig$Type extends MessageType<InjectedResourceConfig> {
    constructor() {
        super("envoy.extensions.resource_monitors.injected_resource.v3.InjectedResourceConfig", [
            { no: 1, name: "filename", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "validate.rules": { string: { minLen: "1" } } } }
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.resource_monitor.injected_resource.v2alpha.InjectedResourceConfig" } });
    }
...
/**
 * @generated MessageType for protobuf message envoy.extensions.resource_monitors.injected_resource.v3.InjectedResourceConfig
 */
