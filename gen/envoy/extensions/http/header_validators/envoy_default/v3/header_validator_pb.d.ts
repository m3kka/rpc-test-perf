 ...
 */
export declare class HeaderValidatorConfig extends Message<HeaderValidatorConfig> {
  /**
  ...
  constructor(data?: PartialMessage<HeaderValidatorConfig>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "envoy.extensions.http.header_validators.envoy_default.v3.HeaderValidatorConfig";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): HeaderValidatorConfig;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): HeaderValidatorConfig;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): HeaderValidatorConfig;

  static equals(a: HeaderValidatorConfig | PlainMessage<HeaderValidatorConfig> | undefined, b: HeaderValidatorConfig | PlainMessage<HeaderValidatorConfig> | undefined): boolean;
}
 ...
 */
export declare enum HeaderValidatorConfig_HeadersWithUnderscoresAction {
  /**
 ...
 */
export declare class HeaderValidatorConfig_UriPathNormalizationOptions extends Message<HeaderValidatorConfig_UriPathNormalizationOptions> {
  /**
  ...
  constructor(data?: PartialMessage<HeaderValidatorConfig_UriPathNormalizationOptions>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "envoy.extensions.http.header_validators.envoy_default.v3.HeaderValidatorConfig.UriPathNormalizationOptions";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): HeaderValidatorConfig_UriPathNormalizationOptions;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): HeaderValidatorConfig_UriPathNormalizationOptions;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): HeaderValidatorConfig_UriPathNormalizationOptions;

  static equals(a: HeaderValidatorConfig_UriPathNormalizationOptions | PlainMessage<HeaderValidatorConfig_UriPathNormalizationOptions> | undefined, b: HeaderValidatorConfig_UriPathNormalizationOptions | PlainMessage<HeaderValidatorConfig_UriPathNormalizationOptions> | undefined): boolean;
}
 ...
 */
export declare enum HeaderValidatorConfig_UriPathNormalizationOptions_PathWithEscapedSlashesAction {
  /**
 ...
 */
export declare class HeaderValidatorConfig_Http1ProtocolOptions extends Message<HeaderValidatorConfig_Http1ProtocolOptions> {
  /**
  ...
  constructor(data?: PartialMessage<HeaderValidatorConfig_Http1ProtocolOptions>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "envoy.extensions.http.header_validators.envoy_default.v3.HeaderValidatorConfig.Http1ProtocolOptions";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): HeaderValidatorConfig_Http1ProtocolOptions;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): HeaderValidatorConfig_Http1ProtocolOptions;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): HeaderValidatorConfig_Http1ProtocolOptions;

  static equals(a: HeaderValidatorConfig_Http1ProtocolOptions | PlainMessage<HeaderValidatorConfig_Http1ProtocolOptions> | undefined, b: HeaderValidatorConfig_Http1ProtocolOptions | PlainMessage<HeaderValidatorConfig_Http1ProtocolOptions> | undefined): boolean;
}
