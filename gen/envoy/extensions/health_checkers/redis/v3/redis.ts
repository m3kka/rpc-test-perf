...
// @generated from protobuf file "envoy/extensions/health_checkers/redis/v3/redis.proto" (package "envoy.extensions.health_checkers.redis.v3", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message envoy.extensions.health_checkers.redis.v3.Redis
 */
...
class Redis$Type extends MessageType<Redis> {
    constructor() {
        super("envoy.extensions.health_checkers.redis.v3.Redis", [
            { no: 1, name: "key", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.health_checker.redis.v2.Redis" } });
    }
...
/**
 * @generated MessageType for protobuf message envoy.extensions.health_checkers.redis.v3.Redis
 */
