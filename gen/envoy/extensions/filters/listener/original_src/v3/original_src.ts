...
// @generated from protobuf file "envoy/extensions/filters/listener/original_src/v3/original_src.proto" (package "envoy.extensions.filters.listener.original_src.v3", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message envoy.extensions.filters.listener.original_src.v3.OriginalSrc
 */
...
class OriginalSrc$Type extends MessageType<OriginalSrc> {
    constructor() {
        super("envoy.extensions.filters.listener.original_src.v3.OriginalSrc", [
            { no: 1, name: "bind_port", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
            { no: 2, name: "mark", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.filter.listener.original_src.v2alpha1.OriginalSrc" } });
    }
...
/**
 * @generated MessageType for protobuf message envoy.extensions.filters.listener.original_src.v3.OriginalSrc
 */
