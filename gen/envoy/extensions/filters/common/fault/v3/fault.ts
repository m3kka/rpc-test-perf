...
// @generated from protobuf file "envoy/extensions/filters/common/fault/v3/fault.proto" (package "envoy.extensions.filters.common.fault.v3", syntax proto3)
// tslint:disable
 ...
 * [#next-free-field: 6]
 *
 * @generated from protobuf message envoy.extensions.filters.common.fault.v3.FaultDelay
 */
export interface FaultDelay {
    ...
    faultDelaySecifier: {
         ...
         *
         * @generated from protobuf field: envoy.extensions.filters.common.fault.v3.FaultDelay.HeaderDelay header_delay = 5;
         */
     ...
     *
     * @generated from protobuf field: envoy.type.v3.FractionalPercent percentage = 4;
     */
 ...
 * more information.
 *
 * @generated from protobuf message envoy.extensions.filters.common.fault.v3.FaultDelay.HeaderDelay
 */
export interface FaultDelay_HeaderDelay {
}
/**
 * @generated from protobuf enum envoy.extensions.filters.common.fault.v3.FaultDelay.FaultDelayType
 */
 ...
 *
 * @generated from protobuf message envoy.extensions.filters.common.fault.v3.FaultRateLimit
 */
export interface FaultRateLimit {
    ...
    limitType: {
         ...
         * A fixed rate limit.
         *
         * @generated from protobuf field: envoy.extensions.filters.common.fault.v3.FaultRateLimit.FixedLimit fixed_limit = 1;
         */
         ...
         *
         * @generated from protobuf field: envoy.extensions.filters.common.fault.v3.FaultRateLimit.HeaderLimit header_limit = 3;
         */
     ...
     *
     * @generated from protobuf field: envoy.type.v3.FractionalPercent percentage = 2;
     */
    percentage?: FractionalPercent;
}
/**
 ...
 *
 * @generated from protobuf message envoy.extensions.filters.common.fault.v3.FaultRateLimit.FixedLimit
 */
 ...
 * more information.
 *
 * @generated from protobuf message envoy.extensions.filters.common.fault.v3.FaultRateLimit.HeaderLimit
 */
...
class FaultDelay$Type extends MessageType<FaultDelay> {
    constructor() {
        super("envoy.extensions.filters.common.fault.v3.FaultDelay", [
        ...
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.filter.fault.v2.FaultDelay" } });
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* google.protobuf.Duration fixed_delay */ 3:
                    ...
                    break;
                case /* envoy.extensions.filters.common.fault.v3.FaultDelay.HeaderDelay header_delay */ 5:
                    message.faultDelaySecifier = {
                        oneofKind: "headerDelay",
                    ...
                    break;
                case /* envoy.type.v3.FractionalPercent percentage */ 4:
...
/**
 * @generated MessageType for protobuf message envoy.extensions.filters.common.fault.v3.FaultDelay
 */
export const FaultDelay = new FaultDelay$Type();
// @generated message type with reflection information, may provide speed optimized methods
class FaultDelay_HeaderDelay$Type extends MessageType<FaultDelay_HeaderDelay> {
    constructor() {
        super("envoy.extensions.filters.common.fault.v3.FaultDelay.HeaderDelay", [], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.filter.fault.v2.FaultDelay.HeaderDelay" } });
    }
...
/**
 * @generated MessageType for protobuf message envoy.extensions.filters.common.fault.v3.FaultDelay.HeaderDelay
 */
...
class FaultRateLimit$Type extends MessageType<FaultRateLimit> {
    constructor() {
        super("envoy.extensions.filters.common.fault.v3.FaultRateLimit", [
        ...
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.filter.fault.v2.FaultRateLimit" } });
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: FaultRateLimit): FaultRateLimit {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* envoy.extensions.filters.common.fault.v3.FaultRateLimit.FixedLimit fixed_limit */ 1:
                    message.limitType = {
                        oneofKind: "fixedLimit",
                        fixedLimit: FaultRateLimit_FixedLimit.internalBinaryRead(reader, reader.uint32(), options, (message.limitType as any).fixedLimit)
                    };
                    break;
                case /* envoy.extensions.filters.common.fault.v3.FaultRateLimit.HeaderLimit header_limit */ 3:
                    message.limitType = {
                        oneofKind: "headerLimit",
                    ...
                    break;
                case /* envoy.type.v3.FractionalPercent percentage */ 2:
                    message.percentage = FractionalPercent.internalBinaryRead(reader, reader.uint32(), options, message.percentage);
                    break;
                default:
                    let u = options.readUnknownField;
...
/**
 * @generated MessageType for protobuf message envoy.extensions.filters.common.fault.v3.FaultRateLimit
 */
...
class FaultRateLimit_FixedLimit$Type extends MessageType<FaultRateLimit_FixedLimit> {
    constructor() {
        super("envoy.extensions.filters.common.fault.v3.FaultRateLimit.FixedLimit", [
            { no: 1, name: "limit_kbps", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/, options: { "validate.rules": { uint64: { gte: "1" } } } }
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.filter.fault.v2.FaultRateLimit.FixedLimit" } });
    }
...
/**
 * @generated MessageType for protobuf message envoy.extensions.filters.common.fault.v3.FaultRateLimit.FixedLimit
 */
...
class FaultRateLimit_HeaderLimit$Type extends MessageType<FaultRateLimit_HeaderLimit> {
    constructor() {
        super("envoy.extensions.filters.common.fault.v3.FaultRateLimit.HeaderLimit", [], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.filter.fault.v2.FaultRateLimit.HeaderLimit" } });
    }
...
/**
 * @generated MessageType for protobuf message envoy.extensions.filters.common.fault.v3.FaultRateLimit.HeaderLimit
 */
