...
// @generated from protobuf file "envoy/extensions/filters/http/jwt_authn/v3/config.proto" (package "envoy.extensions.filters.http.jwt_authn.v3", syntax proto3)
// tslint:disable
 ...
 * [#next-free-field: 17]
 *
 * @generated from protobuf message envoy.extensions.filters.http.jwt_authn.v3.JwtProvider
 */
export interface JwtProvider {
    ...
    jwksSourceSpecifier: {
         ...
         *
         *
         * @generated from protobuf field: envoy.extensions.filters.http.jwt_authn.v3.RemoteJwks remote_jwks = 3;
         */
         ...
         *
         *
         * @generated from protobuf field: envoy.config.core.v3.DataSource local_jwks = 4;
         */
     ...
     *
     *
     * @generated from protobuf field: repeated envoy.extensions.filters.http.jwt_authn.v3.JwtHeader from_headers = 6;
     */
     ...
     *
     *
     * @generated from protobuf field: repeated string from_cookies = 13;
     */
    fromCookies: string[];
    /**
     ...
     * is specified.
     *
     * @generated from protobuf field: bool pad_forward_payload_header = 11;
     */
     ...
     *
     *
     * @generated from protobuf field: string header_in_metadata = 14;
     */
     ...
     *       message: Jwt expired
     *
     * @generated from protobuf field: string failed_status_in_metadata = 16;
     */
     ...
     *
     * @generated from protobuf field: uint32 clock_skew_seconds = 10;
     */
     ...
     *
     * @generated from protobuf field: envoy.extensions.filters.http.jwt_authn.v3.JwtCacheConfig jwt_cache_config = 12;
     */
     ...
     *
     * @generated from protobuf field: repeated envoy.extensions.filters.http.jwt_authn.v3.JwtClaimToHeader claim_to_headers = 15;
     */
 ...
 *
 * @generated from protobuf message envoy.extensions.filters.http.jwt_authn.v3.JwtCacheConfig
 */
export interface JwtCacheConfig {
    /**
     * The unit is number of JWT tokens, default to 100.
     *
     * @generated from protobuf field: uint32 jwt_cache_size = 1;
     */
    jwtCacheSize: number;
}
/**
 ...
 *
 * @generated from protobuf message envoy.extensions.filters.http.jwt_authn.v3.RemoteJwks
 */
export interface RemoteJwks {
     ...
     *
     *
     * @generated from protobuf field: envoy.extensions.filters.http.jwt_authn.v3.JwksAsyncFetch async_fetch = 3;
     */
     ...
     *
     *
     * @generated from protobuf field: envoy.config.core.v3.RetryPolicy retry_policy = 4;
     */
 ...
 *
 * @generated from protobuf message envoy.extensions.filters.http.jwt_authn.v3.JwksAsyncFetch
 */
export interface JwksAsyncFetch {
     ...
     * Default is false.
     *
     * @generated from protobuf field: bool fast_listener = 1;
     */
    fastListener: boolean;
    /**
     * The duration to refetch after a failed fetch. If not specified, default is 1 second.
     *
     * @generated from protobuf field: google.protobuf.Duration failed_refetch_duration = 2;
     */
 ...
 *
 * @generated from protobuf message envoy.extensions.filters.http.jwt_authn.v3.JwtHeader
 */
 ...
 *
 * @generated from protobuf message envoy.extensions.filters.http.jwt_authn.v3.ProviderWithAudiences
 */
 ...
 * [#next-free-field: 7]
 *
 * @generated from protobuf message envoy.extensions.filters.http.jwt_authn.v3.JwtRequirement
 */
export interface JwtRequirement {
    ...
    requiresType: {
         ...
         * Specify a required provider with audiences.
         *
         * @generated from protobuf field: envoy.extensions.filters.http.jwt_authn.v3.ProviderWithAudiences provider_and_audiences = 2;
         */
         ...
         *
         * @generated from protobuf field: envoy.extensions.filters.http.jwt_authn.v3.JwtRequirementOrList requires_any = 3;
         */
         ...
         *
         * @generated from protobuf field: envoy.extensions.filters.http.jwt_authn.v3.JwtRequirementAndList requires_all = 4;
         */
 ...
 *
 * @generated from protobuf message envoy.extensions.filters.http.jwt_authn.v3.JwtRequirementOrList
 */
export interface JwtRequirementOrList {
    /**
     * Specify a list of JwtRequirement.
     *
     * @generated from protobuf field: repeated envoy.extensions.filters.http.jwt_authn.v3.JwtRequirement requirements = 1;
     */
 ...
 *
 * @generated from protobuf message envoy.extensions.filters.http.jwt_authn.v3.JwtRequirementAndList
 */
 ...
 * from "provider-A".
 *
 * @generated from protobuf message envoy.extensions.filters.http.jwt_authn.v3.RequirementRule
 */
export interface RequirementRule {
    ...
    match?: RouteMatch;
    /**
     * @generated from protobuf oneof: requirement_type
     */
    requirementType: {
        oneofKind: "requires";
        /**
         ...
         *
         * @generated from protobuf field: envoy.extensions.filters.http.jwt_authn.v3.JwtRequirement requires = 2;
         */
        requires: JwtRequirement;
    } | {
        oneofKind: "requirementName";
        /**
         ...
         *
         * @generated from protobuf field: string requirement_name = 3;
         */
 ...
 *
 * @generated from protobuf message envoy.extensions.filters.http.jwt_authn.v3.FilterStateRule
 */
export interface FilterStateRule {
     ...
     *
     * @generated from protobuf field: map<string, envoy.extensions.filters.http.jwt_authn.v3.JwtRequirement> requires = 3;
     */
    requires: {
 ...
 * [#next-free-field: 6]
 *
 * @generated from protobuf message envoy.extensions.filters.http.jwt_authn.v3.JwtAuthentication
 */
export interface JwtAuthentication {
     ...
     *
     *
     * @generated from protobuf field: map<string, envoy.extensions.filters.http.jwt_authn.v3.JwtProvider> providers = 1;
     */
    providers: {
     ...
     *
     *
     * @generated from protobuf field: repeated envoy.extensions.filters.http.jwt_authn.v3.RequirementRule rules = 2;
     */
     ...
     * check this one.
     *
     * @generated from protobuf field: envoy.extensions.filters.http.jwt_authn.v3.FilterStateRule filter_state_rules = 3;
     */
     ...
     *
     * @generated from protobuf field: map<string, envoy.extensions.filters.http.jwt_authn.v3.JwtRequirement> requirement_map = 5;
     */
    requirementMap: {
        [key: string]: JwtRequirement;
    };
 ...
 *
 * @generated from protobuf message envoy.extensions.filters.http.jwt_authn.v3.PerRouteConfig
 */
export interface PerRouteConfig {
    /**
     * @generated from protobuf oneof: requirement_specifier
     */
    requirementSpecifier: {
         ...
         *
         * @generated from protobuf field: string requirement_name = 2;
         */
        requirementName: string;
    } | {
        oneofKind: undefined;
 ...
 *
 * @generated from protobuf message envoy.extensions.filters.http.jwt_authn.v3.JwtClaimToHeader
 */
export interface JwtClaimToHeader {
     ...
     * the JSON name path.
     *
     * @generated from protobuf field: string claim_name = 2;
     */
    claimName: string;
}
...
class JwtProvider$Type extends MessageType<JwtProvider> {
    constructor() {
        super("envoy.extensions.filters.http.jwt_authn.v3.JwtProvider", [
            ...
            { no: 13, name: "from_cookies", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            { no: 8, name: "forward_payload_header", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "validate.rules": { string: { wellKnownRegex: "HTTP_HEADER_NAME", strict: false } } } },
            ...
            { no: 15, name: "claim_to_headers", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => JwtClaimToHeader }
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.filter.http.jwt_authn.v2alpha.JwtProvider" } });
    }
    create(value?: PartialMessage<JwtProvider>): JwtProvider {
        ...
        message.padForwardPayloadHeader = false;
        message.payloadInMetadata = "";
        message.headerInMetadata = "";
        message.failedStatusInMetadata = "";
        message.clockSkewSeconds = 0;
        message.claimToHeaders = [];
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated string audiences */ 2:
                    ...
                    break;
                case /* envoy.extensions.filters.http.jwt_authn.v3.RemoteJwks remote_jwks */ 3:
                    ...
                    break;
                case /* envoy.config.core.v3.DataSource local_jwks */ 4:
                    message.jwksSourceSpecifier = {
                        oneofKind: "localJwks",
                ...
                case /* bool forward */ 5:
                    ...
                    break;
                case /* repeated envoy.extensions.filters.http.jwt_authn.v3.JwtHeader from_headers */ 6:
                ...
                case /* repeated string from_params */ 7:
                    ...
                    break;
                case /* repeated string from_cookies */ 13:
                    message.fromCookies.push(reader.string());
                    break;
                case /* string forward_payload_header */ 8:
                    message.forwardPayloadHeader = reader.string();
                    break;
                case /* bool pad_forward_payload_header */ 11:
                    message.padForwardPayloadHeader = reader.bool();
                    break;
                case /* string payload_in_metadata */ 9:
                    message.payloadInMetadata = reader.string();
                    break;
                case /* string header_in_metadata */ 14:
                    message.headerInMetadata = reader.string();
                    break;
                case /* string failed_status_in_metadata */ 16:
                    message.failedStatusInMetadata = reader.string();
                    break;
                case /* uint32 clock_skew_seconds */ 10:
                    message.clockSkewSeconds = reader.uint32();
                    break;
                case /* envoy.extensions.filters.http.jwt_authn.v3.JwtCacheConfig jwt_cache_config */ 12:
                    message.jwtCacheConfig = JwtCacheConfig.internalBinaryRead(reader, reader.uint32(), options, message.jwtCacheConfig);
                    break;
                case /* repeated envoy.extensions.filters.http.jwt_authn.v3.JwtClaimToHeader claim_to_headers */ 15:
                    message.claimToHeaders.push(JwtClaimToHeader.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
    ...
    internalBinaryWrite(message: JwtProvider, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.fromCookies.length; i++)
            writer.tag(13, WireType.LengthDelimited).string(message.fromCookies[i]);
        ...
        if (message.padForwardPayloadHeader !== false)
            writer.tag(11, WireType.Varint).bool(message.padForwardPayloadHeader);
        ...
        if (message.headerInMetadata !== "")
            writer.tag(14, WireType.LengthDelimited).string(message.headerInMetadata);
        /* string failed_status_in_metadata = 16; */
        if (message.failedStatusInMetadata !== "")
            writer.tag(16, WireType.LengthDelimited).string(message.failedStatusInMetadata);
        /* uint32 clock_skew_seconds = 10; */
        if (message.clockSkewSeconds !== 0)
            writer.tag(10, WireType.Varint).uint32(message.clockSkewSeconds);
        /* envoy.extensions.filters.http.jwt_authn.v3.JwtCacheConfig jwt_cache_config = 12; */
        if (message.jwtCacheConfig)
            JwtCacheConfig.internalBinaryWrite(message.jwtCacheConfig, writer.tag(12, WireType.LengthDelimited).fork(), options).join();
        /* repeated envoy.extensions.filters.http.jwt_authn.v3.JwtClaimToHeader claim_to_headers = 15; */
        for (let i = 0; i < message.claimToHeaders.length; i++)
            JwtClaimToHeader.internalBinaryWrite(message.claimToHeaders[i], writer.tag(15, WireType.LengthDelimited).fork(), options).join();
...
/**
 * @generated MessageType for protobuf message envoy.extensions.filters.http.jwt_authn.v3.JwtProvider
 */
export const JwtProvider = new JwtProvider$Type();
// @generated message type with reflection information, may provide speed optimized methods
class JwtCacheConfig$Type extends MessageType<JwtCacheConfig> {
    constructor() {
        super("envoy.extensions.filters.http.jwt_authn.v3.JwtCacheConfig", [
            { no: 1, name: "jwt_cache_size", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value?: PartialMessage<JwtCacheConfig>): JwtCacheConfig {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.jwtCacheSize = 0;
        if (value !== undefined)
            reflectionMergePartial<JwtCacheConfig>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: JwtCacheConfig): JwtCacheConfig {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* uint32 jwt_cache_size */ 1:
                    message.jwtCacheSize = reader.uint32();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: JwtCacheConfig, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint32 jwt_cache_size = 1; */
        if (message.jwtCacheSize !== 0)
            writer.tag(1, WireType.Varint).uint32(message.jwtCacheSize);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message envoy.extensions.filters.http.jwt_authn.v3.JwtCacheConfig
 */
export const JwtCacheConfig = new JwtCacheConfig$Type();
// @generated message type with reflection information, may provide speed optimized methods
class RemoteJwks$Type extends MessageType<RemoteJwks> {
    constructor() {
        super("envoy.extensions.filters.http.jwt_authn.v3.RemoteJwks", [
            { no: 1, name: "http_uri", kind: "message", T: () => HttpUri },
            { no: 2, name: "cache_duration", kind: "message", T: () => Duration, options: { "validate.rules": { duration: { lt: { seconds: "9000000000" }, gte: { nanos: 1000000 } } } } },
            { no: 3, name: "async_fetch", kind: "message", T: () => JwksAsyncFetch },
            { no: 4, name: "retry_policy", kind: "message", T: () => RetryPolicy }
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.filter.http.jwt_authn.v2alpha.RemoteJwks" } });
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* google.protobuf.Duration cache_duration */ 2:
                    ...
                    break;
                case /* envoy.extensions.filters.http.jwt_authn.v3.JwksAsyncFetch async_fetch */ 3:
                    message.asyncFetch = JwksAsyncFetch.internalBinaryRead(reader, reader.uint32(), options, message.asyncFetch);
                    break;
                case /* envoy.config.core.v3.RetryPolicy retry_policy */ 4:
    ...
    internalBinaryWrite(message: RemoteJwks, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.asyncFetch)
            JwksAsyncFetch.internalBinaryWrite(message.asyncFetch, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        /* envoy.config.core.v3.RetryPolicy retry_policy = 4; */
        if (message.retryPolicy)
            RetryPolicy.internalBinaryWrite(message.retryPolicy, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message envoy.extensions.filters.http.jwt_authn.v3.RemoteJwks
 */
export const RemoteJwks = new RemoteJwks$Type();
// @generated message type with reflection information, may provide speed optimized methods
class JwksAsyncFetch$Type extends MessageType<JwksAsyncFetch> {
    constructor() {
        super("envoy.extensions.filters.http.jwt_authn.v3.JwksAsyncFetch", [
            { no: 1, name: "fast_listener", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
            { no: 2, name: "failed_refetch_duration", kind: "message", T: () => Duration }
        ]);
    }
    create(value?: PartialMessage<JwksAsyncFetch>): JwksAsyncFetch {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.fastListener = false;
        if (value !== undefined)
            reflectionMergePartial<JwksAsyncFetch>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: JwksAsyncFetch): JwksAsyncFetch {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* bool fast_listener */ 1:
                    message.fastListener = reader.bool();
                    break;
                case /* google.protobuf.Duration failed_refetch_duration */ 2:
                    message.failedRefetchDuration = Duration.internalBinaryRead(reader, reader.uint32(), options, message.failedRefetchDuration);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: JwksAsyncFetch, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bool fast_listener = 1; */
        if (message.fastListener !== false)
            writer.tag(1, WireType.Varint).bool(message.fastListener);
        /* google.protobuf.Duration failed_refetch_duration = 2; */
        if (message.failedRefetchDuration)
            Duration.internalBinaryWrite(message.failedRefetchDuration, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message envoy.extensions.filters.http.jwt_authn.v3.JwksAsyncFetch
 */
export const JwksAsyncFetch = new JwksAsyncFetch$Type();
// @generated message type with reflection information, may provide speed optimized methods
class JwtHeader$Type extends MessageType<JwtHeader> {
    constructor() {
        super("envoy.extensions.filters.http.jwt_authn.v3.JwtHeader", [
        ...
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.filter.http.jwt_authn.v2alpha.JwtHeader" } });
    }
...
/**
 * @generated MessageType for protobuf message envoy.extensions.filters.http.jwt_authn.v3.JwtHeader
 */
export const JwtHeader = new JwtHeader$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ProviderWithAudiences$Type extends MessageType<ProviderWithAudiences> {
    constructor() {
        super("envoy.extensions.filters.http.jwt_authn.v3.ProviderWithAudiences", [
            { no: 1, name: "provider_name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "audiences", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ }
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.filter.http.jwt_authn.v2alpha.ProviderWithAudiences" } });
    }
...
/**
 * @generated MessageType for protobuf message envoy.extensions.filters.http.jwt_authn.v3.ProviderWithAudiences
 */
...
class JwtRequirement$Type extends MessageType<JwtRequirement> {
    constructor() {
        super("envoy.extensions.filters.http.jwt_authn.v3.JwtRequirement", [
        ...
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.filter.http.jwt_authn.v2alpha.JwtRequirement" } });
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string provider_name */ 1:
                    ...
                    break;
                case /* envoy.extensions.filters.http.jwt_authn.v3.ProviderWithAudiences provider_and_audiences */ 2:
                    message.requiresType = {
                        oneofKind: "providerAndAudiences",
                    ...
                    break;
                case /* envoy.extensions.filters.http.jwt_authn.v3.JwtRequirementOrList requires_any */ 3:
                    message.requiresType = {
                        oneofKind: "requiresAny",
                        requiresAny: JwtRequirementOrList.internalBinaryRead(reader, reader.uint32(), options, (message.requiresType as any).requiresAny)
                    };
                    break;
                case /* envoy.extensions.filters.http.jwt_authn.v3.JwtRequirementAndList requires_all */ 4:
                    message.requiresType = {
                        oneofKind: "requiresAll",
...
/**
 * @generated MessageType for protobuf message envoy.extensions.filters.http.jwt_authn.v3.JwtRequirement
 */
...
class JwtRequirementOrList$Type extends MessageType<JwtRequirementOrList> {
    constructor() {
        super("envoy.extensions.filters.http.jwt_authn.v3.JwtRequirementOrList", [
        ...
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.filter.http.jwt_authn.v2alpha.JwtRequirementOrList" } });
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: JwtRequirementOrList): JwtRequirementOrList {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated envoy.extensions.filters.http.jwt_authn.v3.JwtRequirement requirements */ 1:
...
/**
 * @generated MessageType for protobuf message envoy.extensions.filters.http.jwt_authn.v3.JwtRequirementOrList
 */
...
class JwtRequirementAndList$Type extends MessageType<JwtRequirementAndList> {
    constructor() {
        super("envoy.extensions.filters.http.jwt_authn.v3.JwtRequirementAndList", [
            { no: 1, name: "requirements", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => JwtRequirement, options: { "validate.rules": { repeated: { minItems: "2" } } } }
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.filter.http.jwt_authn.v2alpha.JwtRequirementAndList" } });
    }
...
/**
 * @generated MessageType for protobuf message envoy.extensions.filters.http.jwt_authn.v3.JwtRequirementAndList
 */
...
class RequirementRule$Type extends MessageType<RequirementRule> {
    constructor() {
        super("envoy.extensions.filters.http.jwt_authn.v3.RequirementRule", [
            { no: 1, name: "match", kind: "message", T: () => RouteMatch, options: { "validate.rules": { message: { required: true } } } },
            { no: 2, name: "requires", kind: "message", oneof: "requirementType", T: () => JwtRequirement },
            { no: 3, name: "requirement_name", kind: "scalar", oneof: "requirementType", T: 9 /*ScalarType.STRING*/, options: { "validate.rules": { string: { minLen: "1" } } } }
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.filter.http.jwt_authn.v2alpha.RequirementRule" } });
    }
    create(value?: PartialMessage<RequirementRule>): RequirementRule {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.requirementType = { oneofKind: undefined };
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* envoy.config.route.v3.RouteMatch match */ 1:
                    ...
                    break;
                case /* envoy.extensions.filters.http.jwt_authn.v3.JwtRequirement requires */ 2:
                    message.requirementType = {
                        oneofKind: "requires",
                        requires: JwtRequirement.internalBinaryRead(reader, reader.uint32(), options, (message.requirementType as any).requires)
                    };
                    break;
                case /* string requirement_name */ 3:
                    message.requirementType = {
                        oneofKind: "requirementName",
                        requirementName: reader.string()
                    };
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: RequirementRule, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.requirementType.oneofKind === "requires")
            JwtRequirement.internalBinaryWrite(message.requirementType.requires, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        /* string requirement_name = 3; */
        if (message.requirementType.oneofKind === "requirementName")
            writer.tag(3, WireType.LengthDelimited).string(message.requirementType.requirementName);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message envoy.extensions.filters.http.jwt_authn.v3.RequirementRule
 */
export const RequirementRule = new RequirementRule$Type();
// @generated message type with reflection information, may provide speed optimized methods
class FilterStateRule$Type extends MessageType<FilterStateRule> {
    constructor() {
        super("envoy.extensions.filters.http.jwt_authn.v3.FilterStateRule", [
        ...
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.filter.http.jwt_authn.v2alpha.FilterStateRule" } });
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string name */ 1:
                    message.name = reader.string();
                    break;
                case /* map<string, envoy.extensions.filters.http.jwt_authn.v3.JwtRequirement> requires */ 3:
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    ...
                    break;
                default: throw new globalThis.Error("unknown map entry field for field envoy.extensions.filters.http.jwt_authn.v3.FilterStateRule.requires");
            }
        }
...
/**
 * @generated MessageType for protobuf message envoy.extensions.filters.http.jwt_authn.v3.FilterStateRule
 */
export const FilterStateRule = new FilterStateRule$Type();
// @generated message type with reflection information, may provide speed optimized methods
class JwtAuthentication$Type extends MessageType<JwtAuthentication> {
    constructor() {
        super("envoy.extensions.filters.http.jwt_authn.v3.JwtAuthentication", [
        ...
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.filter.http.jwt_authn.v2alpha.JwtAuthentication" } });
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: JwtAuthentication): JwtAuthentication {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* map<string, envoy.extensions.filters.http.jwt_authn.v3.JwtProvider> providers */ 1:
                    this.binaryReadMap1(message.providers, reader, options);
                    break;
                case /* repeated envoy.extensions.filters.http.jwt_authn.v3.RequirementRule rules */ 2:
                    message.rules.push(RequirementRule.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* envoy.extensions.filters.http.jwt_authn.v3.FilterStateRule filter_state_rules */ 3:
                ...
                case /* bool bypass_cors_preflight */ 4:
                    ...
                    break;
                case /* map<string, envoy.extensions.filters.http.jwt_authn.v3.JwtRequirement> requirement_map */ 5:
                    this.binaryReadMap5(message.requirementMap, reader, options);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    ...
                    break;
                default: throw new globalThis.Error("unknown map entry field for field envoy.extensions.filters.http.jwt_authn.v3.JwtAuthentication.providers");
            }
        }
        map[key ?? ""] = val ?? JwtProvider.create();
    }
    private binaryReadMap5(map: JwtAuthentication["requirementMap"], reader: IBinaryReader, options: BinaryReadOptions): void {
        let len = reader.uint32(), end = reader.pos + len, key: keyof JwtAuthentication["requirementMap"] | undefined, val: JwtAuthentication["requirementMap"][any] | undefined;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case 1:
                ...
                case 2:
                    val = JwtRequirement.internalBinaryRead(reader, reader.uint32(), options);
                    break;
                default: throw new globalThis.Error("unknown map entry field for field envoy.extensions.filters.http.jwt_authn.v3.JwtAuthentication.requirement_map");
            }
        }
        map[key ?? ""] = val ?? JwtRequirement.create();
    }
    internalBinaryWrite(message: JwtAuthentication, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let k of globalThis.Object.keys(message.requirementMap)) {
            writer.tag(5, WireType.LengthDelimited).fork().tag(1, WireType.LengthDelimited).string(k);
            writer.tag(2, WireType.LengthDelimited).fork();
            JwtRequirement.internalBinaryWrite(message.requirementMap[k], writer, options);
            writer.join().join();
        }
        let u = options.writeUnknownFields;
        if (u !== false)
...
/**
 * @generated MessageType for protobuf message envoy.extensions.filters.http.jwt_authn.v3.JwtAuthentication
 */
export const JwtAuthentication = new JwtAuthentication$Type();
// @generated message type with reflection information, may provide speed optimized methods
class PerRouteConfig$Type extends MessageType<PerRouteConfig> {
    constructor() {
        super("envoy.extensions.filters.http.jwt_authn.v3.PerRouteConfig", [
            { no: 1, name: "disabled", kind: "scalar", oneof: "requirementSpecifier", T: 8 /*ScalarType.BOOL*/, options: { "validate.rules": { bool: { const: true } } } },
            { no: 2, name: "requirement_name", kind: "scalar", oneof: "requirementSpecifier", T: 9 /*ScalarType.STRING*/, options: { "validate.rules": { string: { minLen: "1" } } } }
        ]);
    }
    create(value?: PartialMessage<PerRouteConfig>): PerRouteConfig {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.requirementSpecifier = { oneofKind: undefined };
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* bool disabled */ 1:
                    message.requirementSpecifier = {
                        oneofKind: "disabled",
                        disabled: reader.bool()
                    };
                    break;
                case /* string requirement_name */ 2:
                    message.requirementSpecifier = {
                        oneofKind: "requirementName",
                        requirementName: reader.string()
                    };
    ...
    internalBinaryWrite(message: PerRouteConfig, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bool disabled = 1; */
        if (message.requirementSpecifier.oneofKind === "disabled")
            writer.tag(1, WireType.Varint).bool(message.requirementSpecifier.disabled);
        /* string requirement_name = 2; */
        if (message.requirementSpecifier.oneofKind === "requirementName")
            writer.tag(2, WireType.LengthDelimited).string(message.requirementSpecifier.requirementName);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message envoy.extensions.filters.http.jwt_authn.v3.PerRouteConfig
 */
export const PerRouteConfig = new PerRouteConfig$Type();
// @generated message type with reflection information, may provide speed optimized methods
class JwtClaimToHeader$Type extends MessageType<JwtClaimToHeader> {
    constructor() {
        super("envoy.extensions.filters.http.jwt_authn.v3.JwtClaimToHeader", [
            ...
            { no: 2, name: "claim_name", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "validate.rules": { string: { minLen: "1" } } } }
        ]);
    }
    create(value?: PartialMessage<JwtClaimToHeader>): JwtClaimToHeader {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.headerName = "";
        message.claimName = "";
        if (value !== undefined)
            reflectionMergePartial<JwtClaimToHeader>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: JwtClaimToHeader): JwtClaimToHeader {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: JwtClaimToHeader, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string header_name = 1; */
        if (message.headerName !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.headerName);
        /* string claim_name = 2; */
        if (message.claimName !== "")
            writer.tag(2, WireType.LengthDelimited).string(message.claimName);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message envoy.extensions.filters.http.jwt_authn.v3.JwtClaimToHeader
 */
export const JwtClaimToHeader = new JwtClaimToHeader$Type();
