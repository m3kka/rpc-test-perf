...
// @generated from protobuf file "envoy/extensions/filters/http/ip_tagging/v3/ip_tagging.proto" (package "envoy.extensions.filters.http.ip_tagging.v3", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message envoy.extensions.filters.http.ip_tagging.v3.IPTagging
 */
export interface IPTagging {
    /**
     * The type of request the filter should apply to.
     *
     * @generated from protobuf field: envoy.extensions.filters.http.ip_tagging.v3.IPTagging.RequestType request_type = 1;
     */
     ...
     *
     * @generated from protobuf field: repeated envoy.extensions.filters.http.ip_tagging.v3.IPTagging.IPTag ip_tags = 4;
     */
 ...
 *
 * @generated from protobuf message envoy.extensions.filters.http.ip_tagging.v3.IPTagging.IPTag
 */
export interface IPTagging_IPTag {
     ...
     *
     * @generated from protobuf field: repeated envoy.config.core.v3.CidrRange ip_list = 2;
     */
    ipList: CidrRange[];
}
/**
 ...
 *
 * @generated from protobuf enum envoy.extensions.filters.http.ip_tagging.v3.IPTagging.RequestType
 */
...
class IPTagging$Type extends MessageType<IPTagging> {
    constructor() {
        super("envoy.extensions.filters.http.ip_tagging.v3.IPTagging", [
            { no: 1, name: "request_type", kind: "enum", T: () => ["envoy.extensions.filters.http.ip_tagging.v3.IPTagging.RequestType", IPTagging_RequestType], options: { "validate.rules": { enum: { definedOnly: true } } } },
            { no: 4, name: "ip_tags", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => IPTagging_IPTag, options: { "validate.rules": { repeated: { minItems: "1" } } } }
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.filter.http.ip_tagging.v2.IPTagging" } });
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: IPTagging): IPTagging {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* envoy.extensions.filters.http.ip_tagging.v3.IPTagging.RequestType request_type */ 1:
                    message.requestType = reader.int32();
                    break;
                case /* repeated envoy.extensions.filters.http.ip_tagging.v3.IPTagging.IPTag ip_tags */ 4:
...
/**
 * @generated MessageType for protobuf message envoy.extensions.filters.http.ip_tagging.v3.IPTagging
 */
export const IPTagging = new IPTagging$Type();
// @generated message type with reflection information, may provide speed optimized methods
class IPTagging_IPTag$Type extends MessageType<IPTagging_IPTag> {
    constructor() {
        super("envoy.extensions.filters.http.ip_tagging.v3.IPTagging.IPTag", [
        ...
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.filter.http.ip_tagging.v2.IPTagging.IPTag" } });
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string ip_tag_name */ 1:
                    ...
                    break;
                case /* repeated envoy.config.core.v3.CidrRange ip_list */ 2:
...
/**
 * @generated MessageType for protobuf message envoy.extensions.filters.http.ip_tagging.v3.IPTagging.IPTag
 */
