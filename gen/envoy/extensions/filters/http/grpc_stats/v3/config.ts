...
// @generated from protobuf file "envoy/extensions/filters/http/grpc_stats/v3/config.proto" (package "envoy.extensions.filters.http.grpc_stats.v3", syntax proto3)
// tslint:disable
 ...
 * [#next-free-field: 6]
 *
 * @generated from protobuf message envoy.extensions.filters.http.grpc_stats.v3.FilterConfig
 */
export interface FilterConfig {
    ...
    perMethodStatSpecifier: {
         ...
         *
         * @generated from protobuf field: envoy.config.core.v3.GrpcMethodList individual_method_stats_allowlist = 2;
         */
     ...
     *
     * @generated from protobuf field: bool enable_upstream_stats = 4;
     */
     ...
     *
     * @generated from protobuf field: bool replace_dots_in_grpc_service_name = 5;
     */
 ...
 *
 * @generated from protobuf message envoy.extensions.filters.http.grpc_stats.v3.FilterObject
 */
...
class FilterConfig$Type extends MessageType<FilterConfig> {
    constructor() {
        super("envoy.extensions.filters.http.grpc_stats.v3.FilterConfig", [
        ...
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.filter.http.grpc_stats.v2alpha.FilterConfig" } });
    }
    create(value?: PartialMessage<FilterConfig>): FilterConfig {
        ...
        message.enableUpstreamStats = false;
        message.replaceDotsInGrpcServiceName = false;
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* bool emit_filter_state */ 1:
                    ...
                    break;
                case /* envoy.config.core.v3.GrpcMethodList individual_method_stats_allowlist */ 2:
                ...
                case /* google.protobuf.BoolValue stats_for_all_methods */ 3:
                    ...
                    break;
                case /* bool enable_upstream_stats */ 4:
                    message.enableUpstreamStats = reader.bool();
                    break;
                case /* bool replace_dots_in_grpc_service_name */ 5:
                    message.replaceDotsInGrpcServiceName = reader.bool();
                    break;
                default:
    ...
    internalBinaryWrite(message: FilterConfig, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.enableUpstreamStats !== false)
            writer.tag(4, WireType.Varint).bool(message.enableUpstreamStats);
        /* bool replace_dots_in_grpc_service_name = 5; */
        if (message.replaceDotsInGrpcServiceName !== false)
            writer.tag(5, WireType.Varint).bool(message.replaceDotsInGrpcServiceName);
...
/**
 * @generated MessageType for protobuf message envoy.extensions.filters.http.grpc_stats.v3.FilterConfig
 */
export const FilterConfig = new FilterConfig$Type();
// @generated message type with reflection information, may provide speed optimized methods
class FilterObject$Type extends MessageType<FilterObject> {
    constructor() {
        super("envoy.extensions.filters.http.grpc_stats.v3.FilterObject", [
        ...
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.filter.http.grpc_stats.v2alpha.FilterObject" } });
    }
...
/**
 * @generated MessageType for protobuf message envoy.extensions.filters.http.grpc_stats.v3.FilterObject
 */
