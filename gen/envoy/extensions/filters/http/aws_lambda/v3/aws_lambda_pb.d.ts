...
export declare class Config extends Message<Config> {
  ...
  static readonly typeName = "envoy.extensions.filters.http.aws_lambda.v3.Config";
...
export declare class PerRouteConfig extends Message<PerRouteConfig> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "envoy.extensions.filters.http.aws_lambda.v3.PerRouteConfig";
  static readonly fields: FieldList;
