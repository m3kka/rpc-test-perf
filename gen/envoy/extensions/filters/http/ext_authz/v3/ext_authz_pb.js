...
import { HeaderValue, RuntimeFeatureFlag, RuntimeFractionalPercent } from "../../../../../config/core/v3/base_pb.js";
...
export const ExtAuthz = proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 12, name: "transport_api_version", kind: "enum", T: proto3.getEnumType(ApiVersion) },
    ...
    { no: 16, name: "typed_metadata_context_namespaces", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
