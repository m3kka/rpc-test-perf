...
// @generated from protobuf file "envoy/extensions/filters/network/ratelimit/v3/rate_limit.proto" (package "envoy.extensions.filters.network.ratelimit.v3", syntax proto3)
// tslint:disable
 ...
 * [#next-free-field: 7]
 *
 * @generated from protobuf message envoy.extensions.filters.network.ratelimit.v3.RateLimit
 */
export interface RateLimit {
     ...
     *
     * @generated from protobuf field: repeated envoy.extensions.common.ratelimit.v3.RateLimitDescriptor descriptors = 3;
     */
     ...
     * success.
     *
     * @generated from protobuf field: envoy.config.ratelimit.v3.RateLimitServiceConfig rate_limit_service = 6;
     */
...
class RateLimit$Type extends MessageType<RateLimit> {
    constructor() {
        super("envoy.extensions.filters.network.ratelimit.v3.RateLimit", [
        ...
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.filter.network.rate_limit.v2.RateLimit" } });
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string domain */ 2:
                    ...
                    break;
                case /* repeated envoy.extensions.common.ratelimit.v3.RateLimitDescriptor descriptors */ 3:
                ...
                case /* bool failure_mode_deny */ 5:
                    ...
                    break;
                case /* envoy.config.ratelimit.v3.RateLimitServiceConfig rate_limit_service */ 6:
...
/**
 * @generated MessageType for protobuf message envoy.extensions.filters.network.ratelimit.v3.RateLimit
 */
