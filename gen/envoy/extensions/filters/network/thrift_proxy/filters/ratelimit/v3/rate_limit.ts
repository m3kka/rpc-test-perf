...
// @generated from protobuf file "envoy/extensions/filters/network/thrift_proxy/filters/ratelimit/v3/rate_limit.proto" (package "envoy.extensions.filters.network.thrift_proxy.filters.ratelimit.v3", syntax proto3)
// tslint:disable
 ...
 * [#next-free-field: 6]
 *
 * @generated from protobuf message envoy.extensions.filters.network.thrift_proxy.filters.ratelimit.v3.RateLimit
 */
export interface RateLimit {
     ...
     * success.
     *
     * @generated from protobuf field: envoy.config.ratelimit.v3.RateLimitServiceConfig rate_limit_service = 5;
     */
...
class RateLimit$Type extends MessageType<RateLimit> {
    constructor() {
        super("envoy.extensions.filters.network.thrift_proxy.filters.ratelimit.v3.RateLimit", [
        ...
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.filter.thrift.rate_limit.v2alpha1.RateLimit" } });
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* bool failure_mode_deny */ 4:
                    ...
                    break;
                case /* envoy.config.ratelimit.v3.RateLimitServiceConfig rate_limit_service */ 5:
...
/**
 * @generated MessageType for protobuf message envoy.extensions.filters.network.thrift_proxy.filters.ratelimit.v3.RateLimit
 */
