...
// @generated from protobuf file "envoy/extensions/clusters/redis/v3/redis_cluster.proto" (package "envoy.extensions.clusters.redis.v3", syntax proto3)
// tslint:disable
 ...
 * [#next-free-field: 7]
 *
 * @generated from protobuf message envoy.extensions.clusters.redis.v3.RedisClusterConfig
 */
...
class RedisClusterConfig$Type extends MessageType<RedisClusterConfig> {
    constructor() {
        super("envoy.extensions.clusters.redis.v3.RedisClusterConfig", [
        ...
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.cluster.redis.RedisClusterConfig" } });
    }
...
/**
 * @generated MessageType for protobuf message envoy.extensions.clusters.redis.v3.RedisClusterConfig
 */
