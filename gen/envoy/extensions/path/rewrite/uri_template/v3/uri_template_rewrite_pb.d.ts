 ...
 */
export declare class UriTemplateRewriteConfig extends Message<UriTemplateRewriteConfig> {
  /**
   * @generated from field: string path_template_rewrite = 1;
   */
  pathTemplateRewrite: string;

  constructor(data?: PartialMessage<UriTemplateRewriteConfig>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "envoy.extensions.path.rewrite.uri_template.v3.UriTemplateRewriteConfig";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): UriTemplateRewriteConfig;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): UriTemplateRewriteConfig;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): UriTemplateRewriteConfig;

  static equals(a: UriTemplateRewriteConfig | PlainMessage<UriTemplateRewriteConfig> | undefined, b: UriTemplateRewriteConfig | PlainMessage<UriTemplateRewriteConfig> | undefined): boolean;
}
