...
// @generated from protobuf file "envoy/extensions/retry/host/omit_host_metadata/v3/omit_host_metadata_config.proto" (package "envoy.extensions.retry.host.omit_host_metadata.v3", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message envoy.extensions.retry.host.omit_host_metadata.v3.OmitHostMetadataConfig
 */
export interface OmitHostMetadataConfig {
     ...
     *
     * @generated from protobuf field: envoy.config.core.v3.Metadata metadata_match = 1;
     */
...
class OmitHostMetadataConfig$Type extends MessageType<OmitHostMetadataConfig> {
    constructor() {
        super("envoy.extensions.retry.host.omit_host_metadata.v3.OmitHostMetadataConfig", [
            { no: 1, name: "metadata_match", kind: "message", T: () => Metadata }
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.retry.omit_host_metadata.v2.OmitHostMetadataConfig" } });
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: OmitHostMetadataConfig): OmitHostMetadataConfig {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* envoy.config.core.v3.Metadata metadata_match */ 1:
...
/**
 * @generated MessageType for protobuf message envoy.extensions.retry.host.omit_host_metadata.v3.OmitHostMetadataConfig
 */
