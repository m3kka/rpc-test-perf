...
// @generated from protobuf file "envoy/extensions/retry/priority/previous_priorities/v3/previous_priorities_config.proto" (package "envoy.extensions.retry.priority.previous_priorities.v3", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message envoy.extensions.retry.priority.previous_priorities.v3.PreviousPrioritiesConfig
 */
...
class PreviousPrioritiesConfig$Type extends MessageType<PreviousPrioritiesConfig> {
    constructor() {
        super("envoy.extensions.retry.priority.previous_priorities.v3.PreviousPrioritiesConfig", [
            { no: 1, name: "update_frequency", kind: "scalar", T: 5 /*ScalarType.INT32*/, options: { "validate.rules": { int32: { gt: 0 } } } }
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.retry.previous_priorities.PreviousPrioritiesConfig" } });
    }
...
/**
 * @generated MessageType for protobuf message envoy.extensions.retry.priority.previous_priorities.v3.PreviousPrioritiesConfig
 */
