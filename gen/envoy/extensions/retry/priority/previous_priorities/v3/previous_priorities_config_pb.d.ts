 ...
 */
export declare class PreviousPrioritiesConfig extends Message<PreviousPrioritiesConfig> {
  /**
  ...
  constructor(data?: PartialMessage<PreviousPrioritiesConfig>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "envoy.extensions.retry.priority.previous_priorities.v3.PreviousPrioritiesConfig";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): PreviousPrioritiesConfig;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): PreviousPrioritiesConfig;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): PreviousPrioritiesConfig;

  static equals(a: PreviousPrioritiesConfig | PlainMessage<PreviousPrioritiesConfig> | undefined, b: PreviousPrioritiesConfig | PlainMessage<PreviousPrioritiesConfig> | undefined): boolean;
}
