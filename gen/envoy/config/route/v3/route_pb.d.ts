...
import type { ClusterSpecifierPlugin, RouteAction_RequestMirrorPolicy, VirtualHost } from "./route_components_pb.js";
...
export declare class RouteConfiguration extends Message<RouteConfiguration> {
  ...
  static readonly typeName = "envoy.config.route.v3.RouteConfiguration";
 ...
 */
export declare class Vhds extends Message<Vhds> {
  /**
  ...
  constructor(data?: PartialMessage<Vhds>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "envoy.config.route.v3.Vhds";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): Vhds;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): Vhds;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): Vhds;

  static equals(a: Vhds | PlainMessage<Vhds> | undefined, b: Vhds | PlainMessage<Vhds> | undefined): boolean;
}
