...
// @generated from protobuf file "envoy/config/listener/v3/api_listener.proto" (package "envoy.config.listener.v3", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message envoy.config.listener.v3.ApiListener
 */
...
class ApiListener$Type extends MessageType<ApiListener> {
    constructor() {
        super("envoy.config.listener.v3.ApiListener", [
            { no: 1, name: "api_listener", kind: "message", T: () => Any }
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.listener.v2.ApiListener" } });
    }
...
/**
 * @generated MessageType for protobuf message envoy.config.listener.v3.ApiListener
 */
