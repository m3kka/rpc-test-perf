...
// @generated from protobuf file "envoy/config/grpc_credential/v3/aws_iam.proto" (package "envoy.config.grpc_credential.v3", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message envoy.config.grpc_credential.v3.AwsIamConfig
 */
...
class AwsIamConfig$Type extends MessageType<AwsIamConfig> {
    constructor() {
        super("envoy.config.grpc_credential.v3.AwsIamConfig", [
            { no: 1, name: "service_name", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "validate.rules": { string: { minLen: "1" } } } },
            { no: 2, name: "region", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.grpc_credential.v2alpha.AwsIamConfig" } });
    }
...
/**
 * @generated MessageType for protobuf message envoy.config.grpc_credential.v3.AwsIamConfig
 */
