...
// @generated from protobuf file "envoy/config/grpc_credential/v3/file_based_metadata.proto" (package "envoy.config.grpc_credential.v3", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message envoy.config.grpc_credential.v3.FileBasedMetadataConfig
 */
export interface FileBasedMetadataConfig {
     ...
     *
     * @generated from protobuf field: envoy.config.core.v3.DataSource secret_data = 1;
     */
...
class FileBasedMetadataConfig$Type extends MessageType<FileBasedMetadataConfig> {
    constructor() {
        super("envoy.config.grpc_credential.v3.FileBasedMetadataConfig", [
        ...
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.grpc_credential.v2alpha.FileBasedMetadataConfig" } });
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: FileBasedMetadataConfig): FileBasedMetadataConfig {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* envoy.config.core.v3.DataSource secret_data */ 1:
...
/**
 * @generated MessageType for protobuf message envoy.config.grpc_credential.v3.FileBasedMetadataConfig
 */
