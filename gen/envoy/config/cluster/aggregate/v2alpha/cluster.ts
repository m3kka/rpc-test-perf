...
// @generated from protobuf file "envoy/config/cluster/aggregate/v2alpha/cluster.proto" (package "envoy.config.cluster.aggregate.v2alpha", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message envoy.config.cluster.aggregate.v2alpha.ClusterConfig
 */
...
class ClusterConfig$Type extends MessageType<ClusterConfig> {
    constructor() {
        super("envoy.config.cluster.aggregate.v2alpha.ClusterConfig", [
...
/**
 * @generated MessageType for protobuf message envoy.config.cluster.aggregate.v2alpha.ClusterConfig
 */
