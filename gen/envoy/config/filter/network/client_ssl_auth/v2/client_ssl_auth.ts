...
// @generated from protobuf file "envoy/config/filter/network/client_ssl_auth/v2/client_ssl_auth.proto" (package "envoy.config.filter.network.client_ssl_auth.v2", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message envoy.config.filter.network.client_ssl_auth.v2.ClientSSLAuth
 */
export interface ClientSSLAuth {
     ...
     * IP allowlist.
     *
     * @generated from protobuf field: repeated envoy.api.v2.core.CidrRange ip_white_list = 4;
     */
...
class ClientSSLAuth$Type extends MessageType<ClientSSLAuth> {
    constructor() {
        super("envoy.config.filter.network.client_ssl_auth.v2.ClientSSLAuth", [
            { no: 1, name: "auth_api_cluster", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "validate.rules": { string: { minBytes: "1" } } } },
            ...
            { no: 4, name: "ip_white_list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => CidrRange }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* google.protobuf.Duration refresh_delay */ 3:
                    ...
                    break;
                case /* repeated envoy.api.v2.core.CidrRange ip_white_list */ 4:
...
/**
 * @generated MessageType for protobuf message envoy.config.filter.network.client_ssl_auth.v2.ClientSSLAuth
 */
