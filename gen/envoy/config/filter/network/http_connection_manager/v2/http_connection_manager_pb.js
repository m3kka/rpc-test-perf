...
import { RouteConfiguration } from "../../../../../api/v2/route_pb.js";
import { Http1ProtocolOptions, Http2ProtocolOptions, HttpProtocolOptions } from "../../../../../api/v2/core/protocol_pb.js";
...
import { Tracing_Http } from "../../../../trace/v2/http_tracer_pb.js";
import { ConfigSource } from "../../../../../api/v2/core/config_source_pb.js";
import { ScopedRouteConfiguration } from "../../../../../api/v2/scoped_route_pb.js";
...
export const HttpConnectionManager = proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 11, name: "idle_timeout", kind: "message", T: Duration },
...
export const HttpConnectionManager_Tracing = proto3.makeMessageType(
  ...
  () => [
    { no: 1, name: "operation_name", kind: "enum", T: proto3.getEnumType(HttpConnectionManager_Tracing_OperationName) },
    { no: 2, name: "request_headers_for_tags", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
