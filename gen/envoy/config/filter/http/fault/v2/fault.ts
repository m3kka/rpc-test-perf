...
// @generated from protobuf file "envoy/config/filter/http/fault/v2/fault.proto" (package "envoy.config.filter.http.fault.v2", syntax proto3)
// tslint:disable
...
import { FaultRateLimit } from "../../../fault/v2/fault";
...
/**
 * @generated from protobuf message envoy.config.filter.http.fault.v2.FaultAbort
 */
export interface FaultAbort {
    ...
    errorType: {
         ...
         *
         * @generated from protobuf field: envoy.config.filter.http.fault.v2.FaultAbort.HeaderAbort header_abort = 4;
         */
     ...
     * provided.
     *
     * @generated from protobuf field: envoy.type.FractionalPercent percentage = 3;
     */
 ...
 * more information.
 *
 * @generated from protobuf message envoy.config.filter.http.fault.v2.FaultAbort.HeaderAbort
 */
 ...
 * [#next-free-field: 14]
 *
 * @generated from protobuf message envoy.config.filter.http.fault.v2.HTTPFault
 */
export interface HTTPFault {
     ...
     * object.
     *
     * @generated from protobuf field: envoy.config.filter.fault.v2.FaultDelay delay = 1;
     */
    delay?: FaultDelay;
    /**
     ...
     *
     * @generated from protobuf field: envoy.config.filter.http.fault.v2.FaultAbort abort = 2;
     */
    abort?: FaultAbort;
    /**
     ...
     *
     * @generated from protobuf field: envoy.config.filter.fault.v2.FaultRateLimit response_rate_limit = 7;
     */
...
class FaultAbort$Type extends MessageType<FaultAbort> {
    constructor() {
        super("envoy.config.filter.http.fault.v2.FaultAbort", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint32 http_status */ 2:
                    ...
                    break;
                case /* envoy.config.filter.http.fault.v2.FaultAbort.HeaderAbort header_abort */ 4:
                    message.errorType = {
                        oneofKind: "headerAbort",
                        headerAbort: FaultAbort_HeaderAbort.internalBinaryRead(reader, reader.uint32(), options, (message.errorType as any).headerAbort)
                    };
                    break;
                case /* envoy.type.FractionalPercent percentage */ 3:
...
/**
 * @generated MessageType for protobuf message envoy.config.filter.http.fault.v2.FaultAbort
 */
export const FaultAbort = new FaultAbort$Type();
// @generated message type with reflection information, may provide speed optimized methods
class FaultAbort_HeaderAbort$Type extends MessageType<FaultAbort_HeaderAbort> {
    constructor() {
        super("envoy.config.filter.http.fault.v2.FaultAbort.HeaderAbort", []);
    }
...
/**
 * @generated MessageType for protobuf message envoy.config.filter.http.fault.v2.FaultAbort.HeaderAbort
 */
export const FaultAbort_HeaderAbort = new FaultAbort_HeaderAbort$Type();
// @generated message type with reflection information, may provide speed optimized methods
class HTTPFault$Type extends MessageType<HTTPFault> {
    constructor() {
        super("envoy.config.filter.http.fault.v2.HTTPFault", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: HTTPFault): HTTPFault {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* envoy.config.filter.fault.v2.FaultDelay delay */ 1:
                    message.delay = FaultDelay.internalBinaryRead(reader, reader.uint32(), options, message.delay);
                    break;
                case /* envoy.config.filter.http.fault.v2.FaultAbort abort */ 2:
                ...
                case /* google.protobuf.UInt32Value max_active_faults */ 6:
                    ...
                    break;
                case /* envoy.config.filter.fault.v2.FaultRateLimit response_rate_limit */ 7:
...
/**
 * @generated MessageType for protobuf message envoy.config.filter.http.fault.v2.HTTPFault
 */
