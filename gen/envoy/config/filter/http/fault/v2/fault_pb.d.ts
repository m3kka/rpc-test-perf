...
import type { FaultDelay, FaultRateLimit } from "../../../fault/v2/fault_pb.js";
...
export declare class FaultAbort extends Message<FaultAbort> {
  ...
  static readonly typeName = "envoy.config.filter.http.fault.v2.FaultAbort";
...
export declare class FaultAbort_HeaderAbort extends Message<FaultAbort_HeaderAbort> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "envoy.config.filter.http.fault.v2.FaultAbort.HeaderAbort";
  static readonly fields: FieldList;
...
export declare class HTTPFault extends Message<HTTPFault> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "envoy.config.filter.http.fault.v2.HTTPFault";
  static readonly fields: FieldList;
