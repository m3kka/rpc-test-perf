...
// @generated from protobuf file "envoy/config/filter/http/health_check/v2/health_check.proto" (package "envoy.config.filter.http.health_check.v2", syntax proto3)
// tslint:disable
 ...
 * [#next-free-field: 6]
 *
 * @generated from protobuf message envoy.config.filter.http.health_check.v2.HealthCheck
 */
export interface HealthCheck {
     ...
     *    as if it were 12%.
     *
     * @generated from protobuf field: map<string, envoy.type.Percent> cluster_min_healthy_percentages = 4;
     */
     ...
     *
     * @generated from protobuf field: repeated envoy.api.v2.route.HeaderMatcher headers = 5;
     */
...
class HealthCheck$Type extends MessageType<HealthCheck> {
    constructor() {
        super("envoy.config.filter.http.health_check.v2.HealthCheck", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* google.protobuf.Duration cache_time */ 3:
                    ...
                    break;
                case /* map<string, envoy.type.Percent> cluster_min_healthy_percentages */ 4:
                    this.binaryReadMap4(message.clusterMinHealthyPercentages, reader, options);
                    break;
                case /* repeated envoy.api.v2.route.HeaderMatcher headers */ 5:
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    ...
                    break;
                default: throw new globalThis.Error("unknown map entry field for field envoy.config.filter.http.health_check.v2.HealthCheck.cluster_min_healthy_percentages");
            }
        }
...
/**
 * @generated MessageType for protobuf message envoy.config.filter.http.health_check.v2.HealthCheck
 */
