...
// @generated from protobuf file "envoy/config/filter/http/tap/v2alpha/tap.proto" (package "envoy.config.filter.http.tap.v2alpha", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message envoy.config.filter.http.tap.v2alpha.Tap
 */
...
class Tap$Type extends MessageType<Tap> {
    constructor() {
        super("envoy.config.filter.http.tap.v2alpha.Tap", [
...
/**
 * @generated MessageType for protobuf message envoy.config.filter.http.tap.v2alpha.Tap
 */
