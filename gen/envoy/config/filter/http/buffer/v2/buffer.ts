...
// @generated from protobuf file "envoy/config/filter/http/buffer/v2/buffer.proto" (package "envoy.config.filter.http.buffer.v2", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message envoy.config.filter.http.buffer.v2.Buffer
 */
...
/**
 * @generated from protobuf message envoy.config.filter.http.buffer.v2.BufferPerRoute
 */
export interface BufferPerRoute {
    ...
    override: {
         ...
         *
         * @generated from protobuf field: envoy.config.filter.http.buffer.v2.Buffer buffer = 2;
         */
        buffer: Buffer;
    } | {
        oneofKind: undefined;
...
class Buffer$Type extends MessageType<Buffer> {
    constructor() {
        super("envoy.config.filter.http.buffer.v2.Buffer", [
...
/**
 * @generated MessageType for protobuf message envoy.config.filter.http.buffer.v2.Buffer
 */
export const Buffer = new Buffer$Type();
// @generated message type with reflection information, may provide speed optimized methods
class BufferPerRoute$Type extends MessageType<BufferPerRoute> {
    constructor() {
        super("envoy.config.filter.http.buffer.v2.BufferPerRoute", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* bool disabled */ 1:
                    ...
                    break;
                case /* envoy.config.filter.http.buffer.v2.Buffer buffer */ 2:
                    message.override = {
                        oneofKind: "buffer",
...
/**
 * @generated MessageType for protobuf message envoy.config.filter.http.buffer.v2.BufferPerRoute
 */
