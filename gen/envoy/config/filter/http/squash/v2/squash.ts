...
// @generated from protobuf file "envoy/config/filter/http/squash/v2/squash.proto" (package "envoy.config.filter.http.squash.v2", syntax proto3)
// tslint:disable
 ...
 * [#next-free-field: 6]
 *
 * @generated from protobuf message envoy.config.filter.http.squash.v2.Squash
 */
...
class Squash$Type extends MessageType<Squash> {
    constructor() {
        super("envoy.config.filter.http.squash.v2.Squash", [
...
/**
 * @generated MessageType for protobuf message envoy.config.filter.http.squash.v2.Squash
 */
