...
import type { HeaderValue, RuntimeFeatureFlag, RuntimeFractionalPercent } from "../../../../../api/v2/core/base_pb.js";
import type { HttpUri } from "../../../../../api/v2/core/http_uri_pb.js";
import type { ListStringMatcher } from "../../../../../type/matcher/string_pb.js";
...
export declare class ExtAuthz extends Message<ExtAuthz> {
  ...
  static readonly typeName = "envoy.config.filter.http.ext_authz.v2.ExtAuthz";
...
export declare class BufferSettings extends Message<BufferSettings> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "envoy.config.filter.http.ext_authz.v2.BufferSettings";
  static readonly fields: FieldList;
...
export declare class HttpService extends Message<HttpService> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "envoy.config.filter.http.ext_authz.v2.HttpService";
  static readonly fields: FieldList;
...
export declare class AuthorizationRequest extends Message<AuthorizationRequest> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "envoy.config.filter.http.ext_authz.v2.AuthorizationRequest";
  static readonly fields: FieldList;
...
export declare class AuthorizationResponse extends Message<AuthorizationResponse> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "envoy.config.filter.http.ext_authz.v2.AuthorizationResponse";
  static readonly fields: FieldList;
...
export declare class ExtAuthzPerRoute extends Message<ExtAuthzPerRoute> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "envoy.config.filter.http.ext_authz.v2.ExtAuthzPerRoute";
  static readonly fields: FieldList;
...
export declare class CheckSettings extends Message<CheckSettings> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "envoy.config.filter.http.ext_authz.v2.CheckSettings";
  static readonly fields: FieldList;
