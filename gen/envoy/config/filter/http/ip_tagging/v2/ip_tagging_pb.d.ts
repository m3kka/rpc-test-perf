...
export declare class IPTagging extends Message<IPTagging> {
  ...
  static readonly typeName = "envoy.config.filter.http.ip_tagging.v2.IPTagging";
...
export declare class IPTagging_IPTag extends Message<IPTagging_IPTag> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "envoy.config.filter.http.ip_tagging.v2.IPTagging.IPTag";
  static readonly fields: FieldList;
