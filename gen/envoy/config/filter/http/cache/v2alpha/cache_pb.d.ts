...
import type { QueryParameterMatcher } from "../../../../../api/v2/route/route_components_pb.js";
...
export declare class CacheConfig extends Message<CacheConfig> {
  ...
  static readonly typeName = "envoy.config.filter.http.cache.v2alpha.CacheConfig";
...
export declare class CacheConfig_KeyCreatorParams extends Message<CacheConfig_KeyCreatorParams> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "envoy.config.filter.http.cache.v2alpha.CacheConfig.KeyCreatorParams";
  static readonly fields: FieldList;
