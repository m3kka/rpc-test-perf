...
// @generated from protobuf file "envoy/config/filter/http/original_src/v2alpha1/original_src.proto" (package "envoy.config.filter.http.original_src.v2alpha1", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message envoy.config.filter.http.original_src.v2alpha1.OriginalSrc
 */
...
class OriginalSrc$Type extends MessageType<OriginalSrc> {
    constructor() {
        super("envoy.config.filter.http.original_src.v2alpha1.OriginalSrc", [
...
/**
 * @generated MessageType for protobuf message envoy.config.filter.http.original_src.v2alpha1.OriginalSrc
 */
