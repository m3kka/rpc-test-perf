...
// @generated from protobuf file "envoy/config/filter/http/aws_lambda/v2alpha/aws_lambda.proto" (package "envoy.config.filter.http.aws_lambda.v2alpha", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message envoy.config.filter.http.aws_lambda.v2alpha.Config
 */
export interface Config {
     ...
     *
     * @generated from protobuf field: envoy.config.filter.http.aws_lambda.v2alpha.Config.InvocationMode invocation_mode = 3;
     */
    invocationMode: Config_InvocationMode;
}
/**
 * @generated from protobuf enum envoy.config.filter.http.aws_lambda.v2alpha.Config.InvocationMode
 */
 ...
 *
 * @generated from protobuf message envoy.config.filter.http.aws_lambda.v2alpha.PerRouteConfig
 */
export interface PerRouteConfig {
    /**
     * @generated from protobuf field: envoy.config.filter.http.aws_lambda.v2alpha.Config invoke_config = 1;
     */
    invokeConfig?: Config;
}
...
class Config$Type extends MessageType<Config> {
    constructor() {
        super("envoy.config.filter.http.aws_lambda.v2alpha.Config", [
            ...
            { no: 3, name: "invocation_mode", kind: "enum", T: () => ["envoy.config.filter.http.aws_lambda.v2alpha.Config.InvocationMode", Config_InvocationMode], options: { "validate.rules": { enum: { definedOnly: true } } } }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* bool payload_passthrough */ 2:
                    ...
                    break;
                case /* envoy.config.filter.http.aws_lambda.v2alpha.Config.InvocationMode invocation_mode */ 3:
...
/**
 * @generated MessageType for protobuf message envoy.config.filter.http.aws_lambda.v2alpha.Config
 */
export const Config = new Config$Type();
// @generated message type with reflection information, may provide speed optimized methods
class PerRouteConfig$Type extends MessageType<PerRouteConfig> {
    constructor() {
        super("envoy.config.filter.http.aws_lambda.v2alpha.PerRouteConfig", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: PerRouteConfig): PerRouteConfig {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* envoy.config.filter.http.aws_lambda.v2alpha.Config invoke_config */ 1:
...
/**
 * @generated MessageType for protobuf message envoy.config.filter.http.aws_lambda.v2alpha.PerRouteConfig
 */
