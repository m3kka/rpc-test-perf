...
import type { Compressor } from "../../compressor/v2/compressor_pb.js";
...
export declare class Gzip extends Message<Gzip> {
  ...
  static readonly typeName = "envoy.config.filter.http.gzip.v2.Gzip";
...
export declare class Gzip_CompressionLevel extends Message<Gzip_CompressionLevel> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "envoy.config.filter.http.gzip.v2.Gzip.CompressionLevel";
  static readonly fields: FieldList;
