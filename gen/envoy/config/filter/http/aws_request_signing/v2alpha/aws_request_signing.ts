...
// @generated from protobuf file "envoy/config/filter/http/aws_request_signing/v2alpha/aws_request_signing.proto" (package "envoy.config.filter.http.aws_request_signing.v2alpha", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message envoy.config.filter.http.aws_request_signing.v2alpha.AwsRequestSigning
 */
...
class AwsRequestSigning$Type extends MessageType<AwsRequestSigning> {
    constructor() {
        super("envoy.config.filter.http.aws_request_signing.v2alpha.AwsRequestSigning", [
            { no: 1, name: "service_name", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "validate.rules": { string: { minBytes: "1" } } } },
            { no: 2, name: "region", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "validate.rules": { string: { minBytes: "1" } } } },
...
/**
 * @generated MessageType for protobuf message envoy.config.filter.http.aws_request_signing.v2alpha.AwsRequestSigning
 */
