...
// @generated from protobuf file "envoy/config/filter/dubbo/router/v2alpha1/router.proto" (package "envoy.config.filter.dubbo.router.v2alpha1", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message envoy.config.filter.dubbo.router.v2alpha1.Router
 */
...
class Router$Type extends MessageType<Router> {
    constructor() {
        super("envoy.config.filter.dubbo.router.v2alpha1.Router", []);
    }
...
/**
 * @generated MessageType for protobuf message envoy.config.filter.dubbo.router.v2alpha1.Router
 */
