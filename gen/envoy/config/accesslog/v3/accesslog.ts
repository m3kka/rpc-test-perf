...
// @generated from protobuf file "envoy/config/accesslog/v3/accesslog.proto" (package "envoy.config.accesslog.v3", syntax proto3)
// tslint:disable
...
import { AccessLogType } from "../../../data/accesslog/v3/accesslog";
...
/**
 * @generated from protobuf message envoy.config.accesslog.v3.AccessLog
 */
export interface AccessLog {
     ...
     *
     * @generated from protobuf field: envoy.config.accesslog.v3.AccessLogFilter filter = 2;
     */
 ...
 * [#next-free-field: 14]
 *
 * @generated from protobuf message envoy.config.accesslog.v3.AccessLogFilter
 */
export interface AccessLogFilter {
    ...
    filterSpecifier: {
         ...
         * Status code filter.
         *
         * @generated from protobuf field: envoy.config.accesslog.v3.StatusCodeFilter status_code_filter = 1;
         */
         ...
         * Duration filter.
         *
         * @generated from protobuf field: envoy.config.accesslog.v3.DurationFilter duration_filter = 2;
         */
         ...
         *
         * @generated from protobuf field: envoy.config.accesslog.v3.NotHealthCheckFilter not_health_check_filter = 3;
         */
         ...
         * Traceable filter.
         *
         * @generated from protobuf field: envoy.config.accesslog.v3.TraceableFilter traceable_filter = 4;
         */
         ...
         * Runtime filter.
         *
         * @generated from protobuf field: envoy.config.accesslog.v3.RuntimeFilter runtime_filter = 5;
         */
         ...
         * And filter.
         *
         * @generated from protobuf field: envoy.config.accesslog.v3.AndFilter and_filter = 6;
         */
        andFilter: AndFilter;
    } | {
        oneofKind: "orFilter";
         ...
         * Or filter.
         *
         * @generated from protobuf field: envoy.config.accesslog.v3.OrFilter or_filter = 7;
         */
        orFilter: OrFilter;
    } | {
         ...
         * Header filter.
         *
         * @generated from protobuf field: envoy.config.accesslog.v3.HeaderFilter header_filter = 8;
         */
         ...
         *
         * @generated from protobuf field: envoy.config.accesslog.v3.ResponseFlagFilter response_flag_filter = 9;
         */
         ...
         * gRPC status filter.
         *
         * @generated from protobuf field: envoy.config.accesslog.v3.GrpcStatusFilter grpc_status_filter = 10;
         */
         ...
         *
         * @generated from protobuf field: envoy.config.accesslog.v3.ExtensionFilter extension_filter = 11;
         */
        extensionFilter: ExtensionFilter;
    } | {
        oneofKind: "metadataFilter";
        /**
         * Metadata Filter
         *
         * @generated from protobuf field: envoy.config.accesslog.v3.MetadataFilter metadata_filter = 12;
         */
        metadataFilter: MetadataFilter;
    } | {
        oneofKind: "logTypeFilter";
        /**
         * Log Type Filter
         *
         * @generated from protobuf field: envoy.config.accesslog.v3.LogTypeFilter log_type_filter = 13;
         */
 ...
 *
 * @generated from protobuf message envoy.config.accesslog.v3.ComparisonFilter
 */
export interface ComparisonFilter {
    /**
     * Comparison operator.
     *
     * @generated from protobuf field: envoy.config.accesslog.v3.ComparisonFilter.Op op = 1;
     */
    op: ComparisonFilter_Op;
    /**
     * Value to compare against.
     *
     * @generated from protobuf field: envoy.config.core.v3.RuntimeUInt32 value = 2;
     */
    value?: RuntimeUInt32;
}
/**
 * @generated from protobuf enum envoy.config.accesslog.v3.ComparisonFilter.Op
 */
 ...
 *
 * @generated from protobuf message envoy.config.accesslog.v3.StatusCodeFilter
 */
export interface StatusCodeFilter {
    /**
     * Comparison.
     *
     * @generated from protobuf field: envoy.config.accesslog.v3.ComparisonFilter comparison = 1;
     */
 ...
 *
 * @generated from protobuf message envoy.config.accesslog.v3.DurationFilter
 */
 ...
 *
 * @generated from protobuf message envoy.config.accesslog.v3.NotHealthCheckFilter
 */
 ...
 *
 * @generated from protobuf message envoy.config.accesslog.v3.TraceableFilter
 */
 ...
 *
 * @generated from protobuf message envoy.config.accesslog.v3.RuntimeFilter
 */
export interface RuntimeFilter {
     ...
     * denominator of 100.
     *
     * @generated from protobuf field: envoy.type.v3.FractionalPercent percent_sampled = 2;
     */
 ...
 *
 * @generated from protobuf message envoy.config.accesslog.v3.AndFilter
 */
export interface AndFilter {
    /**
     * @generated from protobuf field: repeated envoy.config.accesslog.v3.AccessLogFilter filters = 1;
     */
 ...
 *
 * @generated from protobuf message envoy.config.accesslog.v3.OrFilter
 */
export interface OrFilter {
    /**
     * @generated from protobuf field: repeated envoy.config.accesslog.v3.AccessLogFilter filters = 2;
     */
    filters: AccessLogFilter[];
}
/**
 ...
 *
 * @generated from protobuf message envoy.config.accesslog.v3.HeaderFilter
 */
export interface HeaderFilter {
     ...
     *
     * @generated from protobuf field: envoy.config.route.v3.HeaderMatcher header = 1;
     */
 ...
 *
 * @generated from protobuf message envoy.config.accesslog.v3.ResponseFlagFilter
 */
 ...
 *
 * @generated from protobuf message envoy.config.accesslog.v3.GrpcStatusFilter
 */
export interface GrpcStatusFilter {
    /**
     * Logs only responses that have any one of the gRPC statuses in this field.
     *
     * @generated from protobuf field: repeated envoy.config.accesslog.v3.GrpcStatusFilter.Status statuses = 1;
     */
...
/**
 * @generated from protobuf enum envoy.config.accesslog.v3.GrpcStatusFilter.Status
 */
 ...
 *
 * @generated from protobuf message envoy.config.accesslog.v3.MetadataFilter
 */
export interface MetadataFilter {
     ...
     *
     * @generated from protobuf field: envoy.type.matcher.v3.MetadataMatcher matcher = 1;
     */
     ...
     *
     * @generated from protobuf field: google.protobuf.BoolValue match_if_key_not_found = 2;
     */
    matchIfKeyNotFound?: BoolValue;
}
/**
 * Filters based on access log type.
 *
 * @generated from protobuf message envoy.config.accesslog.v3.LogTypeFilter
 */
export interface LogTypeFilter {
    /**
     * Logs only records which their type is one of the types defined in this field.
     *
     * @generated from protobuf field: repeated envoy.data.accesslog.v3.AccessLogType types = 1;
     */
    types: AccessLogType[];
    /**
 ...
 *
 * @generated from protobuf message envoy.config.accesslog.v3.ExtensionFilter
 */
...
class AccessLog$Type extends MessageType<AccessLog> {
    constructor() {
        super("envoy.config.accesslog.v3.AccessLog", [
            { no: 1, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "filter", kind: "message", T: () => AccessLogFilter },
            { no: 4, name: "typed_config", kind: "message", oneof: "configType", T: () => Any }
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.filter.accesslog.v2.AccessLog" } });
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string name */ 1:
                    ...
                    break;
                case /* envoy.config.accesslog.v3.AccessLogFilter filter */ 2:
...
/**
 * @generated MessageType for protobuf message envoy.config.accesslog.v3.AccessLog
 */
export const AccessLog = new AccessLog$Type();
// @generated message type with reflection information, may provide speed optimized methods
class AccessLogFilter$Type extends MessageType<AccessLogFilter> {
    constructor() {
        super("envoy.config.accesslog.v3.AccessLogFilter", [
            ...
            { no: 12, name: "metadata_filter", kind: "message", oneof: "filterSpecifier", T: () => MetadataFilter },
            { no: 13, name: "log_type_filter", kind: "message", oneof: "filterSpecifier", T: () => LogTypeFilter }
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.filter.accesslog.v2.AccessLogFilter" } });
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: AccessLogFilter): AccessLogFilter {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* envoy.config.accesslog.v3.StatusCodeFilter status_code_filter */ 1:
                    ...
                    break;
                case /* envoy.config.accesslog.v3.DurationFilter duration_filter */ 2:
                    message.filterSpecifier = {
                        oneofKind: "durationFilter",
                    ...
                    break;
                case /* envoy.config.accesslog.v3.NotHealthCheckFilter not_health_check_filter */ 3:
                    message.filterSpecifier = {
                        oneofKind: "notHealthCheckFilter",
                    ...
                    break;
                case /* envoy.config.accesslog.v3.TraceableFilter traceable_filter */ 4:
                    message.filterSpecifier = {
                        oneofKind: "traceableFilter",
                ...
                case /* envoy.config.accesslog.v3.ResponseFlagFilter response_flag_filter */ 9:
                    ...
                    break;
                case /* envoy.config.accesslog.v3.GrpcStatusFilter grpc_status_filter */ 10:
                    message.filterSpecifier = {
                        oneofKind: "grpcStatusFilter",
                    ...
                    break;
                case /* envoy.config.accesslog.v3.ExtensionFilter extension_filter */ 11:
                    message.filterSpecifier = {
                        oneofKind: "extensionFilter",
                    ...
                    break;
                case /* envoy.config.accesslog.v3.MetadataFilter metadata_filter */ 12:
                    message.filterSpecifier = {
                        oneofKind: "metadataFilter",
                        metadataFilter: MetadataFilter.internalBinaryRead(reader, reader.uint32(), options, (message.filterSpecifier as any).metadataFilter)
                    };
                    break;
                case /* envoy.config.accesslog.v3.LogTypeFilter log_type_filter */ 13:
                    message.filterSpecifier = {
                        oneofKind: "logTypeFilter",
                        logTypeFilter: LogTypeFilter.internalBinaryRead(reader, reader.uint32(), options, (message.filterSpecifier as any).logTypeFilter)
                    };
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: AccessLogFilter, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.filterSpecifier.oneofKind === "metadataFilter")
            MetadataFilter.internalBinaryWrite(message.filterSpecifier.metadataFilter, writer.tag(12, WireType.LengthDelimited).fork(), options).join();
        /* envoy.config.accesslog.v3.LogTypeFilter log_type_filter = 13; */
        if (message.filterSpecifier.oneofKind === "logTypeFilter")
            LogTypeFilter.internalBinaryWrite(message.filterSpecifier.logTypeFilter, writer.tag(13, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message envoy.config.accesslog.v3.AccessLogFilter
 */
export const AccessLogFilter = new AccessLogFilter$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ComparisonFilter$Type extends MessageType<ComparisonFilter> {
    constructor() {
        super("envoy.config.accesslog.v3.ComparisonFilter", [
            { no: 1, name: "op", kind: "enum", T: () => ["envoy.config.accesslog.v3.ComparisonFilter.Op", ComparisonFilter_Op], options: { "validate.rules": { enum: { definedOnly: true } } } },
            { no: 2, name: "value", kind: "message", T: () => RuntimeUInt32, options: { "validate.rules": { message: { required: true } } } }
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.filter.accesslog.v2.ComparisonFilter" } });
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ComparisonFilter): ComparisonFilter {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* envoy.config.accesslog.v3.ComparisonFilter.Op op */ 1:
                    message.op = reader.int32();
                    break;
                case /* envoy.config.core.v3.RuntimeUInt32 value */ 2:
...
/**
 * @generated MessageType for protobuf message envoy.config.accesslog.v3.ComparisonFilter
 */
export const ComparisonFilter = new ComparisonFilter$Type();
// @generated message type with reflection information, may provide speed optimized methods
class StatusCodeFilter$Type extends MessageType<StatusCodeFilter> {
    constructor() {
        super("envoy.config.accesslog.v3.StatusCodeFilter", [
            { no: 1, name: "comparison", kind: "message", T: () => ComparisonFilter, options: { "validate.rules": { message: { required: true } } } }
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.filter.accesslog.v2.StatusCodeFilter" } });
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: StatusCodeFilter): StatusCodeFilter {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* envoy.config.accesslog.v3.ComparisonFilter comparison */ 1:
...
/**
 * @generated MessageType for protobuf message envoy.config.accesslog.v3.StatusCodeFilter
 */
export const StatusCodeFilter = new StatusCodeFilter$Type();
// @generated message type with reflection information, may provide speed optimized methods
class DurationFilter$Type extends MessageType<DurationFilter> {
    constructor() {
        super("envoy.config.accesslog.v3.DurationFilter", [
            { no: 1, name: "comparison", kind: "message", T: () => ComparisonFilter, options: { "validate.rules": { message: { required: true } } } }
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.filter.accesslog.v2.DurationFilter" } });
    }
...
/**
 * @generated MessageType for protobuf message envoy.config.accesslog.v3.DurationFilter
 */
...
class NotHealthCheckFilter$Type extends MessageType<NotHealthCheckFilter> {
    constructor() {
        super("envoy.config.accesslog.v3.NotHealthCheckFilter", [], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.filter.accesslog.v2.NotHealthCheckFilter" } });
    }
...
/**
 * @generated MessageType for protobuf message envoy.config.accesslog.v3.NotHealthCheckFilter
 */
...
class TraceableFilter$Type extends MessageType<TraceableFilter> {
    constructor() {
        super("envoy.config.accesslog.v3.TraceableFilter", [], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.filter.accesslog.v2.TraceableFilter" } });
    }
...
/**
 * @generated MessageType for protobuf message envoy.config.accesslog.v3.TraceableFilter
 */
export const TraceableFilter = new TraceableFilter$Type();
// @generated message type with reflection information, may provide speed optimized methods
class RuntimeFilter$Type extends MessageType<RuntimeFilter> {
    constructor() {
        super("envoy.config.accesslog.v3.RuntimeFilter", [
            { no: 1, name: "runtime_key", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "validate.rules": { string: { minLen: "1" } } } },
        ...
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.filter.accesslog.v2.RuntimeFilter" } });
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string runtime_key */ 1:
                    ...
                    break;
                case /* envoy.type.v3.FractionalPercent percent_sampled */ 2:
...
class AndFilter$Type extends MessageType<AndFilter> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: AndFilter): AndFilter {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated envoy.config.accesslog.v3.AccessLogFilter filters */ 1:
...
/**
 * @generated MessageType for protobuf message envoy.config.accesslog.v3.AndFilter
 */
export const AndFilter = new AndFilter$Type();
// @generated message type with reflection information, may provide speed optimized methods
class OrFilter$Type extends MessageType<OrFilter> {
    constructor() {
        super("envoy.config.accesslog.v3.OrFilter", [
            { no: 2, name: "filters", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => AccessLogFilter, options: { "validate.rules": { repeated: { minItems: "2" } } } }
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.filter.accesslog.v2.OrFilter" } });
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: OrFilter): OrFilter {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated envoy.config.accesslog.v3.AccessLogFilter filters */ 2:
                    message.filters.push(AccessLogFilter.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
...
/**
 * @generated MessageType for protobuf message envoy.config.accesslog.v3.OrFilter
 */
export const OrFilter = new OrFilter$Type();
// @generated message type with reflection information, may provide speed optimized methods
class HeaderFilter$Type extends MessageType<HeaderFilter> {
    constructor() {
        super("envoy.config.accesslog.v3.HeaderFilter", [
            { no: 1, name: "header", kind: "message", T: () => HeaderMatcher, options: { "validate.rules": { message: { required: true } } } }
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.filter.accesslog.v2.HeaderFilter" } });
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: HeaderFilter): HeaderFilter {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* envoy.config.route.v3.HeaderMatcher header */ 1:
...
/**
 * @generated MessageType for protobuf message envoy.config.accesslog.v3.HeaderFilter
 */
export const HeaderFilter = new HeaderFilter$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ResponseFlagFilter$Type extends MessageType<ResponseFlagFilter> {
    constructor() {
        super("envoy.config.accesslog.v3.ResponseFlagFilter", [
            { no: 1, name: "flags", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/, options: { "validate.rules": { repeated: { items: { string: { in: ["LH", "UH", "UT", "LR", "UR", "UF", "UC", "UO", "NR", "DI", "FI", "RL", "UAEX", "RLSE", "DC", "URX", "SI", "IH", "DPE", "UMSDR", "RFCF", "NFCF", "DT", "UPE", "NC", "OM"] } } } } } }
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.filter.accesslog.v2.ResponseFlagFilter" } });
    }
...
/**
 * @generated MessageType for protobuf message envoy.config.accesslog.v3.ResponseFlagFilter
 */
...
class GrpcStatusFilter$Type extends MessageType<GrpcStatusFilter> {
    constructor() {
        super("envoy.config.accesslog.v3.GrpcStatusFilter", [
            { no: 1, name: "statuses", kind: "enum", repeat: 1 /*RepeatType.PACKED*/, T: () => ["envoy.config.accesslog.v3.GrpcStatusFilter.Status", GrpcStatusFilter_Status], options: { "validate.rules": { repeated: { items: { enum: { definedOnly: true } } } } } },
            { no: 2, name: "exclude", kind: "scalar", T: 8 /*ScalarType.BOOL*/ }
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.filter.accesslog.v2.GrpcStatusFilter" } });
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GrpcStatusFilter): GrpcStatusFilter {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated envoy.config.accesslog.v3.GrpcStatusFilter.Status statuses */ 1:
...
/**
 * @generated MessageType for protobuf message envoy.config.accesslog.v3.GrpcStatusFilter
 */
export const GrpcStatusFilter = new GrpcStatusFilter$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MetadataFilter$Type extends MessageType<MetadataFilter> {
    constructor() {
        super("envoy.config.accesslog.v3.MetadataFilter", [
            { no: 1, name: "matcher", kind: "message", T: () => MetadataMatcher },
            { no: 2, name: "match_if_key_not_found", kind: "message", T: () => BoolValue }
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.filter.accesslog.v2.MetadataFilter" } });
    }
    create(value?: PartialMessage<MetadataFilter>): MetadataFilter {
        const message = globalThis.Object.create((this.messagePrototype!));
        if (value !== undefined)
            reflectionMergePartial<MetadataFilter>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: MetadataFilter): MetadataFilter {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* envoy.type.matcher.v3.MetadataMatcher matcher */ 1:
                    message.matcher = MetadataMatcher.internalBinaryRead(reader, reader.uint32(), options, message.matcher);
                    break;
                case /* google.protobuf.BoolValue match_if_key_not_found */ 2:
                    message.matchIfKeyNotFound = BoolValue.internalBinaryRead(reader, reader.uint32(), options, message.matchIfKeyNotFound);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: MetadataFilter, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* envoy.type.matcher.v3.MetadataMatcher matcher = 1; */
        if (message.matcher)
            MetadataMatcher.internalBinaryWrite(message.matcher, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* google.protobuf.BoolValue match_if_key_not_found = 2; */
        if (message.matchIfKeyNotFound)
            BoolValue.internalBinaryWrite(message.matchIfKeyNotFound, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message envoy.config.accesslog.v3.MetadataFilter
 */
export const MetadataFilter = new MetadataFilter$Type();
// @generated message type with reflection information, may provide speed optimized methods
class LogTypeFilter$Type extends MessageType<LogTypeFilter> {
    constructor() {
        super("envoy.config.accesslog.v3.LogTypeFilter", [
            { no: 1, name: "types", kind: "enum", repeat: 1 /*RepeatType.PACKED*/, T: () => ["envoy.data.accesslog.v3.AccessLogType", AccessLogType], options: { "validate.rules": { repeated: { items: { enum: { definedOnly: true } } } } } },
            { no: 2, name: "exclude", kind: "scalar", T: 8 /*ScalarType.BOOL*/ }
        ]);
    }
    create(value?: PartialMessage<LogTypeFilter>): LogTypeFilter {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.types = [];
        message.exclude = false;
        if (value !== undefined)
            reflectionMergePartial<LogTypeFilter>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: LogTypeFilter): LogTypeFilter {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated envoy.data.accesslog.v3.AccessLogType types */ 1:
                    if (wireType === WireType.LengthDelimited)
                        for (let e = reader.int32() + reader.pos; reader.pos < e;)
    ...
    internalBinaryWrite(message: LogTypeFilter, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
/**
 * @generated MessageType for protobuf message envoy.config.accesslog.v3.LogTypeFilter
 */
export const LogTypeFilter = new LogTypeFilter$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ExtensionFilter$Type extends MessageType<ExtensionFilter> {
    constructor() {
        super("envoy.config.accesslog.v3.ExtensionFilter", [
            { no: 1, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "typed_config", kind: "message", oneof: "configType", T: () => Any }
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.filter.accesslog.v2.ExtensionFilter" } });
    }
...
/**
 * @generated MessageType for protobuf message envoy.config.accesslog.v3.ExtensionFilter
 */
