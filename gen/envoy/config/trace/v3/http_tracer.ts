...
// @generated from protobuf file "envoy/config/trace/v3/http_tracer.proto" (package "envoy.config.trace.v3", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message envoy.config.trace.v3.Tracing
 */
export interface Tracing {
    /**
     * Provides configuration for the HTTP tracer.
     *
     * @generated from protobuf field: envoy.config.trace.v3.Tracing.Http http = 1;
     */
    http?: Tracing_Http;
}
/**
 ...
 * field.
 *
 * @generated from protobuf message envoy.config.trace.v3.Tracing.Http
 */
...
class Tracing$Type extends MessageType<Tracing> {
    constructor() {
        super("envoy.config.trace.v3.Tracing", [
            { no: 1, name: "http", kind: "message", T: () => Tracing_Http }
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.trace.v2.Tracing" } });
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Tracing): Tracing {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* envoy.config.trace.v3.Tracing.Http http */ 1:
...
/**
 * @generated MessageType for protobuf message envoy.config.trace.v3.Tracing
 */
export const Tracing = new Tracing$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Tracing_Http$Type extends MessageType<Tracing_Http> {
    constructor() {
        super("envoy.config.trace.v3.Tracing.Http", [
        ...
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.trace.v2.Tracing.Http" } });
    }
...
/**
 * @generated MessageType for protobuf message envoy.config.trace.v3.Tracing.Http
 */
