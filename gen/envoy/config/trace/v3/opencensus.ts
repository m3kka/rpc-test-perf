...
// @generated from protobuf file "envoy/config/trace/v3/opencensus.proto" (package "envoy.config.trace.v3", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message envoy.config.trace.v3.OpenCensusConfig
 */
export interface OpenCensusConfig {
     ...
     *
     * @generated from protobuf field: envoy.config.core.v3.GrpcService stackdriver_grpc_service = 13;
     */
     ...
     *
     * @deprecated
     * @generated from protobuf field: bool zipkin_exporter_enabled = 5 [deprecated = true];
     */
     ...
     *
     * @deprecated
     * @generated from protobuf field: string zipkin_url = 6 [deprecated = true];
     */
    zipkinUrl: string;
    /**
     ...
     *
     * @generated from protobuf field: envoy.config.core.v3.GrpcService ocagent_grpc_service = 14;
     */
     ...
     * wins.
     *
     * @generated from protobuf field: repeated envoy.config.trace.v3.OpenCensusConfig.TraceContext incoming_trace_context = 8;
     */
    incomingTraceContext: OpenCensusConfig_TraceContext[];
    /**
     * List of outgoing trace context headers we will produce.
     *
     * @generated from protobuf field: repeated envoy.config.trace.v3.OpenCensusConfig.TraceContext outgoing_trace_context = 9;
     */
    outgoingTraceContext: OpenCensusConfig_TraceContext[];
}
/**
 * @generated from protobuf enum envoy.config.trace.v3.OpenCensusConfig.TraceContext
 */
...
class OpenCensusConfig$Type extends MessageType<OpenCensusConfig> {
    constructor() {
        super("envoy.config.trace.v3.OpenCensusConfig", [
            ...
            { no: 5, name: "zipkin_exporter_enabled", kind: "scalar", T: 8 /*ScalarType.BOOL*/, options: { "envoy.annotations.deprecated_at_minor_version": "3.0" } },
            { no: 6, name: "zipkin_url", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "envoy.annotations.deprecated_at_minor_version": "3.0" } },
            ...
            { no: 8, name: "incoming_trace_context", kind: "enum", repeat: 1 /*RepeatType.PACKED*/, T: () => ["envoy.config.trace.v3.OpenCensusConfig.TraceContext", OpenCensusConfig_TraceContext] },
            { no: 9, name: "outgoing_trace_context", kind: "enum", repeat: 1 /*RepeatType.PACKED*/, T: () => ["envoy.config.trace.v3.OpenCensusConfig.TraceContext", OpenCensusConfig_TraceContext] }
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.config.trace.v2.OpenCensusConfig" } });
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string stackdriver_address */ 10:
                    ...
                    break;
                case /* envoy.config.core.v3.GrpcService stackdriver_grpc_service */ 13:
                    ...
                    break;
                case /* bool zipkin_exporter_enabled = 5 [deprecated = true];*/ 5:
                    message.zipkinExporterEnabled = reader.bool();
                    break;
                case /* string zipkin_url = 6 [deprecated = true];*/ 6:
                ...
                case /* string ocagent_address */ 12:
                    ...
                    break;
                case /* envoy.config.core.v3.GrpcService ocagent_grpc_service */ 14:
                    message.ocagentGrpcService = GrpcService.internalBinaryRead(reader, reader.uint32(), options, message.ocagentGrpcService);
                    break;
                case /* repeated envoy.config.trace.v3.OpenCensusConfig.TraceContext incoming_trace_context */ 8:
                    if (wireType === WireType.LengthDelimited)
                        ...
                        message.incomingTraceContext.push(reader.int32());
                    break;
                case /* repeated envoy.config.trace.v3.OpenCensusConfig.TraceContext outgoing_trace_context */ 9:
                    if (wireType === WireType.LengthDelimited)
                        for (let e = reader.int32() + reader.pos; reader.pos < e;)
...
/**
 * @generated MessageType for protobuf message envoy.config.trace.v3.OpenCensusConfig
 */
