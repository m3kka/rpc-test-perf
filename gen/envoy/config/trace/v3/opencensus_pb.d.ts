...
// @generated from file envoy/config/trace/v3/opencensus.proto (package envoy.config.trace.v3, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message envoy.config.trace.v3.OpenCensusConfig
 */
export declare class OpenCensusConfig extends Message<OpenCensusConfig> {
   ...
   *
   * @generated from field: envoy.config.core.v3.GrpcService stackdriver_grpc_service = 13;
   */
   ...
   *
   * @generated from field: bool zipkin_exporter_enabled = 5 [deprecated = true];
   * @deprecated
   */
   ...
   *
   * @generated from field: string zipkin_url = 6 [deprecated = true];
   * @deprecated
   */
  zipkinUrl: string;
   ...
   *
   * @generated from field: envoy.config.core.v3.GrpcService ocagent_grpc_service = 14;
   */
   ...
   * wins.
   *
   * @generated from field: repeated envoy.config.trace.v3.OpenCensusConfig.TraceContext incoming_trace_context = 8;
   */
   ...
   *
   * @generated from field: repeated envoy.config.trace.v3.OpenCensusConfig.TraceContext outgoing_trace_context = 9;
   */
  ...
  static readonly typeName = "envoy.config.trace.v3.OpenCensusConfig";
...
/**
 * @generated from enum envoy.config.trace.v3.OpenCensusConfig.TraceContext
 */
