...
// @generated from protobuf file "envoy/config/trace/v2/lightstep.proto" (package "envoy.config.trace.v2", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message envoy.config.trace.v2.LightstepConfig
 */
export interface LightstepConfig {
     ...
     *
     * @generated from protobuf field: string access_token_file = 2;
     */
    accessTokenFile: string;
    /**
     * Propagation modes to use by LightStep's tracer.
     *
     * @generated from protobuf field: repeated envoy.config.trace.v2.LightstepConfig.PropagationMode propagation_modes = 3;
     */
 ...
 *
 * @generated from protobuf enum envoy.config.trace.v2.LightstepConfig.PropagationMode
 */
...
class LightstepConfig$Type extends MessageType<LightstepConfig> {
    constructor() {
        super("envoy.config.trace.v2.LightstepConfig", [
            { no: 1, name: "collector_cluster", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "validate.rules": { string: { minBytes: "1" } } } },
            { no: 2, name: "access_token_file", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "validate.rules": { string: { minBytes: "1" } } } },
            { no: 3, name: "propagation_modes", kind: "enum", repeat: 1 /*RepeatType.PACKED*/, T: () => ["envoy.config.trace.v2.LightstepConfig.PropagationMode", LightstepConfig_PropagationMode], options: { "validate.rules": { repeated: { items: { enum: { definedOnly: true } } } } } }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string collector_cluster */ 1:
                    ...
                    break;
                case /* string access_token_file */ 2:
                    message.accessTokenFile = reader.string();
                    break;
                case /* repeated envoy.config.trace.v2.LightstepConfig.PropagationMode propagation_modes */ 3:
...
/**
 * @generated MessageType for protobuf message envoy.config.trace.v2.LightstepConfig
 */
