...
// @generated from protobuf file "envoy/config/trace/v2/dynamic_ot.proto" (package "envoy.config.trace.v2", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message envoy.config.trace.v2.DynamicOtConfig
 */
...
class DynamicOtConfig$Type extends MessageType<DynamicOtConfig> {
    constructor() {
        super("envoy.config.trace.v2.DynamicOtConfig", [
            { no: 1, name: "library", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "validate.rules": { string: { minBytes: "1" } } } },
...
/**
 * @generated MessageType for protobuf message envoy.config.trace.v2.DynamicOtConfig
 */
