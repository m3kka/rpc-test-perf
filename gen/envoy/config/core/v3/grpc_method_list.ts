...
// @generated from protobuf file "envoy/config/core/v3/grpc_method_list.proto" (package "envoy.config.core.v3", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message envoy.config.core.v3.GrpcMethodList
 */
export interface GrpcMethodList {
    /**
     * @generated from protobuf field: repeated envoy.config.core.v3.GrpcMethodList.Service services = 1;
     */
    services: GrpcMethodList_Service[];
}
/**
 * @generated from protobuf message envoy.config.core.v3.GrpcMethodList.Service
 */
...
class GrpcMethodList$Type extends MessageType<GrpcMethodList> {
    constructor() {
        super("envoy.config.core.v3.GrpcMethodList", [
            { no: 1, name: "services", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => GrpcMethodList_Service }
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.api.v2.core.GrpcMethodList" } });
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GrpcMethodList): GrpcMethodList {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated envoy.config.core.v3.GrpcMethodList.Service services */ 1:
...
/**
 * @generated MessageType for protobuf message envoy.config.core.v3.GrpcMethodList
 */
...
class GrpcMethodList_Service$Type extends MessageType<GrpcMethodList_Service> {
    constructor() {
        super("envoy.config.core.v3.GrpcMethodList.Service", [
        ...
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.api.v2.core.GrpcMethodList.Service" } });
    }
...
/**
 * @generated MessageType for protobuf message envoy.config.core.v3.GrpcMethodList.Service
 */
