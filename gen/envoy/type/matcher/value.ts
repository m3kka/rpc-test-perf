...
// @generated from protobuf file "envoy/type/matcher/value.proto" (package "envoy.type.matcher", syntax proto3)
// tslint:disable
 ...
 * [#next-free-field: 7]
 *
 * @generated from protobuf message envoy.type.matcher.ValueMatcher
 */
export interface ValueMatcher {
    ...
    matchPattern: {
         ...
         *
         * @generated from protobuf field: envoy.type.matcher.ValueMatcher.NullMatch null_match = 1;
         */
         ...
         *
         * @generated from protobuf field: envoy.type.matcher.DoubleMatcher double_match = 2;
         */
         ...
         * matched to this field.
         *
         * @generated from protobuf field: envoy.type.matcher.StringMatcher string_match = 3;
         */
         ...
         *
         * @generated from protobuf field: envoy.type.matcher.ListMatcher list_match = 6;
         */
 ...
 *
 * @generated from protobuf message envoy.type.matcher.ValueMatcher.NullMatch
 */
 ...
 *
 * @generated from protobuf message envoy.type.matcher.ListMatcher
 */
export interface ListMatcher {
    ...
    matchPattern: {
         ...
         *
         * @generated from protobuf field: envoy.type.matcher.ValueMatcher one_of = 1;
         */
        oneOf: ValueMatcher;
    } | {
        oneofKind: undefined;
...
class ValueMatcher$Type extends MessageType<ValueMatcher> {
    constructor() {
        super("envoy.type.matcher.ValueMatcher", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ValueMatcher): ValueMatcher {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* envoy.type.matcher.ValueMatcher.NullMatch null_match */ 1:
                ...
                case /* bool present_match */ 5:
                    ...
                    break;
                case /* envoy.type.matcher.ListMatcher list_match */ 6:
                    message.matchPattern = {
                        oneofKind: "listMatch",
...
/**
 * @generated MessageType for protobuf message envoy.type.matcher.ValueMatcher
 */
...
class ValueMatcher_NullMatch$Type extends MessageType<ValueMatcher_NullMatch> {
    constructor() {
        super("envoy.type.matcher.ValueMatcher.NullMatch", []);
    }
...
/**
 * @generated MessageType for protobuf message envoy.type.matcher.ValueMatcher.NullMatch
 */
...
class ListMatcher$Type extends MessageType<ListMatcher> {
    constructor() {
        super("envoy.type.matcher.ListMatcher", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ListMatcher): ListMatcher {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* envoy.type.matcher.ValueMatcher one_of */ 1:
                    message.matchPattern = {
                        oneofKind: "oneOf",
...
/**
 * @generated MessageType for protobuf message envoy.type.matcher.ListMatcher
 */
