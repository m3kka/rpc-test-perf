...
// @generated from protobuf file "envoy/type/matcher/node.proto" (package "envoy.type.matcher", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message envoy.type.matcher.NodeMatcher
 */
export interface NodeMatcher {
    /**
     * Specifies match criteria on the node id.
     *
     * @generated from protobuf field: envoy.type.matcher.StringMatcher node_id = 1;
     */
    nodeId?: StringMatcher;
    /**
     * Specifies match criteria on the node metadata.
     *
     * @generated from protobuf field: repeated envoy.type.matcher.StructMatcher node_metadatas = 2;
     */
...
class NodeMatcher$Type extends MessageType<NodeMatcher> {
    constructor() {
        super("envoy.type.matcher.NodeMatcher", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: NodeMatcher): NodeMatcher {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* envoy.type.matcher.StringMatcher node_id */ 1:
                    message.nodeId = StringMatcher.internalBinaryRead(reader, reader.uint32(), options, message.nodeId);
                    break;
                case /* repeated envoy.type.matcher.StructMatcher node_metadatas */ 2:
...
/**
 * @generated MessageType for protobuf message envoy.type.matcher.NodeMatcher
 */
