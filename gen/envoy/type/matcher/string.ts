...
// @generated from protobuf file "envoy/type/matcher/string.proto" (package "envoy.type.matcher", syntax proto3)
// tslint:disable
 ...
 * [#next-free-field: 7]
 *
 * @generated from protobuf message envoy.type.matcher.StringMatcher
 */
export interface StringMatcher {
    ...
    matchPattern: {
         ...
         *
         * @deprecated
         * @generated from protobuf field: string regex = 4 [deprecated = true];
         */
        regex: string;
    } | {
        oneofKind: "safeRegex";
         ...
         * The input string must match the regular expression specified here.
         *
         * @generated from protobuf field: envoy.type.matcher.RegexMatcher safe_regex = 5;
         */
 ...
 *
 * @generated from protobuf message envoy.type.matcher.ListStringMatcher
 */
export interface ListStringMatcher {
    /**
     * @generated from protobuf field: repeated envoy.type.matcher.StringMatcher patterns = 1;
     */
...
class StringMatcher$Type extends MessageType<StringMatcher> {
    constructor() {
        super("envoy.type.matcher.StringMatcher", [
            ...
            { no: 4, name: "regex", kind: "scalar", oneof: "matchPattern", T: 9 /*ScalarType.STRING*/, options: { "validate.rules": { string: { maxBytes: "1024" } }, "envoy.annotations.disallowed_by_default": true } },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string suffix */ 3:
                    ...
                    break;
                case /* string regex = 4 [deprecated = true];*/ 4:
                    message.matchPattern = {
                        oneofKind: "regex",
                        regex: reader.string()
                    };
                    break;
                case /* envoy.type.matcher.RegexMatcher safe_regex */ 5:
                    message.matchPattern = {
                        oneofKind: "safeRegex",
    ...
    internalBinaryWrite(message: StringMatcher, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* string regex = 4 [deprecated = true]; */
        if (message.matchPattern.oneofKind === "regex")
            writer.tag(4, WireType.LengthDelimited).string(message.matchPattern.regex);
...
/**
 * @generated MessageType for protobuf message envoy.type.matcher.StringMatcher
 */
export const StringMatcher = new StringMatcher$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ListStringMatcher$Type extends MessageType<ListStringMatcher> {
    constructor() {
        super("envoy.type.matcher.ListStringMatcher", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ListStringMatcher): ListStringMatcher {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated envoy.type.matcher.StringMatcher patterns */ 1:
...
/**
 * @generated MessageType for protobuf message envoy.type.matcher.ListStringMatcher
 */
