...
// @generated from protobuf file "envoy/type/matcher/path.proto" (package "envoy.type.matcher", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message envoy.type.matcher.PathMatcher
 */
export interface PathMatcher {
    ...
    rule: {
         ...
         *
         * @generated from protobuf field: envoy.type.matcher.StringMatcher path = 1;
         */
        path: StringMatcher;
    } | {
        oneofKind: undefined;
...
class PathMatcher$Type extends MessageType<PathMatcher> {
    constructor() {
        super("envoy.type.matcher.PathMatcher", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: PathMatcher): PathMatcher {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* envoy.type.matcher.StringMatcher path */ 1:
                    message.rule = {
                        oneofKind: "path",
...
/**
 * @generated MessageType for protobuf message envoy.type.matcher.PathMatcher
 */
