 ...
 *
 * @generated from protobuf message envoy.api.v2.CdsDummy
 */
...
/**
 * @generated MessageType for protobuf message envoy.api.v2.CdsDummy
 */
export const CdsDummy = new CdsDummy$Type();
/**
 * @generated ServiceType for protobuf service envoy.api.v2.ClusterDiscoveryService
 */
export const ClusterDiscoveryService = new ServiceType("envoy.api.v2.ClusterDiscoveryService", [
    ...
    { name: "FetchClusters", options: { "google.api.http": { post: "/v2/discovery:clusters", body: "*" } }, I: DiscoveryRequest, O: DiscoveryResponse }
], { "envoy.annotations.resource": { type: "envoy.api.v2.Cluster" } });
