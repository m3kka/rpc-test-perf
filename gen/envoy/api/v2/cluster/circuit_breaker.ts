...
// @generated from protobuf file "envoy/api/v2/cluster/circuit_breaker.proto" (package "envoy.api.v2.cluster", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message envoy.api.v2.cluster.CircuitBreakers
 */
export interface CircuitBreakers {
     ...
     * are used.
     *
     * @generated from protobuf field: repeated envoy.api.v2.cluster.CircuitBreakers.Thresholds thresholds = 1;
     */
 ...
 * [#next-free-field: 9]
 *
 * @generated from protobuf message envoy.api.v2.cluster.CircuitBreakers.Thresholds
 */
export interface CircuitBreakers_Thresholds {
     ...
     *
     * @generated from protobuf field: envoy.api.v2.core.RoutingPriority priority = 1;
     */
     ...
     *    breaker.
     *
     * @generated from protobuf field: envoy.api.v2.cluster.CircuitBreakers.Thresholds.RetryBudget retry_budget = 8;
     */
...
/**
 * @generated from protobuf message envoy.api.v2.cluster.CircuitBreakers.Thresholds.RetryBudget
 */
export interface CircuitBreakers_Thresholds_RetryBudget {
     ...
     *
     * @generated from protobuf field: envoy.type.Percent budget_percent = 1;
     */
...
class CircuitBreakers$Type extends MessageType<CircuitBreakers> {
    constructor() {
        super("envoy.api.v2.cluster.CircuitBreakers", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CircuitBreakers): CircuitBreakers {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated envoy.api.v2.cluster.CircuitBreakers.Thresholds thresholds */ 1:
...
/**
 * @generated MessageType for protobuf message envoy.api.v2.cluster.CircuitBreakers
 */
...
class CircuitBreakers_Thresholds$Type extends MessageType<CircuitBreakers_Thresholds> {
    constructor() {
        super("envoy.api.v2.cluster.CircuitBreakers.Thresholds", [
            { no: 1, name: "priority", kind: "enum", T: () => ["envoy.api.v2.core.RoutingPriority", RoutingPriority], options: { "validate.rules": { enum: { definedOnly: true } } } },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CircuitBreakers_Thresholds): CircuitBreakers_Thresholds {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* envoy.api.v2.core.RoutingPriority priority */ 1:
                ...
                case /* google.protobuf.UInt32Value max_retries */ 5:
                    ...
                    break;
                case /* envoy.api.v2.cluster.CircuitBreakers.Thresholds.RetryBudget retry_budget */ 8:
...
/**
 * @generated MessageType for protobuf message envoy.api.v2.cluster.CircuitBreakers.Thresholds
 */
...
class CircuitBreakers_Thresholds_RetryBudget$Type extends MessageType<CircuitBreakers_Thresholds_RetryBudget> {
    constructor() {
        super("envoy.api.v2.cluster.CircuitBreakers.Thresholds.RetryBudget", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CircuitBreakers_Thresholds_RetryBudget): CircuitBreakers_Thresholds_RetryBudget {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* envoy.type.Percent budget_percent */ 1:
...
/**
 * @generated MessageType for protobuf message envoy.api.v2.cluster.CircuitBreakers.Thresholds.RetryBudget
 */
