...
// @generated from protobuf file "envoy/admin/v3/memory.proto" (package "envoy.admin.v3", syntax proto3)
// tslint:disable
 ...
 * [#next-free-field: 7]
 *
 * @generated from protobuf message envoy.admin.v3.Memory
 */
...
class Memory$Type extends MessageType<Memory> {
    constructor() {
        ...
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.admin.v2alpha.Memory" } });
    }
...
/**
 * @generated MessageType for protobuf message envoy.admin.v3.Memory
 */
