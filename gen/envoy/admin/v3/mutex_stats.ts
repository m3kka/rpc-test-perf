...
// @generated from protobuf file "envoy/admin/v3/mutex_stats.proto" (package "envoy.admin.v3", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message envoy.admin.v3.MutexStats
 */
...
class MutexStats$Type extends MessageType<MutexStats> {
    constructor() {
        super("envoy.admin.v3.MutexStats", [
        ...
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.admin.v2alpha.MutexStats" } });
    }
...
/**
 * @generated MessageType for protobuf message envoy.admin.v3.MutexStats
 */
