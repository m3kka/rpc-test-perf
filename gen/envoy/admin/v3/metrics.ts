...
// @generated from protobuf file "envoy/admin/v3/metrics.proto" (package "envoy.admin.v3", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message envoy.admin.v3.SimpleMetric
 */
export interface SimpleMetric {
    /**
     * Type of the metric represented.
     *
     * @generated from protobuf field: envoy.admin.v3.SimpleMetric.Type type = 1;
     */
...
/**
 * @generated from protobuf enum envoy.admin.v3.SimpleMetric.Type
 */
...
class SimpleMetric$Type extends MessageType<SimpleMetric> {
    constructor() {
        super("envoy.admin.v3.SimpleMetric", [
            { no: 1, name: "type", kind: "enum", T: () => ["envoy.admin.v3.SimpleMetric.Type", SimpleMetric_Type] },
            { no: 2, name: "value", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 3, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.admin.v2alpha.SimpleMetric" } });
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SimpleMetric): SimpleMetric {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* envoy.admin.v3.SimpleMetric.Type type */ 1:
...
/**
 * @generated MessageType for protobuf message envoy.admin.v3.SimpleMetric
 */
