...
// @generated from protobuf file "envoy/data/accesslog/v2/accesslog.proto" (package "envoy.data.accesslog.v2", syntax proto3)
// tslint:disable
...
import { RequestMethod } from "../../../api/v2/core/base";
...
/**
 * @generated from protobuf message envoy.data.accesslog.v2.TCPAccessLogEntry
 */
export interface TCPAccessLogEntry {
    /**
     * Common properties shared by all Envoy access logs.
     *
     * @generated from protobuf field: envoy.data.accesslog.v2.AccessLogCommon common_properties = 1;
     */
    commonProperties?: AccessLogCommon;
    /**
     * Properties of the TCP connection.
     *
     * @generated from protobuf field: envoy.data.accesslog.v2.ConnectionProperties connection_properties = 2;
     */
    connectionProperties?: ConnectionProperties;
}
/**
 * @generated from protobuf message envoy.data.accesslog.v2.HTTPAccessLogEntry
 */
export interface HTTPAccessLogEntry {
    ...
    commonProperties?: AccessLogCommon;
    /**
     * @generated from protobuf field: envoy.data.accesslog.v2.HTTPAccessLogEntry.HTTPVersion protocol_version = 2;
     */
    protocolVersion: HTTPAccessLogEntry_HTTPVersion;
    /**
     * Description of the incoming HTTP request.
     *
     * @generated from protobuf field: envoy.data.accesslog.v2.HTTPRequestProperties request = 3;
     */
    request?: HTTPRequestProperties;
    /**
     * Description of the outgoing HTTP response.
     *
     * @generated from protobuf field: envoy.data.accesslog.v2.HTTPResponseProperties response = 4;
     */
 ...
 * HTTP version
 *
 * @generated from protobuf enum envoy.data.accesslog.v2.HTTPAccessLogEntry.HTTPVersion
 */
 ...
 *
 * @generated from protobuf message envoy.data.accesslog.v2.ConnectionProperties
 */
 ...
 * [#next-free-field: 22]
 *
 * @generated from protobuf message envoy.data.accesslog.v2.AccessLogCommon
 */
export interface AccessLogCommon {
     ...
     *
     * @generated from protobuf field: envoy.api.v2.core.Address downstream_remote_address = 2;
     */
    downstreamRemoteAddress?: Address;
    /**
     * This field is the local/destination address on which the request from the user was received.
     *
     * @generated from protobuf field: envoy.api.v2.core.Address downstream_local_address = 3;
     */
    downstreamLocalAddress?: Address;
    /**
     * If the connection is secure,S this field will contain TLS properties.
     *
     * @generated from protobuf field: envoy.data.accesslog.v2.TLSProperties tls_properties = 4;
     */
     ...
     * retries.
     *
     * @generated from protobuf field: envoy.api.v2.core.Address upstream_remote_address = 13;
     */
    upstreamRemoteAddress?: Address;
    /**
     * The upstream local/origin address that handles this exchange. This does not include retries.
     *
     * @generated from protobuf field: envoy.api.v2.core.Address upstream_local_address = 14;
     */
     ...
     *
     * @generated from protobuf field: envoy.data.accesslog.v2.ResponseFlags response_flags = 16;
     */
     ...
     *
     * @generated from protobuf field: envoy.api.v2.core.Metadata metadata = 17;
     */
    metadata?: Metadata;
    /**
     ...
     *
     * @generated from protobuf field: envoy.api.v2.core.Address downstream_direct_remote_address = 20;
     */
 ...
 * [#next-free-field: 20]
 *
 * @generated from protobuf message envoy.data.accesslog.v2.ResponseFlags
 */
export interface ResponseFlags {
     ...
     *
     * @generated from protobuf field: envoy.data.accesslog.v2.ResponseFlags.Unauthorized unauthorized_details = 13;
     */
...
/**
 * @generated from protobuf message envoy.data.accesslog.v2.ResponseFlags.Unauthorized
 */
export interface ResponseFlags_Unauthorized {
    /**
     * @generated from protobuf field: envoy.data.accesslog.v2.ResponseFlags.Unauthorized.Reason reason = 1;
     */
 ...
 *
 * @generated from protobuf enum envoy.data.accesslog.v2.ResponseFlags.Unauthorized.Reason
 */
 ...
 * [#next-free-field: 7]
 *
 * @generated from protobuf message envoy.data.accesslog.v2.TLSProperties
 */
export interface TLSProperties {
    /**
     * Version of TLS that was negotiated.
     *
     * @generated from protobuf field: envoy.data.accesslog.v2.TLSProperties.TLSVersion tls_version = 1;
     */
     ...
     *
     * @generated from protobuf field: envoy.data.accesslog.v2.TLSProperties.CertificateProperties local_certificate_properties = 4;
     */
    localCertificateProperties?: TLSProperties_CertificateProperties;
    /**
     * Properties of the peer certificate used to negotiate TLS.
     *
     * @generated from protobuf field: envoy.data.accesslog.v2.TLSProperties.CertificateProperties peer_certificate_properties = 5;
     */
...
/**
 * @generated from protobuf message envoy.data.accesslog.v2.TLSProperties.CertificateProperties
 */
export interface TLSProperties_CertificateProperties {
    /**
     * SANs present in the certificate.
     *
     * @generated from protobuf field: repeated envoy.data.accesslog.v2.TLSProperties.CertificateProperties.SubjectAltName subject_alt_name = 1;
     */
...
/**
 * @generated from protobuf message envoy.data.accesslog.v2.TLSProperties.CertificateProperties.SubjectAltName
 */
...
/**
 * @generated from protobuf enum envoy.data.accesslog.v2.TLSProperties.TLSVersion
 */
 ...
 * [#next-free-field: 14]
 *
 * @generated from protobuf message envoy.data.accesslog.v2.HTTPRequestProperties
 */
export interface HTTPRequestProperties {
    /**
     * The request method (RFC 7231/2616).
     *
     * @generated from protobuf field: envoy.api.v2.core.RequestMethod request_method = 1;
     */
 ...
 * [#next-free-field: 7]
 *
 * @generated from protobuf message envoy.data.accesslog.v2.HTTPResponseProperties
 */
...
class TCPAccessLogEntry$Type extends MessageType<TCPAccessLogEntry> {
    constructor() {
        super("envoy.data.accesslog.v2.TCPAccessLogEntry", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: TCPAccessLogEntry): TCPAccessLogEntry {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* envoy.data.accesslog.v2.AccessLogCommon common_properties */ 1:
                    message.commonProperties = AccessLogCommon.internalBinaryRead(reader, reader.uint32(), options, message.commonProperties);
                    break;
                case /* envoy.data.accesslog.v2.ConnectionProperties connection_properties */ 2:
...
/**
 * @generated MessageType for protobuf message envoy.data.accesslog.v2.TCPAccessLogEntry
 */
...
class HTTPAccessLogEntry$Type extends MessageType<HTTPAccessLogEntry> {
    constructor() {
        super("envoy.data.accesslog.v2.HTTPAccessLogEntry", [
            { no: 1, name: "common_properties", kind: "message", T: () => AccessLogCommon },
            { no: 2, name: "protocol_version", kind: "enum", T: () => ["envoy.data.accesslog.v2.HTTPAccessLogEntry.HTTPVersion", HTTPAccessLogEntry_HTTPVersion] },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* envoy.data.accesslog.v2.AccessLogCommon common_properties */ 1:
                    message.commonProperties = AccessLogCommon.internalBinaryRead(reader, reader.uint32(), options, message.commonProperties);
                    break;
                case /* envoy.data.accesslog.v2.HTTPAccessLogEntry.HTTPVersion protocol_version */ 2:
                    message.protocolVersion = reader.int32();
                    break;
                case /* envoy.data.accesslog.v2.HTTPRequestProperties request */ 3:
                    message.request = HTTPRequestProperties.internalBinaryRead(reader, reader.uint32(), options, message.request);
                    break;
                case /* envoy.data.accesslog.v2.HTTPResponseProperties response */ 4:
...
/**
 * @generated MessageType for protobuf message envoy.data.accesslog.v2.HTTPAccessLogEntry
 */
...
class ConnectionProperties$Type extends MessageType<ConnectionProperties> {
    constructor() {
        super("envoy.data.accesslog.v2.ConnectionProperties", [
...
/**
 * @generated MessageType for protobuf message envoy.data.accesslog.v2.ConnectionProperties
 */
...
class AccessLogCommon$Type extends MessageType<AccessLogCommon> {
    constructor() {
        super("envoy.data.accesslog.v2.AccessLogCommon", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string route_name */ 19:
                    ...
                    break;
                case /* envoy.api.v2.core.Address downstream_direct_remote_address */ 20:
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    ...
                    break;
                default: throw new globalThis.Error("unknown map entry field for field envoy.data.accesslog.v2.AccessLogCommon.filter_state_objects");
            }
        }
...
/**
 * @generated MessageType for protobuf message envoy.data.accesslog.v2.AccessLogCommon
 */
export const AccessLogCommon = new AccessLogCommon$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ResponseFlags$Type extends MessageType<ResponseFlags> {
    constructor() {
        super("envoy.data.accesslog.v2.ResponseFlags", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* bool rate_limited */ 12:
                    ...
                    break;
                case /* envoy.data.accesslog.v2.ResponseFlags.Unauthorized unauthorized_details */ 13:
...
/**
 * @generated MessageType for protobuf message envoy.data.accesslog.v2.ResponseFlags
 */
...
class ResponseFlags_Unauthorized$Type extends MessageType<ResponseFlags_Unauthorized> {
    constructor() {
        super("envoy.data.accesslog.v2.ResponseFlags.Unauthorized", [
            { no: 1, name: "reason", kind: "enum", T: () => ["envoy.data.accesslog.v2.ResponseFlags.Unauthorized.Reason", ResponseFlags_Unauthorized_Reason] }
        ]);
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ResponseFlags_Unauthorized): ResponseFlags_Unauthorized {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* envoy.data.accesslog.v2.ResponseFlags.Unauthorized.Reason reason */ 1:
...
/**
 * @generated MessageType for protobuf message envoy.data.accesslog.v2.ResponseFlags.Unauthorized
 */
...
class TLSProperties$Type extends MessageType<TLSProperties> {
    constructor() {
        super("envoy.data.accesslog.v2.TLSProperties", [
            { no: 1, name: "tls_version", kind: "enum", T: () => ["envoy.data.accesslog.v2.TLSProperties.TLSVersion", TLSProperties_TLSVersion] },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: TLSProperties): TLSProperties {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* envoy.data.accesslog.v2.TLSProperties.TLSVersion tls_version */ 1:
                ...
                case /* string tls_sni_hostname */ 3:
                    ...
                    break;
                case /* envoy.data.accesslog.v2.TLSProperties.CertificateProperties local_certificate_properties */ 4:
                    ...
                    break;
                case /* envoy.data.accesslog.v2.TLSProperties.CertificateProperties peer_certificate_properties */ 5:
...
/**
 * @generated MessageType for protobuf message envoy.data.accesslog.v2.TLSProperties
 */
...
class TLSProperties_CertificateProperties$Type extends MessageType<TLSProperties_CertificateProperties> {
    constructor() {
        super("envoy.data.accesslog.v2.TLSProperties.CertificateProperties", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: TLSProperties_CertificateProperties): TLSProperties_CertificateProperties {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated envoy.data.accesslog.v2.TLSProperties.CertificateProperties.SubjectAltName subject_alt_name */ 1:
...
/**
 * @generated MessageType for protobuf message envoy.data.accesslog.v2.TLSProperties.CertificateProperties
 */
...
class TLSProperties_CertificateProperties_SubjectAltName$Type extends MessageType<TLSProperties_CertificateProperties_SubjectAltName> {
    constructor() {
        super("envoy.data.accesslog.v2.TLSProperties.CertificateProperties.SubjectAltName", [
...
/**
 * @generated MessageType for protobuf message envoy.data.accesslog.v2.TLSProperties.CertificateProperties.SubjectAltName
 */
...
class HTTPRequestProperties$Type extends MessageType<HTTPRequestProperties> {
    constructor() {
        super("envoy.data.accesslog.v2.HTTPRequestProperties", [
            { no: 1, name: "request_method", kind: "enum", T: () => ["envoy.api.v2.core.RequestMethod", RequestMethod], options: { "validate.rules": { enum: { definedOnly: true } } } },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: HTTPRequestProperties): HTTPRequestProperties {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* envoy.api.v2.core.RequestMethod request_method */ 1:
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field envoy.data.accesslog.v2.HTTPRequestProperties.request_headers");
            }
        }
        map[key ?? ""] = val ?? "";
    }
...
/**
 * @generated MessageType for protobuf message envoy.data.accesslog.v2.HTTPRequestProperties
 */
...
class HTTPResponseProperties$Type extends MessageType<HTTPResponseProperties> {
    constructor() {
        super("envoy.data.accesslog.v2.HTTPResponseProperties", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field envoy.data.accesslog.v2.HTTPResponseProperties.response_headers");
            }
        }
        map[key ?? ""] = val ?? "";
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field envoy.data.accesslog.v2.HTTPResponseProperties.response_trailers");
            }
        }
        map[key ?? ""] = val ?? "";
    }
...
/**
 * @generated MessageType for protobuf message envoy.data.accesslog.v2.HTTPResponseProperties
 */
