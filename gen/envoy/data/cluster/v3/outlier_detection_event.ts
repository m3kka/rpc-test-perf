...
// @generated from protobuf file "envoy/data/cluster/v3/outlier_detection_event.proto" (package "envoy.data.cluster.v3", syntax proto3)
// tslint:disable
 ...
 * [#next-free-field: 12]
 *
 * @generated from protobuf message envoy.data.cluster.v3.OutlierDetectionEvent
 */
export interface OutlierDetectionEvent {
    /**
     * In case of eject represents type of ejection that took place.
     *
     * @generated from protobuf field: envoy.data.cluster.v3.OutlierEjectionType type = 1;
     */
     ...
     *
     * @generated from protobuf field: envoy.data.cluster.v3.Action action = 6;
     */
    action: Action;
    /**
    ...
    event: {
        ...
        /**
         * @generated from protobuf field: envoy.data.cluster.v3.OutlierEjectSuccessRate eject_success_rate_event = 9;
         */
        ejectSuccessRateEvent: OutlierEjectSuccessRate;
    } | {
        oneofKind: "ejectConsecutiveEvent";
        /**
         * @generated from protobuf field: envoy.data.cluster.v3.OutlierEjectConsecutive eject_consecutive_event = 10;
         */
        ejectConsecutiveEvent: OutlierEjectConsecutive;
    } | {
        oneofKind: "ejectFailurePercentageEvent";
        /**
         * @generated from protobuf field: envoy.data.cluster.v3.OutlierEjectFailurePercentage eject_failure_percentage_event = 11;
         */
...
/**
 * @generated from protobuf message envoy.data.cluster.v3.OutlierEjectSuccessRate
 */
...
/**
 * @generated from protobuf message envoy.data.cluster.v3.OutlierEjectConsecutive
 */
export interface OutlierEjectConsecutive {
}
/**
 * @generated from protobuf message envoy.data.cluster.v3.OutlierEjectFailurePercentage
 */
 ...
 *
 * @generated from protobuf enum envoy.data.cluster.v3.OutlierEjectionType
 */
 ...
 *
 * @generated from protobuf enum envoy.data.cluster.v3.Action
 */
export enum Action {
    /**
...
class OutlierDetectionEvent$Type extends MessageType<OutlierDetectionEvent> {
    constructor() {
        super("envoy.data.cluster.v3.OutlierDetectionEvent", [
            { no: 1, name: "type", kind: "enum", T: () => ["envoy.data.cluster.v3.OutlierEjectionType", OutlierEjectionType], options: { "validate.rules": { enum: { definedOnly: true } } } },
            { no: 2, name: "timestamp", kind: "message", T: () => Timestamp },
            { no: 3, name: "secs_since_last_action", kind: "message", T: () => UInt64Value },
            { no: 4, name: "cluster_name", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "validate.rules": { string: { minLen: "1" } } } },
            { no: 5, name: "upstream_url", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "validate.rules": { string: { minLen: "1" } } } },
            { no: 6, name: "action", kind: "enum", T: () => ["envoy.data.cluster.v3.Action", Action], options: { "validate.rules": { enum: { definedOnly: true } } } },
        ...
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.data.cluster.v2alpha.OutlierDetectionEvent" } });
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: OutlierDetectionEvent): OutlierDetectionEvent {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* envoy.data.cluster.v3.OutlierEjectionType type */ 1:
                ...
                case /* string upstream_url */ 5:
                    ...
                    break;
                case /* envoy.data.cluster.v3.Action action */ 6:
                ...
                case /* bool enforced */ 8:
                    ...
                    break;
                case /* envoy.data.cluster.v3.OutlierEjectSuccessRate eject_success_rate_event */ 9:
                    message.event = {
                        oneofKind: "ejectSuccessRateEvent",
                    ...
                    break;
                case /* envoy.data.cluster.v3.OutlierEjectConsecutive eject_consecutive_event */ 10:
                    message.event = {
                        oneofKind: "ejectConsecutiveEvent",
                    ...
                    break;
                case /* envoy.data.cluster.v3.OutlierEjectFailurePercentage eject_failure_percentage_event */ 11:
                    message.event = {
                        oneofKind: "ejectFailurePercentageEvent",
...
/**
 * @generated MessageType for protobuf message envoy.data.cluster.v3.OutlierDetectionEvent
 */
...
class OutlierEjectSuccessRate$Type extends MessageType<OutlierEjectSuccessRate> {
    constructor() {
        super("envoy.data.cluster.v3.OutlierEjectSuccessRate", [
        ...
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.data.cluster.v2alpha.OutlierEjectSuccessRate" } });
    }
...
/**
 * @generated MessageType for protobuf message envoy.data.cluster.v3.OutlierEjectSuccessRate
 */
...
class OutlierEjectConsecutive$Type extends MessageType<OutlierEjectConsecutive> {
    constructor() {
        super("envoy.data.cluster.v3.OutlierEjectConsecutive", [], { "udpa.annotations.versioning": { previousMessageType: "envoy.data.cluster.v2alpha.OutlierEjectConsecutive" } });
    }
...
/**
 * @generated MessageType for protobuf message envoy.data.cluster.v3.OutlierEjectConsecutive
 */
...
class OutlierEjectFailurePercentage$Type extends MessageType<OutlierEjectFailurePercentage> {
    constructor() {
        super("envoy.data.cluster.v3.OutlierEjectFailurePercentage", [
            { no: 1, name: "host_success_rate", kind: "scalar", T: 13 /*ScalarType.UINT32*/, options: { "validate.rules": { uint32: { lte: 100 } } } }
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.data.cluster.v2alpha.OutlierEjectFailurePercentage" } });
    }
...
/**
 * @generated MessageType for protobuf message envoy.data.cluster.v3.OutlierEjectFailurePercentage
 */
