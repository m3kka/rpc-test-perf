...
// @generated from protobuf file "envoy/data/tap/v3/wrapper.proto" (package "envoy.data.tap.v3", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message envoy.data.tap.v3.TraceWrapper
 */
export interface TraceWrapper {
    ...
    trace: {
         ...
         *
         * @generated from protobuf field: envoy.data.tap.v3.HttpBufferedTrace http_buffered_trace = 1;
         */
         ...
         *
         * @generated from protobuf field: envoy.data.tap.v3.HttpStreamedTraceSegment http_streamed_trace_segment = 2;
         */
         ...
         *
         * @generated from protobuf field: envoy.data.tap.v3.SocketBufferedTrace socket_buffered_trace = 3;
         */
         ...
         *
         * @generated from protobuf field: envoy.data.tap.v3.SocketStreamedTraceSegment socket_streamed_trace_segment = 4;
         */
...
class TraceWrapper$Type extends MessageType<TraceWrapper> {
    constructor() {
        super("envoy.data.tap.v3.TraceWrapper", [
        ...
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.data.tap.v2alpha.TraceWrapper" } });
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: TraceWrapper): TraceWrapper {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* envoy.data.tap.v3.HttpBufferedTrace http_buffered_trace */ 1:
                    message.trace = {
                        oneofKind: "httpBufferedTrace",
                    ...
                    break;
                case /* envoy.data.tap.v3.HttpStreamedTraceSegment http_streamed_trace_segment */ 2:
                    message.trace = {
                        oneofKind: "httpStreamedTraceSegment",
                    ...
                    break;
                case /* envoy.data.tap.v3.SocketBufferedTrace socket_buffered_trace */ 3:
                    message.trace = {
                        oneofKind: "socketBufferedTrace",
                    ...
                    break;
                case /* envoy.data.tap.v3.SocketStreamedTraceSegment socket_streamed_trace_segment */ 4:
                    message.trace = {
                        oneofKind: "socketStreamedTraceSegment",
...
/**
 * @generated MessageType for protobuf message envoy.data.tap.v3.TraceWrapper
 */
