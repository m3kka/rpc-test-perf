...
// @generated from protobuf file "envoy/data/tap/v3/transport.proto" (package "envoy.data.tap.v3", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message envoy.data.tap.v3.Connection
 */
export interface Connection {
     ...
     * Remote address.
     *
     * @generated from protobuf field: envoy.config.core.v3.Address remote_address = 3;
     */
 ...
 *
 * @generated from protobuf message envoy.data.tap.v3.SocketEvent
 */
export interface SocketEvent {
    ...
    eventSelector: {
        oneofKind: "read";
        /**
         * @generated from protobuf field: envoy.data.tap.v3.SocketEvent.Read read = 2;
         */
        read: SocketEvent_Read;
    } | {
        oneofKind: "write";
        /**
         * @generated from protobuf field: envoy.data.tap.v3.SocketEvent.Write write = 3;
         */
        write: SocketEvent_Write;
    } | {
        oneofKind: "closed";
        /**
         * @generated from protobuf field: envoy.data.tap.v3.SocketEvent.Closed closed = 4;
         */
 ...
 *
 * @generated from protobuf message envoy.data.tap.v3.SocketEvent.Read
 */
export interface SocketEvent_Read {
    /**
     * Binary data read.
     *
     * @generated from protobuf field: envoy.data.tap.v3.Body data = 1;
     */
    data?: Body;
}
/**
 ...
 *
 * @generated from protobuf message envoy.data.tap.v3.SocketEvent.Write
 */
 ...
 *
 * @generated from protobuf message envoy.data.tap.v3.SocketEvent.Closed
 */
 ...
 * [#next-free-field: 6]
 *
 * @generated from protobuf message envoy.data.tap.v3.SocketBufferedTrace
 */
export interface SocketBufferedTrace {
     ...
     * Connection properties.
     *
     * @generated from protobuf field: envoy.data.tap.v3.Connection connection = 2;
     */
    connection?: Connection;
    /**
     * Sequence of observed events.
     *
     * @generated from protobuf field: repeated envoy.data.tap.v3.SocketEvent events = 3;
     */
    events: SocketEvent[];
    /**
 ...
 *
 * @generated from protobuf message envoy.data.tap.v3.SocketStreamedTraceSegment
 */
export interface SocketStreamedTraceSegment {
    ...
    messagePiece: {
         ...
         * Socket event.
         *
         * @generated from protobuf field: envoy.data.tap.v3.SocketEvent event = 3;
         */
        event: SocketEvent;
    } | {
        oneofKind: undefined;
...
class Connection$Type extends MessageType<Connection> {
    constructor() {
        super("envoy.data.tap.v3.Connection", [
            { no: 2, name: "local_address", kind: "message", T: () => Address },
            { no: 3, name: "remote_address", kind: "message", T: () => Address }
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.data.tap.v2alpha.Connection" } });
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* envoy.config.core.v3.Address local_address */ 2:
                    ...
                    break;
                case /* envoy.config.core.v3.Address remote_address */ 3:
...
/**
 * @generated MessageType for protobuf message envoy.data.tap.v3.Connection
 */
export const Connection = new Connection$Type();
// @generated message type with reflection information, may provide speed optimized methods
class SocketEvent$Type extends MessageType<SocketEvent> {
    constructor() {
        super("envoy.data.tap.v3.SocketEvent", [
        ...
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.data.tap.v2alpha.SocketEvent" } });
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* google.protobuf.Timestamp timestamp */ 1:
                    ...
                    break;
                case /* envoy.data.tap.v3.SocketEvent.Read read */ 2:
...
/**
 * @generated MessageType for protobuf message envoy.data.tap.v3.SocketEvent
 */
export const SocketEvent = new SocketEvent$Type();
// @generated message type with reflection information, may provide speed optimized methods
class SocketEvent_Read$Type extends MessageType<SocketEvent_Read> {
    constructor() {
        super("envoy.data.tap.v3.SocketEvent.Read", [
            { no: 1, name: "data", kind: "message", T: () => Body }
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.data.tap.v2alpha.SocketEvent.Read" } });
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SocketEvent_Read): SocketEvent_Read {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* envoy.data.tap.v3.Body data */ 1:
...
/**
 * @generated MessageType for protobuf message envoy.data.tap.v3.SocketEvent.Read
 */
...
class SocketEvent_Write$Type extends MessageType<SocketEvent_Write> {
    constructor() {
        super("envoy.data.tap.v3.SocketEvent.Write", [
            { no: 1, name: "data", kind: "message", T: () => Body },
            { no: 2, name: "end_stream", kind: "scalar", T: 8 /*ScalarType.BOOL*/ }
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.data.tap.v2alpha.SocketEvent.Write" } });
    }
...
/**
 * @generated MessageType for protobuf message envoy.data.tap.v3.SocketEvent.Write
 */
...
class SocketEvent_Closed$Type extends MessageType<SocketEvent_Closed> {
    constructor() {
        super("envoy.data.tap.v3.SocketEvent.Closed", [], { "udpa.annotations.versioning": { previousMessageType: "envoy.data.tap.v2alpha.SocketEvent.Closed" } });
    }
...
/**
 * @generated MessageType for protobuf message envoy.data.tap.v3.SocketEvent.Closed
 */
...
class SocketBufferedTrace$Type extends MessageType<SocketBufferedTrace> {
    constructor() {
        super("envoy.data.tap.v3.SocketBufferedTrace", [
        ...
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.data.tap.v2alpha.SocketBufferedTrace" } });
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint64 trace_id */ 1:
                    ...
                    break;
                case /* envoy.data.tap.v3.Connection connection */ 2:
                    message.connection = Connection.internalBinaryRead(reader, reader.uint32(), options, message.connection);
                    break;
                case /* repeated envoy.data.tap.v3.SocketEvent events */ 3:
...
/**
 * @generated MessageType for protobuf message envoy.data.tap.v3.SocketBufferedTrace
 */
...
class SocketStreamedTraceSegment$Type extends MessageType<SocketStreamedTraceSegment> {
    constructor() {
        super("envoy.data.tap.v3.SocketStreamedTraceSegment", [
            { no: 1, name: "trace_id", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
        ...
        ], { "udpa.annotations.versioning": { previousMessageType: "envoy.data.tap.v2alpha.SocketStreamedTraceSegment" } });
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* envoy.data.tap.v3.Connection connection */ 2:
                    ...
                    break;
                case /* envoy.data.tap.v3.SocketEvent event */ 3:
                    message.messagePiece = {
                        oneofKind: "event",
...
/**
 * @generated MessageType for protobuf message envoy.data.tap.v3.SocketStreamedTraceSegment
 */
