...
import type { HeaderMap, HeaderValue } from "../../../api/v2/core/base_pb.js";
...
export declare class HttpBufferedTrace extends Message<HttpBufferedTrace> {
  ...
  static readonly typeName = "envoy.data.tap.v2alpha.HttpBufferedTrace";
...
export declare class HttpBufferedTrace_Message extends Message<HttpBufferedTrace_Message> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "envoy.data.tap.v2alpha.HttpBufferedTrace.Message";
  static readonly fields: FieldList;
...
export declare class HttpStreamedTraceSegment extends Message<HttpStreamedTraceSegment> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "envoy.data.tap.v2alpha.HttpStreamedTraceSegment";
  static readonly fields: FieldList;
