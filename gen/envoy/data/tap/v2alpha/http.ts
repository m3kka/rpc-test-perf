...
// @generated from protobuf file "envoy/data/tap/v2alpha/http.proto" (package "envoy.data.tap.v2alpha", syntax proto3)
// tslint:disable
...
import { HeaderMap } from "../../../api/v2/core/base";
 ...
 *
 * @generated from protobuf message envoy.data.tap.v2alpha.HttpBufferedTrace
 */
export interface HttpBufferedTrace {
    /**
     * Request message.
     *
     * @generated from protobuf field: envoy.data.tap.v2alpha.HttpBufferedTrace.Message request = 1;
     */
    request?: HttpBufferedTrace_Message;
    /**
     * Response message.
     *
     * @generated from protobuf field: envoy.data.tap.v2alpha.HttpBufferedTrace.Message response = 2;
     */
 ...
 *
 * @generated from protobuf message envoy.data.tap.v2alpha.HttpBufferedTrace.Message
 */
export interface HttpBufferedTrace_Message {
     ...
     * Message body.
     *
     * @generated from protobuf field: envoy.data.tap.v2alpha.Body body = 2;
     */
    body?: Body;
    /**
     * Message trailers.
     *
     * @generated from protobuf field: repeated envoy.api.v2.core.HeaderValue trailers = 3;
     */
 ...
 * [#next-free-field: 8]
 *
 * @generated from protobuf message envoy.data.tap.v2alpha.HttpStreamedTraceSegment
 */
export interface HttpStreamedTraceSegment {
    ...
    messagePiece: {
         ...
         * Request headers.
         *
         * @generated from protobuf field: envoy.api.v2.core.HeaderMap request_headers = 2;
         */
         ...
         * Request body chunk.
         *
         * @generated from protobuf field: envoy.data.tap.v2alpha.Body request_body_chunk = 3;
         */
         ...
         * Request trailers.
         *
         * @generated from protobuf field: envoy.api.v2.core.HeaderMap request_trailers = 4;
         */
         ...
         * Response headers.
         *
         * @generated from protobuf field: envoy.api.v2.core.HeaderMap response_headers = 5;
         */
         ...
         * Response body chunk.
         *
         * @generated from protobuf field: envoy.data.tap.v2alpha.Body response_body_chunk = 6;
         */
         ...
         * Response trailers.
         *
         * @generated from protobuf field: envoy.api.v2.core.HeaderMap response_trailers = 7;
         */
...
class HttpBufferedTrace$Type extends MessageType<HttpBufferedTrace> {
    constructor() {
        super("envoy.data.tap.v2alpha.HttpBufferedTrace", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: HttpBufferedTrace): HttpBufferedTrace {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* envoy.data.tap.v2alpha.HttpBufferedTrace.Message request */ 1:
                    message.request = HttpBufferedTrace_Message.internalBinaryRead(reader, reader.uint32(), options, message.request);
                    break;
                case /* envoy.data.tap.v2alpha.HttpBufferedTrace.Message response */ 2:
...
/**
 * @generated MessageType for protobuf message envoy.data.tap.v2alpha.HttpBufferedTrace
 */
...
class HttpBufferedTrace_Message$Type extends MessageType<HttpBufferedTrace_Message> {
    constructor() {
        super("envoy.data.tap.v2alpha.HttpBufferedTrace.Message", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated envoy.api.v2.core.HeaderValue headers */ 1:
                    ...
                    break;
                case /* envoy.data.tap.v2alpha.Body body */ 2:
                    message.body = Body.internalBinaryRead(reader, reader.uint32(), options, message.body);
                    break;
                case /* repeated envoy.api.v2.core.HeaderValue trailers */ 3:
...
/**
 * @generated MessageType for protobuf message envoy.data.tap.v2alpha.HttpBufferedTrace.Message
 */
...
class HttpStreamedTraceSegment$Type extends MessageType<HttpStreamedTraceSegment> {
    constructor() {
        super("envoy.data.tap.v2alpha.HttpStreamedTraceSegment", [
...
/**
 * @generated MessageType for protobuf message envoy.data.tap.v2alpha.HttpStreamedTraceSegment
 */
