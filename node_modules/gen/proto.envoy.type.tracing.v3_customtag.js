...
goog.provide('proto.envoy.type.tracing.v3.CustomTag');
goog.provide('proto.envoy.type.tracing.v3.CustomTag.Environment');
goog.provide('proto.envoy.type.tracing.v3.CustomTag.Header');
goog.provide('proto.envoy.type.tracing.v3.CustomTag.Literal');
goog.provide('proto.envoy.type.tracing.v3.CustomTag.Metadata');
goog.provide('proto.envoy.type.tracing.v3.CustomTag.TypeCase');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.envoy.type.metadata.v3.MetadataKey');
goog.require('proto.envoy.type.metadata.v3.MetadataKind');
...
proto.envoy.type.tracing.v3.CustomTag.Metadata.toObject = function(includeInstance, msg) {
  var f, obj = {
    kind: (f = msg.getKind()) && proto.envoy.type.metadata.v3.MetadataKind.toObject(includeInstance, f),
    metadataKey: (f = msg.getMetadataKey()) && proto.envoy.type.metadata.v3.MetadataKey.toObject(includeInstance, f),
...
proto.envoy.type.tracing.v3.CustomTag.Metadata.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.envoy.type.metadata.v3.MetadataKind;
      reader.readMessage(value,proto.envoy.type.metadata.v3.MetadataKind.deserializeBinaryFromReader);
      msg.setKind(value);
      break;
    case 2:
      var value = new proto.envoy.type.metadata.v3.MetadataKey;
      reader.readMessage(value,proto.envoy.type.metadata.v3.MetadataKey.deserializeBinaryFromReader);
...
proto.envoy.type.tracing.v3.CustomTag.Metadata.prototype.getKind = function() {
  return /** @type{?proto.envoy.type.metadata.v3.MetadataKind} */ (
    jspb.Message.getWrapperField(this, proto.envoy.type.metadata.v3.MetadataKind, 1));
};
...
proto.envoy.type.tracing.v3.CustomTag.Metadata.prototype.getMetadataKey = function() {
  return /** @type{?proto.envoy.type.metadata.v3.MetadataKey} */ (
    jspb.Message.getWrapperField(this, proto.envoy.type.metadata.v3.MetadataKey, 2));
};
