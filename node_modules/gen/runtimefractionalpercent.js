...
goog.provide('proto.envoy.api.v2.core.RuntimeFractionalPercent');
...
proto.envoy.api.v2.core.RuntimeFractionalPercent.toObject = function(includeInstance, msg) {
  var f, obj = {
    defaultValue: (f = msg.getDefaultValue()) && proto.envoy.type.FractionalPercent.toObject(includeInstance, f),
...
proto.envoy.api.v2.core.RuntimeFractionalPercent.prototype.getDefaultValue = function() {
  return /** @type{?proto.envoy.type.FractionalPercent} */ (
    jspb.Message.getWrapperField(this, proto.envoy.type.FractionalPercent, 1));
};
