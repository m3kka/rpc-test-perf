...
goog.provide('proto.envoy.service.tap.v2alpha.OutputConfig');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.envoy.service.tap.v2alpha.OutputSink');
...
proto.envoy.service.tap.v2alpha.OutputConfig.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    maxBufferedRxBytes: (f = msg.getMaxBufferedRxBytes()) && proto.google.protobuf.UInt32Value.toObject(includeInstance, f),
    maxBufferedTxBytes: (f = msg.getMaxBufferedTxBytes()) && proto.google.protobuf.UInt32Value.toObject(includeInstance, f),
    streaming: jspb.Message.getBooleanFieldWithDefault(msg, 4, false)
  };
 ...
 * @return {!proto.envoy.service.tap.v2alpha.OutputConfig} returns this
*/
...
proto.envoy.service.tap.v2alpha.OutputConfig.prototype.clearMaxBufferedRxBytes = function() {
  return this.setMaxBufferedRxBytes(undefined);
};
...
proto.envoy.service.tap.v2alpha.OutputConfig.prototype.clearMaxBufferedTxBytes = function() {
  return this.setMaxBufferedTxBytes(undefined);
};
