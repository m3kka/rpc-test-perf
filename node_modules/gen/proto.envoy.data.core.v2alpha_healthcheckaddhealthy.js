...
goog.provide('proto.envoy.data.core.v2alpha.HealthCheckAddHealthy');
...
proto.envoy.data.core.v2alpha.HealthCheckAddHealthy.toObject = function(includeInstance, msg) {
  var f, obj = {
    firstCheck: jspb.Message.getBooleanFieldWithDefault(msg, 1, false)
  };
...
/**
 * @param {boolean} value
 * @return {!proto.envoy.data.core.v2alpha.HealthCheckAddHealthy} returns this
 */
