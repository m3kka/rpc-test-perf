...
goog.provide('proto.envoy.config.filter.network.redis_proxy.v2.RedisProtocolOptions');
...
proto.envoy.config.filter.network.redis_proxy.v2.RedisProtocolOptions.toObject = function(includeInstance, msg) {
  var f, obj = {
    authPassword: (f = msg.getAuthPassword()) && proto.envoy.api.v2.core.DataSource.toObject(includeInstance, f)
  };
 ...
 * @return {!proto.envoy.config.filter.network.redis_proxy.v2.RedisProtocolOptions} returns this
*/
...
proto.envoy.config.filter.network.redis_proxy.v2.RedisProtocolOptions.prototype.clearAuthPassword = function() {
  return this.setAuthPassword(undefined);
};
