...
goog.provide('proto.envoy.service.metrics.v2.StreamMetricsMessage');
goog.provide('proto.envoy.service.metrics.v2.StreamMetricsMessage.Identifier');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.envoy.api.v2.core.Node');
goog.require('proto.io.prometheus.client.MetricFamily');
...
proto.envoy.service.metrics.v2.StreamMetricsMessage.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.io.prometheus.client.MetricFamily.toObject, includeInstance)
  };
...
proto.envoy.service.metrics.v2.StreamMetricsMessage.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.io.prometheus.client.MetricFamily;
      reader.readMessage(value,proto.io.prometheus.client.MetricFamily.deserializeBinaryFromReader);
...
proto.envoy.service.metrics.v2.StreamMetricsMessage.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      proto.io.prometheus.client.MetricFamily.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!proto.envoy.service.metrics.v2.StreamMetricsMessage.Identifier} returns this
*/
 ...
 * @return {!proto.envoy.service.metrics.v2.StreamMetricsMessage} returns this
*/
...
proto.envoy.service.metrics.v2.StreamMetricsMessage.prototype.getEnvoyMetricsList = function() {
  return /** @type{!Array<!proto.io.prometheus.client.MetricFamily>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.io.prometheus.client.MetricFamily, 2));
};
...
proto.envoy.service.metrics.v2.StreamMetricsMessage.prototype.clearEnvoyMetricsList = function() {
  return this.setEnvoyMetricsList([]);
};
