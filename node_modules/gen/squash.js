...
goog.provide('proto.envoy.config.filter.http.squash.v2.Squash');
...
proto.envoy.config.filter.http.squash.v2.Squash.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    attachmentTemplate: (f = msg.getAttachmentTemplate()) && proto.google.protobuf.Struct.toObject(includeInstance, f),
    requestTimeout: (f = msg.getRequestTimeout()) && proto.google.protobuf.Duration.toObject(includeInstance, f),
    attachmentTimeout: (f = msg.getAttachmentTimeout()) && proto.google.protobuf.Duration.toObject(includeInstance, f),
    attachmentPollPeriod: (f = msg.getAttachmentPollPeriod()) && proto.google.protobuf.Duration.toObject(includeInstance, f)
  };
...
/**
 * @param {string} value
 * @return {!proto.envoy.config.filter.http.squash.v2.Squash} returns this
 */
...
proto.envoy.config.filter.http.squash.v2.Squash.prototype.clearAttachmentTemplate = function() {
  return this.setAttachmentTemplate(undefined);
};
...
proto.envoy.config.filter.http.squash.v2.Squash.prototype.clearAttachmentTimeout = function() {
  return this.setAttachmentTimeout(undefined);
};
...
proto.envoy.config.filter.http.squash.v2.Squash.prototype.clearAttachmentPollPeriod = function() {
  return this.setAttachmentPollPeriod(undefined);
};
