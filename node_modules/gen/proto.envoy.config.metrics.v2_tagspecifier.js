...
goog.provide('proto.envoy.config.metrics.v2.TagSpecifier');
goog.provide('proto.envoy.config.metrics.v2.TagSpecifier.TagValueCase');
...
/**
 * @param {string} value
 * @return {!proto.envoy.config.metrics.v2.TagSpecifier} returns this
 */
...
proto.envoy.config.metrics.v2.TagSpecifier.prototype.setRegex = function(value) {
  return jspb.Message.setOneofField(this, 2, proto.envoy.config.metrics.v2.TagSpecifier.oneofGroups_[0], value);
};
...
proto.envoy.config.metrics.v2.TagSpecifier.prototype.clearRegex = function() {
  return jspb.Message.setOneofField(this, 2, proto.envoy.config.metrics.v2.TagSpecifier.oneofGroups_[0], undefined);
};
...
proto.envoy.config.metrics.v2.TagSpecifier.prototype.setFixedValue = function(value) {
  return jspb.Message.setOneofField(this, 3, proto.envoy.config.metrics.v2.TagSpecifier.oneofGroups_[0], value);
};
...
proto.envoy.config.metrics.v2.TagSpecifier.prototype.clearFixedValue = function() {
  return jspb.Message.setOneofField(this, 3, proto.envoy.config.metrics.v2.TagSpecifier.oneofGroups_[0], undefined);
};
