...
goog.provide('proto.envoy.config.filter.network.dubbo_proxy.v2alpha1.RouteConfiguration');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.envoy.config.filter.network.dubbo_proxy.v2alpha1.Route');
...
/**
 * @param {string} value
 * @return {!proto.envoy.config.filter.network.dubbo_proxy.v2alpha1.RouteConfiguration} returns this
 */
