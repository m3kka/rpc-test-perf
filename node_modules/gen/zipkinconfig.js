...
goog.provide('proto.envoy.config.trace.v3.ZipkinConfig');
goog.provide('proto.envoy.config.trace.v3.ZipkinConfig.CollectorEndpointVersion');
...
proto.envoy.config.trace.v3.ZipkinConfig.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    sharedSpanContext: (f = msg.getSharedSpanContext()) && proto.google.protobuf.BoolValue.toObject(includeInstance, f),
    collectorEndpointVersion: jspb.Message.getFieldWithDefault(msg, 5, 0),
    collectorHostname: jspb.Message.getFieldWithDefault(msg, 6, ""),
    splitSpansForRequest: jspb.Message.getBooleanFieldWithDefault(msg, 7, false)
  };
...
proto.envoy.config.trace.v3.ZipkinConfig.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 6:
      var value = /** @type {string} */ (reader.readString());
      msg.setCollectorHostname(value);
      break;
    case 7:
      var value = /** @type {boolean} */ (reader.readBool());
      msg.setSplitSpansForRequest(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.envoy.config.trace.v3.ZipkinConfig.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getCollectorHostname();
  if (f.length > 0) {
    writer.writeString(
      6,
      f
  ...
  f = message.getSplitSpansForRequest();
  if (f) {
    writer.writeBool(
      7,
      f
 ...
 * @return {string}
 */
proto.envoy.config.trace.v3.ZipkinConfig.prototype.getCollectorCluster = function() {
...
/**
 * @param {string} value
 * @return {!proto.envoy.config.trace.v3.ZipkinConfig} returns this
 */
proto.envoy.config.trace.v3.ZipkinConfig.prototype.setCollectorCluster = function(value) {
...
/**
 * optional string collector_hostname = 6;
 * @return {string}
 */
proto.envoy.config.trace.v3.ZipkinConfig.prototype.getCollectorHostname = function() {
 ...
 * @return {!proto.envoy.config.trace.v3.ZipkinConfig} returns this
 */
proto.envoy.config.trace.v3.ZipkinConfig.prototype.setCollectorHostname = function(value) {
  return jspb.Message.setProto3StringField(this, 6, value);
};


/**
 * optional bool split_spans_for_request = 7;
 * @return {boolean}
 */
proto.envoy.config.trace.v3.ZipkinConfig.prototype.getSplitSpansForRequest = function() {
 ...
 * @return {!proto.envoy.config.trace.v3.ZipkinConfig} returns this
 */
proto.envoy.config.trace.v3.ZipkinConfig.prototype.setSplitSpansForRequest = function(value) {
