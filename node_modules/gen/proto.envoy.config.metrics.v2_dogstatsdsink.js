...
goog.provide('proto.envoy.config.metrics.v2.DogStatsdSink');
goog.provide('proto.envoy.config.metrics.v2.DogStatsdSink.DogStatsdSpecifierCase');
 ...
 * @return {!proto.envoy.config.metrics.v2.DogStatsdSink} returns this
*/
proto.envoy.config.metrics.v2.DogStatsdSink.prototype.setAddress = function(value) {
  return jspb.Message.setOneofWrapperField(this, 1, proto.envoy.config.metrics.v2.DogStatsdSink.oneofGroups_[0], value);
};
