...
goog.provide('proto.envoy.config.filter.network.http_connection_manager.v2.Rds');
...
proto.envoy.config.filter.network.http_connection_manager.v2.Rds.toObject = function(includeInstance, msg) {
  var f, obj = {
    configSource: (f = msg.getConfigSource()) && proto.envoy.api.v2.core.ConfigSource.toObject(includeInstance, f),
