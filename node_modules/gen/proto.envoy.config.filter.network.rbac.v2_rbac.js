...
goog.provide('proto.envoy.config.filter.network.rbac.v2.RBAC');
goog.provide('proto.envoy.config.filter.network.rbac.v2.RBAC.EnforcementType');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.envoy.config.rbac.v2.RBAC');
...
proto.envoy.config.filter.network.rbac.v2.RBAC.toObject = function(includeInstance, msg) {
  var f, obj = {
    rules: (f = msg.getRules()) && proto.envoy.config.rbac.v2.RBAC.toObject(includeInstance, f),
    shadowRules: (f = msg.getShadowRules()) && proto.envoy.config.rbac.v2.RBAC.toObject(includeInstance, f),
...
proto.envoy.config.filter.network.rbac.v2.RBAC.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.envoy.config.rbac.v2.RBAC;
      reader.readMessage(value,proto.envoy.config.rbac.v2.RBAC.deserializeBinaryFromReader);
      msg.setRules(value);
      break;
    case 2:
      var value = new proto.envoy.config.rbac.v2.RBAC;
...
proto.envoy.config.filter.network.rbac.v2.RBAC.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.envoy.config.rbac.v2.RBAC.serializeBinaryToWriter
    );
  }
...
/**
 * optional envoy.config.rbac.v2.RBAC rules = 1;
 * @return {?proto.envoy.config.rbac.v2.RBAC}
 */
proto.envoy.config.filter.network.rbac.v2.RBAC.prototype.getRules = function() {
  return /** @type{?proto.envoy.config.rbac.v2.RBAC} */ (
    jspb.Message.getWrapperField(this, proto.envoy.config.rbac.v2.RBAC, 1));
};


/**
 * @param {?proto.envoy.config.rbac.v2.RBAC|undefined} value
 * @return {!proto.envoy.config.filter.network.rbac.v2.RBAC} returns this
*/
...
/**
 * optional envoy.config.rbac.v2.RBAC shadow_rules = 2;
 * @return {?proto.envoy.config.rbac.v2.RBAC}
 */
proto.envoy.config.filter.network.rbac.v2.RBAC.prototype.getShadowRules = function() {
  return /** @type{?proto.envoy.config.rbac.v2.RBAC} */ (
    jspb.Message.getWrapperField(this, proto.envoy.config.rbac.v2.RBAC, 2));
};
