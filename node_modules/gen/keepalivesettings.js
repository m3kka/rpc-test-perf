...
goog.provide('proto.envoy.config.core.v3.KeepaliveSettings');
...
proto.envoy.config.core.v3.KeepaliveSettings.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    intervalJitter: (f = msg.getIntervalJitter()) && proto.envoy.type.v3.Percent.toObject(includeInstance, f),
    connectionIdleInterval: (f = msg.getConnectionIdleInterval()) && proto.google.protobuf.Duration.toObject(includeInstance, f)
  };
...
proto.envoy.config.core.v3.KeepaliveSettings.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      var value = new proto.google.protobuf.Duration;
      reader.readMessage(value,proto.google.protobuf.Duration.deserializeBinaryFromReader);
      msg.setConnectionIdleInterval(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.envoy.config.core.v3.KeepaliveSettings.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getConnectionIdleInterval();
  if (f != null) {
    writer.writeMessage(
      4,
      f,
...
/**
 * optional google.protobuf.Duration connection_idle_interval = 4;
 * @return {?proto.google.protobuf.Duration}
 */
proto.envoy.config.core.v3.KeepaliveSettings.prototype.getConnectionIdleInterval = function() {
  return /** @type{?proto.google.protobuf.Duration} */ (
 ...
 * @return {!proto.envoy.config.core.v3.KeepaliveSettings} returns this
*/
proto.envoy.config.core.v3.KeepaliveSettings.prototype.setConnectionIdleInterval = function(value) {
 ...
 * @return {!proto.envoy.config.core.v3.KeepaliveSettings} returns this
 */
proto.envoy.config.core.v3.KeepaliveSettings.prototype.clearConnectionIdleInterval = function() {
  return this.setConnectionIdleInterval(undefined);
};
 ...
 * @return {boolean}
 */
proto.envoy.config.core.v3.KeepaliveSettings.prototype.hasConnectionIdleInterval = function() {
