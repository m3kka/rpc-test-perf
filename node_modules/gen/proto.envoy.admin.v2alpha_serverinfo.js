...
goog.provide('proto.envoy.admin.v2alpha.ServerInfo');
goog.provide('proto.envoy.admin.v2alpha.ServerInfo.State');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.envoy.admin.v2alpha.CommandLineOptions');
...
proto.envoy.admin.v2alpha.ServerInfo.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    uptimeCurrentEpoch: (f = msg.getUptimeCurrentEpoch()) && proto.google.protobuf.Duration.toObject(includeInstance, f),
    uptimeAllEpochs: (f = msg.getUptimeAllEpochs()) && proto.google.protobuf.Duration.toObject(includeInstance, f),
    hotRestartVersion: jspb.Message.getFieldWithDefault(msg, 5, ""),
...
/**
 * @param {string} value
 * @return {!proto.envoy.admin.v2alpha.ServerInfo} returns this
 */
...
proto.envoy.admin.v2alpha.ServerInfo.prototype.clearUptimeCurrentEpoch = function() {
  return this.setUptimeCurrentEpoch(undefined);
};
...
proto.envoy.admin.v2alpha.ServerInfo.prototype.clearUptimeAllEpochs = function() {
  return this.setUptimeAllEpochs(undefined);
};
...
/**
 * optional string hot_restart_version = 5;
 * @return {string}
 */
proto.envoy.admin.v2alpha.ServerInfo.prototype.getHotRestartVersion = function() {
 ...
 * @return {!proto.envoy.admin.v2alpha.ServerInfo} returns this
 */
proto.envoy.admin.v2alpha.ServerInfo.prototype.setHotRestartVersion = function(value) {
...
proto.envoy.admin.v2alpha.ServerInfo.prototype.clearCommandLineOptions = function() {
  return this.setCommandLineOptions(undefined);
};
