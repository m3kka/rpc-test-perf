...
goog.provide('proto.envoy.config.overload.v2alpha.OverloadAction');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.envoy.config.overload.v2alpha.Trigger');
...
/**
 * @param {string} value
 * @return {!proto.envoy.config.overload.v2alpha.OverloadAction} returns this
 */
