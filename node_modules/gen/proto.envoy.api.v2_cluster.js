...
goog.provide('proto.envoy.api.v2.Cluster');
goog.provide('proto.envoy.api.v2.Cluster.ClusterDiscoveryTypeCase');
goog.provide('proto.envoy.api.v2.Cluster.ClusterProtocolSelection');
goog.provide('proto.envoy.api.v2.Cluster.CommonLbConfig');
goog.provide('proto.envoy.api.v2.Cluster.CommonLbConfig.ConsistentHashingLbConfig');
goog.provide('proto.envoy.api.v2.Cluster.CommonLbConfig.LocalityConfigSpecifierCase');
goog.provide('proto.envoy.api.v2.Cluster.CommonLbConfig.LocalityWeightedLbConfig');
goog.provide('proto.envoy.api.v2.Cluster.CommonLbConfig.ZoneAwareLbConfig');
goog.provide('proto.envoy.api.v2.Cluster.CustomClusterType');
goog.provide('proto.envoy.api.v2.Cluster.DiscoveryType');
goog.provide('proto.envoy.api.v2.Cluster.DnsLookupFamily');
goog.provide('proto.envoy.api.v2.Cluster.EdsClusterConfig');
goog.provide('proto.envoy.api.v2.Cluster.LbConfigCase');
goog.provide('proto.envoy.api.v2.Cluster.LbPolicy');
goog.provide('proto.envoy.api.v2.Cluster.LbSubsetConfig');
goog.provide('proto.envoy.api.v2.Cluster.LbSubsetConfig.LbSubsetFallbackPolicy');
goog.provide('proto.envoy.api.v2.Cluster.LbSubsetConfig.LbSubsetSelector');
goog.provide('proto.envoy.api.v2.Cluster.LbSubsetConfig.LbSubsetSelector.LbSubsetSelectorFallbackPolicy');
goog.provide('proto.envoy.api.v2.Cluster.LeastRequestLbConfig');
goog.provide('proto.envoy.api.v2.Cluster.OriginalDstLbConfig');
goog.provide('proto.envoy.api.v2.Cluster.RefreshRate');
goog.provide('proto.envoy.api.v2.Cluster.RingHashLbConfig');
goog.provide('proto.envoy.api.v2.Cluster.RingHashLbConfig.HashFunction');
goog.provide('proto.envoy.api.v2.Cluster.TransportSocketMatch');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Map');
goog.require('jspb.Message');
goog.require('proto.envoy.api.v2.ClusterLoadAssignment');
goog.require('proto.envoy.api.v2.LoadBalancingPolicy');
goog.require('proto.envoy.api.v2.UpstreamConnectionOptions');
goog.require('proto.envoy.api.v2.auth.UpstreamTlsContext');
goog.require('proto.envoy.api.v2.cluster.CircuitBreakers');
goog.require('proto.envoy.api.v2.cluster.Filter');
goog.require('proto.envoy.api.v2.cluster.OutlierDetection');
goog.require('proto.envoy.api.v2.core.Address');
goog.require('proto.envoy.api.v2.core.BindConfig');
goog.require('proto.envoy.api.v2.core.ConfigSource');
goog.require('proto.envoy.api.v2.core.HealthCheck');
goog.require('proto.envoy.api.v2.core.Http1ProtocolOptions');
goog.require('proto.envoy.api.v2.core.Http2ProtocolOptions');
goog.require('proto.envoy.api.v2.core.HttpProtocolOptions');
goog.require('proto.envoy.api.v2.core.Metadata');
goog.require('proto.envoy.api.v2.core.TransportSocket');
goog.require('proto.envoy.api.v2.core.UpstreamHttpProtocolOptions');
...
proto.envoy.api.v2.Cluster.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    connectTimeout: (f = msg.getConnectTimeout()) && proto.google.protobuf.Duration.toObject(includeInstance, f),
    ...
    proto.envoy.api.v2.core.Address.toObject, includeInstance),
    loadAssignment: (f = msg.getLoadAssignment()) && proto.envoy.api.v2.ClusterLoadAssignment.toObject(includeInstance, f),
    healthChecksList: jspb.Message.toObjectList(msg.getHealthChecksList(),
    proto.envoy.api.v2.core.HealthCheck.toObject, includeInstance),
    maxRequestsPerConnection: (f = msg.getMaxRequestsPerConnection()) && proto.google.protobuf.UInt32Value.toObject(includeInstance, f),
    circuitBreakers: (f = msg.getCircuitBreakers()) && proto.envoy.api.v2.cluster.CircuitBreakers.toObject(includeInstance, f),
    tlsContext: (f = msg.getTlsContext()) && proto.envoy.api.v2.auth.UpstreamTlsContext.toObject(includeInstance, f),
    upstreamHttpProtocolOptions: (f = msg.getUpstreamHttpProtocolOptions()) && proto.envoy.api.v2.core.UpstreamHttpProtocolOptions.toObject(includeInstance, f),
    commonHttpProtocolOptions: (f = msg.getCommonHttpProtocolOptions()) && proto.envoy.api.v2.core.HttpProtocolOptions.toObject(includeInstance, f),
    httpProtocolOptions: (f = msg.getHttpProtocolOptions()) && proto.envoy.api.v2.core.Http1ProtocolOptions.toObject(includeInstance, f),
    ...
    outlierDetection: (f = msg.getOutlierDetection()) && proto.envoy.api.v2.cluster.OutlierDetection.toObject(includeInstance, f),
    cleanupInterval: (f = msg.getCleanupInterval()) && proto.google.protobuf.Duration.toObject(includeInstance, f),
    upstreamBindConfig: (f = msg.getUpstreamBindConfig()) && proto.envoy.api.v2.core.BindConfig.toObject(includeInstance, f),
    ...
    transportSocket: (f = msg.getTransportSocket()) && proto.envoy.api.v2.core.TransportSocket.toObject(includeInstance, f),
    metadata: (f = msg.getMetadata()) && proto.envoy.api.v2.core.Metadata.toObject(includeInstance, f),
    ...
    proto.envoy.api.v2.cluster.Filter.toObject, includeInstance),
    loadBalancingPolicy: (f = msg.getLoadBalancingPolicy()) && proto.envoy.api.v2.LoadBalancingPolicy.toObject(includeInstance, f),
    lrsServer: (f = msg.getLrsServer()) && proto.envoy.api.v2.core.ConfigSource.toObject(includeInstance, f),
...
proto.envoy.api.v2.Cluster.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 6:
      ...
      break;
    case 7:
      var value = new proto.envoy.api.v2.core.Address;
      reader.readMessage(value,proto.envoy.api.v2.core.Address.deserializeBinaryFromReader);
      msg.addHosts(value);
      break;
    case 33:
      var value = new proto.envoy.api.v2.ClusterLoadAssignment;
      reader.readMessage(value,proto.envoy.api.v2.ClusterLoadAssignment.deserializeBinaryFromReader);
      msg.setLoadAssignment(value);
      break;
    case 8:
      var value = new proto.envoy.api.v2.core.HealthCheck;
      reader.readMessage(value,proto.envoy.api.v2.core.HealthCheck.deserializeBinaryFromReader);
    ...
    case 9:
      ...
      break;
    case 10:
      var value = new proto.envoy.api.v2.cluster.CircuitBreakers;
      reader.readMessage(value,proto.envoy.api.v2.cluster.CircuitBreakers.deserializeBinaryFromReader);
      msg.setCircuitBreakers(value);
      break;
    case 11:
      var value = new proto.envoy.api.v2.auth.UpstreamTlsContext;
      reader.readMessage(value,proto.envoy.api.v2.auth.UpstreamTlsContext.deserializeBinaryFromReader);
      msg.setTlsContext(value);
      break;
    case 46:
      var value = new proto.envoy.api.v2.core.UpstreamHttpProtocolOptions;
      reader.readMessage(value,proto.envoy.api.v2.core.UpstreamHttpProtocolOptions.deserializeBinaryFromReader);
      msg.setUpstreamHttpProtocolOptions(value);
      break;
    case 29:
      var value = new proto.envoy.api.v2.core.HttpProtocolOptions;
      reader.readMessage(value,proto.envoy.api.v2.core.HttpProtocolOptions.deserializeBinaryFromReader);
      msg.setCommonHttpProtocolOptions(value);
      break;
    case 13:
      var value = new proto.envoy.api.v2.core.Http1ProtocolOptions;
      reader.readMessage(value,proto.envoy.api.v2.core.Http1ProtocolOptions.deserializeBinaryFromReader);
    ...
    case 45:
      ...
      break;
    case 19:
      var value = new proto.envoy.api.v2.cluster.OutlierDetection;
      reader.readMessage(value,proto.envoy.api.v2.cluster.OutlierDetection.deserializeBinaryFromReader);
    ...
    case 20:
      ...
      break;
    case 21:
      var value = new proto.envoy.api.v2.core.BindConfig;
      reader.readMessage(value,proto.envoy.api.v2.core.BindConfig.deserializeBinaryFromReader);
    ...
    case 27:
      ...
      break;
    case 24:
      var value = new proto.envoy.api.v2.core.TransportSocket;
      reader.readMessage(value,proto.envoy.api.v2.core.TransportSocket.deserializeBinaryFromReader);
      msg.setTransportSocket(value);
      break;
    case 25:
      var value = new proto.envoy.api.v2.core.Metadata;
      reader.readMessage(value,proto.envoy.api.v2.core.Metadata.deserializeBinaryFromReader);
    ...
    case 32:
      ...
      break;
    case 40:
      var value = new proto.envoy.api.v2.cluster.Filter;
      reader.readMessage(value,proto.envoy.api.v2.cluster.Filter.deserializeBinaryFromReader);
...
proto.envoy.api.v2.Cluster.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      7,
      f,
      proto.envoy.api.v2.core.Address.serializeBinaryToWriter
    );
  }
  ...
  if (f != null) {
    writer.writeMessage(
      33,
      f,
      proto.envoy.api.v2.ClusterLoadAssignment.serializeBinaryToWriter
    );
  }
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      8,
      f,
      proto.envoy.api.v2.core.HealthCheck.serializeBinaryToWriter
    );
  }
  ...
  if (f != null) {
    writer.writeMessage(
      10,
      f,
      proto.envoy.api.v2.cluster.CircuitBreakers.serializeBinaryToWriter
    );
  }
  ...
  if (f != null) {
    writer.writeMessage(
      11,
      f,
      proto.envoy.api.v2.auth.UpstreamTlsContext.serializeBinaryToWriter
    );
  }
  ...
  if (f != null) {
    writer.writeMessage(
      46,
      f,
      proto.envoy.api.v2.core.UpstreamHttpProtocolOptions.serializeBinaryToWriter
    );
  }
  ...
  if (f != null) {
    writer.writeMessage(
      29,
      f,
      proto.envoy.api.v2.core.HttpProtocolOptions.serializeBinaryToWriter
    );
  }
  ...
  if (f != null) {
    writer.writeMessage(
      13,
      f,
      proto.envoy.api.v2.core.Http1ProtocolOptions.serializeBinaryToWriter
    );
  }
  ...
  if (f != null) {
    writer.writeMessage(
      19,
      f,
      proto.envoy.api.v2.cluster.OutlierDetection.serializeBinaryToWriter
    );
  }
  ...
  if (f != null) {
    writer.writeMessage(
      21,
      f,
      proto.envoy.api.v2.core.BindConfig.serializeBinaryToWriter
    );
  }
  ...
  if (f != null) {
    writer.writeMessage(
      24,
      f,
      proto.envoy.api.v2.core.TransportSocket.serializeBinaryToWriter
    );
  }
  ...
  if (f != null) {
    writer.writeMessage(
      25,
      f,
      proto.envoy.api.v2.core.Metadata.serializeBinaryToWriter
    );
  }
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      40,
      f,
      proto.envoy.api.v2.cluster.Filter.serializeBinaryToWriter
    );
  }
...
proto.envoy.api.v2.Cluster.TransportSocketMatch.toObject = function(includeInstance, msg) {
  var f, obj = {
    name: jspb.Message.getFieldWithDefault(msg, 1, ""),
    match: (f = msg.getMatch()) && proto.google.protobuf.Struct.toObject(includeInstance, f),
    transportSocket: (f = msg.getTransportSocket()) && proto.envoy.api.v2.core.TransportSocket.toObject(includeInstance, f)
  };
...
proto.envoy.api.v2.Cluster.TransportSocketMatch.prototype.getTransportSocket = function() {
  return /** @type{?proto.envoy.api.v2.core.TransportSocket} */ (
    jspb.Message.getWrapperField(this, proto.envoy.api.v2.core.TransportSocket, 3));
};
...
proto.envoy.api.v2.Cluster.CustomClusterType.toObject = function(includeInstance, msg) {
  var f, obj = {
    name: jspb.Message.getFieldWithDefault(msg, 1, ""),
    typedConfig: (f = msg.getTypedConfig()) && proto.google.protobuf.Any.toObject(includeInstance, f)
  };
...
proto.envoy.api.v2.Cluster.EdsClusterConfig.toObject = function(includeInstance, msg) {
  var f, obj = {
    edsConfig: (f = msg.getEdsConfig()) && proto.envoy.api.v2.core.ConfigSource.toObject(includeInstance, f),
...
proto.envoy.api.v2.Cluster.LbSubsetConfig.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    defaultSubset: (f = msg.getDefaultSubset()) && proto.google.protobuf.Struct.toObject(includeInstance, f),
...
proto.envoy.api.v2.Cluster.LeastRequestLbConfig.toObject = function(includeInstance, msg) {
  var f, obj = {
    choiceCount: (f = msg.getChoiceCount()) && proto.google.protobuf.UInt32Value.toObject(includeInstance, f)
  };
...
proto.envoy.api.v2.Cluster.RingHashLbConfig.toObject = function(includeInstance, msg) {
  var f, obj = {
    minimumRingSize: (f = msg.getMinimumRingSize()) && proto.google.protobuf.UInt64Value.toObject(includeInstance, f),
    hashFunction: jspb.Message.getFieldWithDefault(msg, 3, 0),
    maximumRingSize: (f = msg.getMaximumRingSize()) && proto.google.protobuf.UInt64Value.toObject(includeInstance, f)
  };
...
proto.envoy.api.v2.Cluster.RingHashLbConfig.prototype.getMinimumRingSize = function() {
  return /** @type{?proto.google.protobuf.UInt64Value} */ (
    jspb.Message.getWrapperField(this, proto.google.protobuf.UInt64Value, 1));
};
...
proto.envoy.api.v2.Cluster.RingHashLbConfig.prototype.getMaximumRingSize = function() {
  return /** @type{?proto.google.protobuf.UInt64Value} */ (
    jspb.Message.getWrapperField(this, proto.google.protobuf.UInt64Value, 4));
};
...
proto.envoy.api.v2.Cluster.CommonLbConfig.toObject = function(includeInstance, msg) {
  var f, obj = {
    healthyPanicThreshold: (f = msg.getHealthyPanicThreshold()) && proto.envoy.type.Percent.toObject(includeInstance, f),
    ...
    updateMergeWindow: (f = msg.getUpdateMergeWindow()) && proto.google.protobuf.Duration.toObject(includeInstance, f),
...
proto.envoy.api.v2.Cluster.CommonLbConfig.ZoneAwareLbConfig.toObject = function(includeInstance, msg) {
  var f, obj = {
    routingEnabled: (f = msg.getRoutingEnabled()) && proto.envoy.type.Percent.toObject(includeInstance, f),
    minClusterSize: (f = msg.getMinClusterSize()) && proto.google.protobuf.UInt64Value.toObject(includeInstance, f),
...
proto.envoy.api.v2.Cluster.RefreshRate.toObject = function(includeInstance, msg) {
  var f, obj = {
    baseInterval: (f = msg.getBaseInterval()) && proto.google.protobuf.Duration.toObject(includeInstance, f),
    maxInterval: (f = msg.getMaxInterval()) && proto.google.protobuf.Duration.toObject(includeInstance, f)
  };
...
proto.envoy.api.v2.Cluster.prototype.getHostsList = function() {
  return /** @type{!Array<!proto.envoy.api.v2.core.Address>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.envoy.api.v2.core.Address, 7));
};
...
proto.envoy.api.v2.Cluster.prototype.getLoadAssignment = function() {
  return /** @type{?proto.envoy.api.v2.ClusterLoadAssignment} */ (
    jspb.Message.getWrapperField(this, proto.envoy.api.v2.ClusterLoadAssignment, 33));
};
...
proto.envoy.api.v2.Cluster.prototype.getHealthChecksList = function() {
  return /** @type{!Array<!proto.envoy.api.v2.core.HealthCheck>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.envoy.api.v2.core.HealthCheck, 8));
};
...
proto.envoy.api.v2.Cluster.prototype.getCircuitBreakers = function() {
  return /** @type{?proto.envoy.api.v2.cluster.CircuitBreakers} */ (
    jspb.Message.getWrapperField(this, proto.envoy.api.v2.cluster.CircuitBreakers, 10));
};
...
proto.envoy.api.v2.Cluster.prototype.getTlsContext = function() {
  return /** @type{?proto.envoy.api.v2.auth.UpstreamTlsContext} */ (
    jspb.Message.getWrapperField(this, proto.envoy.api.v2.auth.UpstreamTlsContext, 11));
};
...
proto.envoy.api.v2.Cluster.prototype.getUpstreamHttpProtocolOptions = function() {
  return /** @type{?proto.envoy.api.v2.core.UpstreamHttpProtocolOptions} */ (
    jspb.Message.getWrapperField(this, proto.envoy.api.v2.core.UpstreamHttpProtocolOptions, 46));
};
...
proto.envoy.api.v2.Cluster.prototype.getCommonHttpProtocolOptions = function() {
  return /** @type{?proto.envoy.api.v2.core.HttpProtocolOptions} */ (
    jspb.Message.getWrapperField(this, proto.envoy.api.v2.core.HttpProtocolOptions, 29));
};
...
proto.envoy.api.v2.Cluster.prototype.getHttpProtocolOptions = function() {
  return /** @type{?proto.envoy.api.v2.core.Http1ProtocolOptions} */ (
    jspb.Message.getWrapperField(this, proto.envoy.api.v2.core.Http1ProtocolOptions, 13));
};
...
proto.envoy.api.v2.Cluster.prototype.getHttp2ProtocolOptions = function() {
  return /** @type{?proto.envoy.api.v2.core.Http2ProtocolOptions} */ (
    jspb.Message.getWrapperField(this, proto.envoy.api.v2.core.Http2ProtocolOptions, 14));
};
...
proto.envoy.api.v2.Cluster.prototype.getDnsRefreshRate = function() {
  return /** @type{?proto.google.protobuf.Duration} */ (
    jspb.Message.getWrapperField(this, proto.google.protobuf.Duration, 16));
};
...
proto.envoy.api.v2.Cluster.prototype.getDnsResolversList = function() {
  return /** @type{!Array<!proto.envoy.api.v2.core.Address>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.envoy.api.v2.core.Address, 18));
};
...
proto.envoy.api.v2.Cluster.prototype.getOutlierDetection = function() {
  return /** @type{?proto.envoy.api.v2.cluster.OutlierDetection} */ (
    jspb.Message.getWrapperField(this, proto.envoy.api.v2.cluster.OutlierDetection, 19));
};
...
proto.envoy.api.v2.Cluster.prototype.getCleanupInterval = function() {
  return /** @type{?proto.google.protobuf.Duration} */ (
    jspb.Message.getWrapperField(this, proto.google.protobuf.Duration, 20));
};
...
proto.envoy.api.v2.Cluster.prototype.getUpstreamBindConfig = function() {
  return /** @type{?proto.envoy.api.v2.core.BindConfig} */ (
    jspb.Message.getWrapperField(this, proto.envoy.api.v2.core.BindConfig, 21));
};
...
proto.envoy.api.v2.Cluster.prototype.getTransportSocket = function() {
  return /** @type{?proto.envoy.api.v2.core.TransportSocket} */ (
    jspb.Message.getWrapperField(this, proto.envoy.api.v2.core.TransportSocket, 24));
};
...
proto.envoy.api.v2.Cluster.prototype.getMetadata = function() {
  return /** @type{?proto.envoy.api.v2.core.Metadata} */ (
    jspb.Message.getWrapperField(this, proto.envoy.api.v2.core.Metadata, 25));
};
...
proto.envoy.api.v2.Cluster.prototype.getFiltersList = function() {
  return /** @type{!Array<!proto.envoy.api.v2.cluster.Filter>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.envoy.api.v2.cluster.Filter, 40));
};
...
proto.envoy.api.v2.Cluster.prototype.getLrsServer = function() {
  return /** @type{?proto.envoy.api.v2.core.ConfigSource} */ (
    jspb.Message.getWrapperField(this, proto.envoy.api.v2.core.ConfigSource, 42));
};
