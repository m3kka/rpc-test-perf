...
goog.provide('proto.envoy.config.common.tap.v2alpha.CommonExtensionConfig');
goog.provide('proto.envoy.config.common.tap.v2alpha.CommonExtensionConfig.ConfigTypeCase');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.envoy.config.common.tap.v2alpha.AdminConfig');
goog.require('proto.envoy.service.tap.v2alpha.TapConfig');
...
proto.envoy.config.common.tap.v2alpha.CommonExtensionConfig.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    staticConfig: (f = msg.getStaticConfig()) && proto.envoy.service.tap.v2alpha.TapConfig.toObject(includeInstance, f)
  };
...
proto.envoy.config.common.tap.v2alpha.CommonExtensionConfig.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.envoy.service.tap.v2alpha.TapConfig;
      reader.readMessage(value,proto.envoy.service.tap.v2alpha.TapConfig.deserializeBinaryFromReader);
...
proto.envoy.config.common.tap.v2alpha.CommonExtensionConfig.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.envoy.service.tap.v2alpha.TapConfig.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!proto.envoy.config.common.tap.v2alpha.CommonExtensionConfig} returns this
*/
proto.envoy.config.common.tap.v2alpha.CommonExtensionConfig.prototype.setAdminConfig = function(value) {
  return jspb.Message.setOneofWrapperField(this, 1, proto.envoy.config.common.tap.v2alpha.CommonExtensionConfig.oneofGroups_[0], value);
};
...
proto.envoy.config.common.tap.v2alpha.CommonExtensionConfig.prototype.clearAdminConfig = function() {
  return this.setAdminConfig(undefined);
};
...
proto.envoy.config.common.tap.v2alpha.CommonExtensionConfig.prototype.getStaticConfig = function() {
  return /** @type{?proto.envoy.service.tap.v2alpha.TapConfig} */ (
    jspb.Message.getWrapperField(this, proto.envoy.service.tap.v2alpha.TapConfig, 2));
};
...
proto.envoy.config.common.tap.v2alpha.CommonExtensionConfig.prototype.setStaticConfig = function(value) {
  return jspb.Message.setOneofWrapperField(this, 2, proto.envoy.config.common.tap.v2alpha.CommonExtensionConfig.oneofGroups_[0], value);
};
...
proto.envoy.config.common.tap.v2alpha.CommonExtensionConfig.prototype.clearStaticConfig = function() {
  return this.setStaticConfig(undefined);
};
