...
goog.provide('proto.envoy.api.v2.Listener');
goog.provide('proto.envoy.api.v2.Listener.ConnectionBalanceConfig');
goog.provide('proto.envoy.api.v2.Listener.ConnectionBalanceConfig.BalanceTypeCase');
goog.provide('proto.envoy.api.v2.Listener.ConnectionBalanceConfig.ExactBalance');
goog.provide('proto.envoy.api.v2.Listener.DeprecatedV1');
goog.provide('proto.envoy.api.v2.Listener.DrainType');
...
goog.require('proto.envoy.api.v2.core.SocketOption');
goog.require('proto.envoy.api.v2.listener.FilterChain');
goog.require('proto.envoy.api.v2.listener.ListenerFilter');
goog.require('proto.envoy.api.v2.listener.UdpListenerConfig');
goog.require('proto.envoy.config.filter.accesslog.v2.AccessLog');
goog.require('proto.envoy.config.listener.v2.ApiListener');
...
goog.forwardDeclare('proto.envoy.api.v2.core.TrafficDirection');
/**
...
proto.envoy.api.v2.Listener.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    address: (f = msg.getAddress()) && proto.envoy.api.v2.core.Address.toObject(includeInstance, f),
    filterChainsList: jspb.Message.toObjectList(msg.getFilterChainsList(),
    proto.envoy.api.v2.listener.FilterChain.toObject, includeInstance),
    ...
    proto.envoy.api.v2.listener.ListenerFilter.toObject, includeInstance),
    ...
    proto.envoy.api.v2.core.SocketOption.toObject, includeInstance),
    ...
    udpListenerConfig: (f = msg.getUdpListenerConfig()) && proto.envoy.api.v2.listener.UdpListenerConfig.toObject(includeInstance, f),
    apiListener: (f = msg.getApiListener()) && proto.envoy.config.listener.v2.ApiListener.toObject(includeInstance, f),
    ...
    proto.envoy.config.filter.accesslog.v2.AccessLog.toObject, includeInstance)
  };
...
proto.envoy.api.v2.Listener.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new proto.envoy.api.v2.listener.FilterChain;
      reader.readMessage(value,proto.envoy.api.v2.listener.FilterChain.deserializeBinaryFromReader);
    ...
    case 8:
      ...
      break;
    case 9:
      var value = new proto.envoy.api.v2.listener.ListenerFilter;
      reader.readMessage(value,proto.envoy.api.v2.listener.ListenerFilter.deserializeBinaryFromReader);
    ...
    case 11:
      ...
      break;
    case 13:
      var value = new proto.envoy.api.v2.core.SocketOption;
      reader.readMessage(value,proto.envoy.api.v2.core.SocketOption.deserializeBinaryFromReader);
    ...
    case 16:
      ...
      break;
    case 18:
      var value = new proto.envoy.api.v2.listener.UdpListenerConfig;
      reader.readMessage(value,proto.envoy.api.v2.listener.UdpListenerConfig.deserializeBinaryFromReader);
      msg.setUdpListenerConfig(value);
      break;
    case 19:
      var value = new proto.envoy.config.listener.v2.ApiListener;
      reader.readMessage(value,proto.envoy.config.listener.v2.ApiListener.deserializeBinaryFromReader);
    ...
    case 21:
      ...
      break;
    case 22:
      var value = new proto.envoy.config.filter.accesslog.v2.AccessLog;
      reader.readMessage(value,proto.envoy.config.filter.accesslog.v2.AccessLog.deserializeBinaryFromReader);
...
proto.envoy.api.v2.Listener.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      3,
      f,
      proto.envoy.api.v2.listener.FilterChain.serializeBinaryToWriter
    );
  }
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      9,
      f,
      proto.envoy.api.v2.listener.ListenerFilter.serializeBinaryToWriter
    );
  }
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      13,
      f,
      proto.envoy.api.v2.core.SocketOption.serializeBinaryToWriter
    );
  }
  ...
  if (f != null) {
    writer.writeMessage(
      18,
      f,
      proto.envoy.api.v2.listener.UdpListenerConfig.serializeBinaryToWriter
    );
  }
  ...
  if (f != null) {
    writer.writeMessage(
      19,
      f,
      proto.envoy.config.listener.v2.ApiListener.serializeBinaryToWriter
    );
  }
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      22,
      f,
      proto.envoy.config.filter.accesslog.v2.AccessLog.serializeBinaryToWriter
    );
  }
};
...
proto.envoy.api.v2.Listener.prototype.getAddress = function() {
  return /** @type{?proto.envoy.api.v2.core.Address} */ (
    jspb.Message.getWrapperField(this, proto.envoy.api.v2.core.Address, 2));
};
...
proto.envoy.api.v2.Listener.prototype.getFilterChainsList = function() {
  return /** @type{!Array<!proto.envoy.api.v2.listener.FilterChain>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.envoy.api.v2.listener.FilterChain, 3));
};
...
proto.envoy.api.v2.Listener.prototype.getMetadata = function() {
  return /** @type{?proto.envoy.api.v2.core.Metadata} */ (
    jspb.Message.getWrapperField(this, proto.envoy.api.v2.core.Metadata, 6));
};
...
proto.envoy.api.v2.Listener.prototype.getListenerFiltersList = function() {
  return /** @type{!Array<!proto.envoy.api.v2.listener.ListenerFilter>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.envoy.api.v2.listener.ListenerFilter, 9));
};
...
proto.envoy.api.v2.Listener.prototype.getSocketOptionsList = function() {
  return /** @type{!Array<!proto.envoy.api.v2.core.SocketOption>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.envoy.api.v2.core.SocketOption, 13));
};
...
proto.envoy.api.v2.Listener.prototype.getUdpListenerConfig = function() {
  return /** @type{?proto.envoy.api.v2.listener.UdpListenerConfig} */ (
    jspb.Message.getWrapperField(this, proto.envoy.api.v2.listener.UdpListenerConfig, 18));
};
...
proto.envoy.api.v2.Listener.prototype.getApiListener = function() {
  return /** @type{?proto.envoy.config.listener.v2.ApiListener} */ (
    jspb.Message.getWrapperField(this, proto.envoy.config.listener.v2.ApiListener, 19));
};
...
proto.envoy.api.v2.Listener.prototype.getAccessLogList = function() {
  return /** @type{!Array<!proto.envoy.config.filter.accesslog.v2.AccessLog>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.envoy.config.filter.accesslog.v2.AccessLog, 22));
};
