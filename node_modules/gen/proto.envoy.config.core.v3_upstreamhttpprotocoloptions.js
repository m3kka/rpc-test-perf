...
goog.provide('proto.envoy.config.core.v3.UpstreamHttpProtocolOptions');
...
proto.envoy.config.core.v3.UpstreamHttpProtocolOptions.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    overrideAutoSniHeader: jspb.Message.getFieldWithDefault(msg, 3, "")
  };
...
proto.envoy.config.core.v3.UpstreamHttpProtocolOptions.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      msg.setOverrideAutoSniHeader(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.envoy.config.core.v3.UpstreamHttpProtocolOptions.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getOverrideAutoSniHeader();
  if (f.length > 0) {
    writer.writeString(
      3,
      f
...
/**
 * optional string override_auto_sni_header = 3;
 * @return {string}
 */
proto.envoy.config.core.v3.UpstreamHttpProtocolOptions.prototype.getOverrideAutoSniHeader = function() {
 ...
 * @return {!proto.envoy.config.core.v3.UpstreamHttpProtocolOptions} returns this
 */
proto.envoy.config.core.v3.UpstreamHttpProtocolOptions.prototype.setOverrideAutoSniHeader = function(value) {
