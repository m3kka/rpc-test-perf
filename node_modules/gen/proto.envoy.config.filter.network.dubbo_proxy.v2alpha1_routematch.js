...
goog.provide('proto.envoy.config.filter.network.dubbo_proxy.v2alpha1.RouteMatch');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.envoy.api.v2.route.HeaderMatcher');
goog.require('proto.envoy.config.filter.network.dubbo_proxy.v2alpha1.MethodMatch');
 ...
 * @return {!proto.envoy.config.filter.network.dubbo_proxy.v2alpha1.RouteMatch} returns this
*/
...
proto.envoy.config.filter.network.dubbo_proxy.v2alpha1.RouteMatch.prototype.getHeadersList = function() {
  return /** @type{!Array<!proto.envoy.api.v2.route.HeaderMatcher>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.envoy.api.v2.route.HeaderMatcher, 2));
};
