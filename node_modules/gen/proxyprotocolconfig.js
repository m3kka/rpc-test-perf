...
goog.provide('proto.envoy.config.core.v3.ProxyProtocolConfig');
goog.provide('proto.envoy.config.core.v3.ProxyProtocolConfig.Version');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.envoy.config.core.v3.ProxyProtocolPassThroughTLVs');
...
proto.envoy.config.core.v3.ProxyProtocolConfig.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    passThroughTlvs: (f = msg.getPassThroughTlvs()) && proto.envoy.config.core.v3.ProxyProtocolPassThroughTLVs.toObject(includeInstance, f)
  };
...
proto.envoy.config.core.v3.ProxyProtocolConfig.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.envoy.config.core.v3.ProxyProtocolPassThroughTLVs;
      reader.readMessage(value,proto.envoy.config.core.v3.ProxyProtocolPassThroughTLVs.deserializeBinaryFromReader);
...
proto.envoy.config.core.v3.ProxyProtocolConfig.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.envoy.config.core.v3.ProxyProtocolPassThroughTLVs.serializeBinaryToWriter
    );
  }
};
 ...
 */
proto.envoy.config.core.v3.ProxyProtocolConfig.prototype.getPassThroughTlvs = function() {
  return /** @type{?proto.envoy.config.core.v3.ProxyProtocolPassThroughTLVs} */ (
    jspb.Message.getWrapperField(this, proto.envoy.config.core.v3.ProxyProtocolPassThroughTLVs, 2));
};


/**
 * @param {?proto.envoy.config.core.v3.ProxyProtocolPassThroughTLVs|undefined} value
 * @return {!proto.envoy.config.core.v3.ProxyProtocolConfig} returns this
*/
proto.envoy.config.core.v3.ProxyProtocolConfig.prototype.setPassThroughTlvs = function(value) {
 ...
 * @return {!proto.envoy.config.core.v3.ProxyProtocolConfig} returns this
 */
proto.envoy.config.core.v3.ProxyProtocolConfig.prototype.clearPassThroughTlvs = function() {
  return this.setPassThroughTlvs(undefined);
};
 ...
 * @return {boolean}
 */
proto.envoy.config.core.v3.ProxyProtocolConfig.prototype.hasPassThroughTlvs = function() {
