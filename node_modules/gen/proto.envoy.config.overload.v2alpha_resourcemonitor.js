...
goog.provide('proto.envoy.config.overload.v2alpha.ResourceMonitor');
goog.provide('proto.envoy.config.overload.v2alpha.ResourceMonitor.ConfigTypeCase');
...
/**
 * @param {string} value
 * @return {!proto.envoy.config.overload.v2alpha.ResourceMonitor} returns this
 */
...
proto.envoy.config.overload.v2alpha.ResourceMonitor.prototype.setConfig = function(value) {
  return jspb.Message.setOneofWrapperField(this, 2, proto.envoy.config.overload.v2alpha.ResourceMonitor.oneofGroups_[0], value);
};
...
proto.envoy.config.overload.v2alpha.ResourceMonitor.prototype.setTypedConfig = function(value) {
  return jspb.Message.setOneofWrapperField(this, 3, proto.envoy.config.overload.v2alpha.ResourceMonitor.oneofGroups_[0], value);
};
