...
goog.provide('proto.envoy.config.trace.v2.LightstepConfig');
goog.provide('proto.envoy.config.trace.v2.LightstepConfig.PropagationMode');
...
proto.envoy.config.trace.v2.LightstepConfig.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var values = /** @type {!Array<!proto.envoy.config.trace.v2.LightstepConfig.PropagationMode>} */ (reader.isDelimited() ? reader.readPackedEnum() : [reader.readEnum()]);
