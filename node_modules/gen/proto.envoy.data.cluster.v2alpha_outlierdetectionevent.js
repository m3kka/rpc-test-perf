...
goog.provide('proto.envoy.data.cluster.v2alpha.OutlierDetectionEvent');
goog.provide('proto.envoy.data.cluster.v2alpha.OutlierDetectionEvent.EventCase');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.envoy.data.cluster.v2alpha.OutlierEjectConsecutive');
goog.require('proto.envoy.data.cluster.v2alpha.OutlierEjectFailurePercentage');
goog.require('proto.envoy.data.cluster.v2alpha.OutlierEjectSuccessRate');
goog.require('proto.google.protobuf.Timestamp');
goog.require('proto.google.protobuf.UInt64Value');

goog.forwardDeclare('proto.envoy.data.cluster.v2alpha.Action');
goog.forwardDeclare('proto.envoy.data.cluster.v2alpha.OutlierEjectionType');
/**
 ...
 * @const
 */
proto.envoy.data.cluster.v2alpha.OutlierDetectionEvent.oneofGroups_ = [[9,10,11]];
...
proto.envoy.data.cluster.v2alpha.OutlierDetectionEvent.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    secsSinceLastAction: (f = msg.getSecsSinceLastAction()) && proto.google.protobuf.UInt64Value.toObject(includeInstance, f),
    ...
    enforced: jspb.Message.getBooleanFieldWithDefault(msg, 8, false),
    ...
    ejectFailurePercentageEvent: (f = msg.getEjectFailurePercentageEvent()) && proto.envoy.data.cluster.v2alpha.OutlierEjectFailurePercentage.toObject(includeInstance, f)
  };
...
proto.envoy.data.cluster.v2alpha.OutlierDetectionEvent.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 10:
      ...
      break;
    case 11:
      var value = new proto.envoy.data.cluster.v2alpha.OutlierEjectFailurePercentage;
      reader.readMessage(value,proto.envoy.data.cluster.v2alpha.OutlierEjectFailurePercentage.deserializeBinaryFromReader);
      msg.setEjectFailurePercentageEvent(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.envoy.data.cluster.v2alpha.OutlierDetectionEvent.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getEjectFailurePercentageEvent();
  if (f != null) {
    writer.writeMessage(
      11,
      f,
      proto.envoy.data.cluster.v2alpha.OutlierEjectFailurePercentage.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!proto.envoy.data.cluster.v2alpha.OutlierDetectionEvent} returns this
 */
...
proto.envoy.data.cluster.v2alpha.OutlierDetectionEvent.prototype.clearSecsSinceLastAction = function() {
  return this.setSecsSinceLastAction(undefined);
};
...
proto.envoy.data.cluster.v2alpha.OutlierDetectionEvent.prototype.setEjectSuccessRateEvent = function(value) {
  return jspb.Message.setOneofWrapperField(this, 9, proto.envoy.data.cluster.v2alpha.OutlierDetectionEvent.oneofGroups_[0], value);
};
...
proto.envoy.data.cluster.v2alpha.OutlierDetectionEvent.prototype.clearEjectSuccessRateEvent = function() {
  return this.setEjectSuccessRateEvent(undefined);
};
...
proto.envoy.data.cluster.v2alpha.OutlierDetectionEvent.prototype.setEjectConsecutiveEvent = function(value) {
  return jspb.Message.setOneofWrapperField(this, 10, proto.envoy.data.cluster.v2alpha.OutlierDetectionEvent.oneofGroups_[0], value);
};
...
proto.envoy.data.cluster.v2alpha.OutlierDetectionEvent.prototype.clearEjectConsecutiveEvent = function() {
  return this.setEjectConsecutiveEvent(undefined);
};
...
/**
 * optional OutlierEjectFailurePercentage eject_failure_percentage_event = 11;
 * @return {?proto.envoy.data.cluster.v2alpha.OutlierEjectFailurePercentage}
 */
proto.envoy.data.cluster.v2alpha.OutlierDetectionEvent.prototype.getEjectFailurePercentageEvent = function() {
  return /** @type{?proto.envoy.data.cluster.v2alpha.OutlierEjectFailurePercentage} */ (
    jspb.Message.getWrapperField(this, proto.envoy.data.cluster.v2alpha.OutlierEjectFailurePercentage, 11));
};


/**
 * @param {?proto.envoy.data.cluster.v2alpha.OutlierEjectFailurePercentage|undefined} value
 * @return {!proto.envoy.data.cluster.v2alpha.OutlierDetectionEvent} returns this
*/
proto.envoy.data.cluster.v2alpha.OutlierDetectionEvent.prototype.setEjectFailurePercentageEvent = function(value) {
  return jspb.Message.setOneofWrapperField(this, 11, proto.envoy.data.cluster.v2alpha.OutlierDetectionEvent.oneofGroups_[0], value);
};
 ...
 * @return {!proto.envoy.data.cluster.v2alpha.OutlierDetectionEvent} returns this
 */
proto.envoy.data.cluster.v2alpha.OutlierDetectionEvent.prototype.clearEjectFailurePercentageEvent = function() {
  return this.setEjectFailurePercentageEvent(undefined);
};
 ...
 * @return {boolean}
 */
proto.envoy.data.cluster.v2alpha.OutlierDetectionEvent.prototype.hasEjectFailurePercentageEvent = function() {
